...
#[cfg(any(feature = "dns-doh", feature = "dns-offline"))]
...
#[cfg(any(
    all(feature = "dns-hickory", feature = "dns-doh"),
    all(feature = "dns-hickory", feature = "dns-offline"),
    all(feature = "dns-doh", feature = "dns-offline"),
))]
compile_error!("enable exactly one DNS backend feature");
#[cfg(not(any(feature = "dns-hickory", feature = "dns-doh", feature = "dns-offline")))]
compile_error!("a DNS backend is required; enable `dns-hickory`, `dns-doh`, or `dns-offline`");
