...
await writeFile(
  ...
  `${JSON.stringify(
    {
      name: "@turenlabs/squashfs-wasm",
      version: "0.1.0-turen.1",
      private: true,
      type: "module",
      description: "TurenOS bounded SquashFS listing and single-entry extraction",
      main: "dist/turen_squashfs_wasm.js",
      types: "dist/turen_squashfs_wasm.d.ts",
      exports: {
        ".": {
          types: "./dist/turen_squashfs_wasm.d.ts",
          import: "./dist/turen_squashfs_wasm.js",
          default: "./dist/turen_squashfs_wasm.js",
        },
      },
