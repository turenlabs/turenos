...
await writeFile(
  ...
  `${JSON.stringify(
    {
      name: "@turenlabs/image-inspect-wasm",
      version: "0.1.0-turen.1",
      private: true,
      type: "module",
      description: "TurenOS bounded offline image/container metadata inspector",
      main: "dist/turen_image_inspect_wasm.js",
      types: "dist/turen_image_inspect_wasm.d.ts",
      exports: {
        ".": {
          types: "./dist/turen_image_inspect_wasm.d.ts",
          import: "./dist/turen_image_inspect_wasm.js",
          default: "./dist/turen_image_inspect_wasm.js",
        },
      },
