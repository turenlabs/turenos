...
- Preserve technical terms and artifacts exactly: TurenOS, Forge compatibility identifiers, API names, identifiers, code, commands, flags, paths, URLs, versions, error messages, config keys, and placeholder tokens.
