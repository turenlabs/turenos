...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".forge/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".forge/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".forge/glossary/zh-tw.md")
  })
