...
- PR #13942: https://github.com/turenlabs/forge/pull/13942

## Do Not Translate (Locale Additions)

- `TurenOS` (preserve casing in prose; keep `forge` only when it is part of commands, package names, paths, or code)
- `TurenOS Zen`
- `TurenOS CLI` (the executable remains `forge` in commands)
- `CLI`, `MCP`, `OAuth`
...
- Avoid `forge` in prose when referring to the product name; use `TurenOS`
