...
- PR #15835: https://github.com/turenlabs/forge/pull/15835

## Do Not Translate (Locale Additions)

- `TurenOS` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `forge` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `TurenOS` in prose, `forge` only for exact technical identifiers
...
- Avoid changing `forge` to `TurenOS` inside commands, URLs, package names, or code literals
