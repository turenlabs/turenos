...
Use this folder for locale-specific translation guidance that supplements `.forge/agent/translator.md`.
...
- PR #12345: https://github.com/turenlabs/forge/pull/12345

## Do Not Translate (Locale Additions)

- `TurenOS` (preserve casing; keep `forge` only for exact compatibility identifiers)
