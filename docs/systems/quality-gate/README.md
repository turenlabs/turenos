...
- [`packages/core/src/tool/interceptor.ts`](../../../packages/core/src/tool/interceptor.ts)
- [`packages/core/src/session/runner/claude-code-mcp.ts`](../../../packages/core/src/session/runner/claude-code-mcp.ts)
- Tests: [`packages/core/test/plugin/complexity-ratchet.test.ts`](../../../packages/core/test/plugin/complexity-ratchet.test.ts), [`packages/core/test/session-runner-claude-code-mcp.test.ts`](../../../packages/core/test/session-runner-claude-code-mcp.test.ts)
