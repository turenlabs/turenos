...
| `spawn_agent`, `send_agent`, `wait_agents`, `interrupt_agent`, `notify_parent`           | [Subagent workstreams](./subagent-workstreams.md)                                                               | V2 (session)  | no                          | `packages/core/src/tool/subagent.ts`                                                                                            |
