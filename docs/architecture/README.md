...
| `@turenlabs/codemode`              | Confined JavaScript execution over explicit, schema-described host tools. See [CodeMode](../systems/codemode/README.md).                                                            | [`packages/codemode/src/codemode.ts`](../../packages/codemode/src/codemode.ts)                     |
| `@turenlabs/ui`                    | Shared Solid components, hooks, context, i18n, and themes used by the app and Desktop.                                                                                              | [`packages/ui/package.json`](../../packages/ui/package.json)                                       |
| `@turenlabs/session-ui`            | Session transcript, message-part, and diff components used by the app.                                                                                                              | [`packages/session-ui/package.json`](../../packages/session-ui/package.json)                       |
| `@turenlabs/effect-drizzle-sqlite` | Drizzle ORM driver for Effect SQLite, including read replicas and the migrator Core uses.                                                                                           | [`packages/effect-drizzle-sqlite/src/index.ts`](../../packages/effect-drizzle-sqlite/src/index.ts) |
| `@turenlabs/effect-sqlite-node`    | Effect SQLite client over Node's built-in `node:sqlite`.                                                                                                                            | [`packages/effect-sqlite-node/src/index.ts`](../../packages/effect-sqlite-node/src/index.ts)       |
| `@turenlabs/httpapi-codegen`       | Build-time generator of Promise and Effect clients from `HttpApi` and Schema contracts, used by `packages/client`.                                                                  | [`packages/httpapi-codegen/README.md`](../../packages/httpapi-codegen/README.md)                   |
| `@turenlabs/http-recorder`         | Test-only record and replay of Effect HTTP and WebSocket traffic as deterministic JSON cassettes.                                                                                   | [`packages/http-recorder/README.md`](../../packages/http-recorder/README.md)                       |
| `@turenlabs/script`                | Release and version tooling: versioned manifests, `version:check`, and release validation policy.                                                                                   | [`packages/script/src/version.ts`](../../packages/script/src/version.ts)                           |
| `@turenlabs/vigil-runtime`         | Per-target Vigil classifier archives embedded in release artifacts for skill install scanning.                                                                                      | [`packages/vigil-runtime/README.md`](../../packages/vigil-runtime/README.md)                       |
| `packages/rosetta-harness`         | Swift Virtualization.framework harness behind the experimental `rosetta_exec` tool. See [Rosetta execution](../systems/rosetta-exec.md).                                            | [`packages/rosetta-harness/Package.swift`](../../packages/rosetta-harness/Package.swift)           |
| `@turenlabs/*-wasm` (41)           | Checked-in WebAssembly builds of the `tools/` targets plus `ripgrep-wasm`, consumed by Core and Desktop. See [Offline security tools](../systems/offline-security-tools/README.md). | [`tools/README.md`](../../tools/README.md)                                                         |
| `@turenlabs/command-guard`         | Standalone dangerous-command detector CLI in `command-guard/` for scripts and CI. It does not import Core and is separate from `ShellSafety`.                                       | [`command-guard/README.md`](../../command-guard/README.md)                                         |
