# Offline Security Tools in 1.0.6

This release adds offline analysis capabilities and retains the Binary Inspector
and compact composer toolbar fixes. It does not introduce live scanning, ZAP,
TShark, or interactive VM debugging. Those native/service integrations are deferred.
