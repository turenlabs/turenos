...
type PlatformBase = {
  ...
  /**
   * Start and stop a CPU profile of the sidecar process (dev desktop builds
   * only). Absent in web builds and in every shipped desktop build.
   */
  profiler?: ProfilerPlatform
