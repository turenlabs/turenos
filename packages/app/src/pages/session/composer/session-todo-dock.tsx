...
import { AnimatedNumber } from "@turenlabs/ui/animated-number"
...
import { TextStrikethrough } from "@turenlabs/ui/text-strikethrough"
...
export function SessionTodoDock(props: {
  ...
  return (
    ...
    >
      <div ref={contentRef}>
        <div class="pl-3 pr-2 py-2 flex items-center gap-2 overflow-visible">
          <div
            data-action="session-todo-toggle"
            class="min-w-0 flex flex-1 items-center gap-2 overflow-visible"
            role="button"
            tabIndex={0}
          ...
          <div class="flex items-center">
            <IconButton
              data-action="session-todo-clear"
              icon="trash"
              size="normal"
              variant="ghost"
              onMouseDown={(event) => {
