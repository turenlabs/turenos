...
import { Avatar } from "@turenlabs/ui/avatar"
  ...
  return (
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      ...
      <Show when={props.working}>
        <div class="absolute -bottom-1 -right-1 size-5 rounded-full bg-background-base z-10 flex items-center justify-center">
