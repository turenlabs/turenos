...
import { showToast } from "@turenlabs/ui/toast"
...
import { LoaderV2 } from "@turenlabs/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@turenlabs/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-forge") {
      await run(() => api.installForge(distro))
      return
    }
