...
import { Switch } from "@turenlabs/ui/switch"
...
export const SettingsGeneral: Component = () => {
  ...
  const [permissionChecks, { mutate: setPermissionChecks }] = createResource(serverSdk, (sdk) =>
        ...
        >
          <div data-action="settings-enforce-permission-checks" class="flex items-center gap-2">
            ...
            <Show when={permissionChecks() === undefined}>
              <span class="text-12-regular text-text-weak">Unavailable</span>
            </Show>
          </div>
        </SettingsRow>
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <Link href="https://github.com/turenlabs/forge/docs/themes/">{language.t("common.learnMore")}</Link>
            </>
          }
        >
          <Select
    ...
    <div class="flex flex-col gap-1">
      ...
      <SettingsList>
        ...
        <Show when={platform.updater}>
          ...
          >
            <div data-action="settings-update-track">
              <Select
