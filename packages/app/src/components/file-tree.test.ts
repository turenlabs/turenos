...
beforeAll(async () => {
  ...
  mock.module("@turenlabs/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@turenlabs/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@turenlabs/ui/icon", () => ({ Icon: () => null }))
  mock.module("@turenlabs/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
