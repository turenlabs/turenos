    ...
    return (
      <ServerSDKProvider server={() => props.server}>
        <ServerSyncProvider server={() => props.server}>
          <DialogCustomProviderContent onBack={props.onBack} />
        </ServerSyncProvider>
      </ServerSDKProvider>
    )
  }
  return <DialogCustomProviderContent onBack={props.onBack} />
}

function DialogCustomProviderContent(props: Props) {
    ...
    <div class="flex flex-col gap-6 px-2.5 pb-3 overflow-y-auto max-h-[60vh]">
      ...
      <form onSubmit={save} class="px-2.5 pb-6 flex flex-col gap-6">
        <p class="text-14-regular text-text-base">
          ...
          <Link href="https://github.com/turenlabs/forge/docs/providers/#custom-provider" tabIndex={-1}>
