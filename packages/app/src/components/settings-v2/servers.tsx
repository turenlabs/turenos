  ...
  return (
    <>
      <SettingsPageHeaderV2
        class="settings-v2-servers-header"
        stacked={showSearch()}
        title={language.t("settings.connections.title")}
        description={language.t("settings.connections.description")}
        scope={language.t("settings.scope.device")}
        actions={<AddServerMenu onAddServer={openAdd} />}
      >
