...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 TurenOS에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 TurenOS에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 TurenOS에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "forge.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 TurenOS 서버를 전환합니다.",
  ...
  "toast.session.compact.success.title": "세션을 압축했습니다",
  "toast.session.compact.success.description": "컨텍스트를 확보하기 위해 이전 메시지를 요약했습니다",
  "toast.session.compact.failed.title": "세션 압축에 실패했습니다",
  "toast.session.listFailed.title": "{{project}}에 대한 세션을 로드하지 못했습니다",
  "toast.update.title": "업데이트 가능",
  "toast.update.description": "TurenOS의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 TurenOS 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(forge.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: TurenOS는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "settings.section.securityIntegrations": "보안 통합",
  "settings.tab.general": "일반",
  "settings.tab.shortcuts": "단축키",
  "settings.tab.securityData": "데이터",
  "settings.tab.securityTools": "도구",
  "settings.security.search.placeholder": "통합 검색",
  "settings.security.data.empty": "아직 데이터 통합이 없습니다",
  "settings.security.tools.empty": "아직 도구 통합이 없습니다",
  "settings.security.loadError": "보안 통합을 불러올 수 없습니다. 서버가 최신 상태인지 확인하세요.",
  "settings.security.updateError": "업데이트에 실패했습니다 — 변경 사항이 저장되지 않았습니다.",
  "settings.security.tools.notInstalled": "설치되지 않음",
  "settings.security.secret.action": "API 키",
  "settings.security.secret.placeholder.set": "설정됨 — 교체하려면 새 키를 입력하세요",
  "settings.security.secret.placeholder.unset": "API 키 입력",
  "settings.security.secret.clearHint": "빈 값을 제출하면 저장된 키가 삭제됩니다.",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "OSV.dev 오픈 소스 데이터베이스에서 알려진 취약점을 조회합니다",
  "settings.security.integration.depsdev.description": "deps.dev에서 제공하는 패키지 상태, 라이선스, 의존성 그래프",
  "settings.security.integration.kev.description": "CVE를 CISA의 알려진 악용 취약점(KEV) 카탈로그와 대조합니다",
  "settings.security.integration.epss.description": "FIRST.org에서 제공하는 CVE 악용 가능성 점수",
  "settings.security.integration.ghsa.description": "GitHub 보안 권고 데이터베이스를 조회합니다",
  "settings.security.integration.hibp.description":
    "비밀번호 유출 확인 — haveibeenpwned.com에서 CC-BY 라이선스로 제공되는 데이터",
  "settings.security.integration.exploitdb.description": "CVE로 Exploit-DB 인덱스에서 공개 익스플로잇을 검색합니다",
  "settings.security.integration.nvd.description": "NIST National Vulnerability Database에서 제공하는 CVE 세부 정보",
  "settings.security.integration.gitleaks.description": "작업 공간을 스캔하여 커밋된 시크릿을 찾습니다",
  "settings.security.integration.trivy.description": "취약점, 잘못된 구성, 시크릿을 스캔합니다",
  "settings.security.integration.osv-scanner.description":
    "잠금 파일을 스캔하여 알려진 취약점이 있는 의존성을 찾습니다",
  "settings.security.integration.grype.description": "취약점 스캔 및 SBOM 생성",
  "settings.security.integration.checkov.description": "코드형 인프라(IaC)의 잘못된 구성을 스캔합니다",
  "settings.security.integration.bandit.description": "Python 보안 문제에 대한 정적 분석",
  "settings.security.integration.native-audit.description":
    "각 생태계 자체의 의존성 감사를 실행합니다 (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description": "작업 공간에 Semgrep 호환 정적 분석 규칙을 실행합니다",
  "settings.security.integration.batou.description": "코드의 일반적인 취약점을 위한 정적 애플리케이션 보안 테스트",
  "settings.security.integration.batou.note":
    "자동 — 에이전트가 작성하는 모든 파일을 스캔하고 심각한 문제를 차단합니다",
  "settings.security.integration.batou.installHint": "처음 활성화할 때 자동으로 다운로드됩니다 (macOS/Linux)",
  "settings.security.batou.status.downloading": "Batou 다운로드 중…",
  "settings.security.batou.status.installed": "설치됨",
  "settings.security.batou.status.failed": "다운로드 실패",

  "settings.section.agentIntegrations": "에이전트 통합",
  "settings.tab.agentData": "데이터",
  "settings.tab.agentTools": "도구",
  "settings.agent.data.empty": "아직 데이터 통합이 없습니다",
  "settings.agent.tools.empty": "아직 도구 통합이 없습니다",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 통합",
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 TurenOS 서버를 실행합니다.",
  ...
  "settings.general.section.retention": "저장소 및 보관",
  "settings.general.retention.scope":
    "이 기간은 저장된 대화 기록 페이로드만 정리하여 디스크 공간을 확보합니다. 영구 이벤트 로그를 다시 쓰거나 세션을 삭제하는 일은 없습니다. 0을 입력하면 해당 기간이 꺼집니다.",
  "settings.general.retention.never":
    "꺼짐. 아무리 오래되어도 정리되는 항목이 없습니다. 일수를 입력하기 전까지 저장된 페이로드는 전체가 그대로 유지됩니다.",
  "settings.general.row.retentionToolOutput.title": "도구 출력",
  "settings.general.row.retentionToolOutput.description":
    "{{days}}일이 지나면 모든 세션에 저장된 도구 호출 페이로드가 처음과 마지막 줄만 남는 짧은 미리보기로 축소됩니다. 도구 이름, 입력값, 결과 미리보기는 유지됩니다.",
  "settings.general.row.retentionToolOutput.label": "전체 도구 출력을 유지할 일수",
  "settings.general.row.retentionArchivedSessions.title": "보관된 세션",
  "settings.general.row.retentionArchivedSessions.description":
    "세션이 보관된 후 {{days}}일이 지나면 해당 세션의 도구 페이로드와 셸 명령 출력이 미리보기로 축소되고, 지나치게 큰 도구 입력값은 삭제됩니다. 세션과 세션 제목, 모든 사용자 프롬프트, 모든 어시스턴트 응답은 유지되므로 대화 기록은 그대로 읽을 수 있습니다.",
  "settings.general.row.retentionArchivedSessions.label": "보관된 세션 페이로드를 유지할 일수",
  "settings.general.row.language.title": "언어",
  "settings.general.row.language.description": "TurenOS 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 TurenOS가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "TurenOS가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "TurenOS 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "TurenOS를 실행할 때 업데이트를 자동으로 확인합니다",
  "settings.updates.row.check.title": "업데이트 확인",
  "settings.updates.row.check.description": "업데이트를 수동으로 확인하고, 사용 가능하면 설치합니다",
  "settings.updates.row.track.title": "업데이트 채널",
  "settings.updates.row.track.description": "최신 릴리스보다 몇 단계 이전 버전을 사용할지 선택합니다",
  "settings.updates.track.option.latest": "최신",
  "settings.updates.track.option.behindOne": "한 단계 이전 릴리스",
  "settings.updates.track.option.behindTwo": "두 단계 이전 릴리스",
  "settings.updates.action.checkNow": "지금 확인",
  "settings.updates.action.checking": "확인 중...",
  "settings.updates.toast.latest.title": "최신 상태입니다",
  "settings.updates.toast.latest.description": "현재 최신 버전의 TurenOS를 사용 중입니다.",
  ...
  "nav.rail.label": "기본 탐색",
  "nav.rail.agents": "에이전트",
  "nav.rail.agents.running": "{{count}}개 실행 중",
  "nav.rail.agents.showPanel": "에이전트 — 패널 표시",
  "nav.rail.agents.hidePanel": "에이전트 — 패널 숨기기",
  "nav.rail.settings": "설정",
  "nav.rail.help": "도움말",
  "nav.rail.server": "서버: {{server}}",
  "command.nav.agents": "에이전트로 이동",
  "command.nav.panel.toggle": "탐색 패널 토글",
  ...
  "wsl.onboarding.checkingForge": "TurenOS 확인 중...",
  "wsl.onboarding.checkingForgeIn": "{{distro}}에서 TurenOS 확인 중...",
  "wsl.onboarding.updatingForge": "TurenOS 업데이트 중...",
  "wsl.onboarding.updatingForgeIn": "{{distro}}에서 TurenOS 업데이트 중...",
  "wsl.onboarding.updateForgeIn": "{{distro}}에서 TurenOS를 업데이트하세요.",
  "wsl.onboarding.updateForge": "TurenOS 업데이트",
  "wsl.onboarding.forgeReadyIn": "{{distro}}에서 TurenOS를 사용할 준비가 되었습니다.",
  "wsl.onboarding.forgeReady": "TurenOS가 준비되었습니다.",
  "wsl.onboarding.installForgeIn": "{{distro}}에 TurenOS를 설치하세요.",
  "wsl.onboarding.installForge": "TurenOS 설치",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "TurenOS에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "TurenOS에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 TurenOS를 다시 여세요.",
  ...
  "settings.general.row.performanceDiagnostics.title": "성능 진단",
  "settings.general.row.performanceDiagnostics.description":
    "탐색, 렌더링, 입력 지연, 레이아웃 이동, 메모리에 대한 개발 카운터 표시",
  "settings.general.section.profiler": "프로파일러",
  "settings.general.profiler.scope":
    "TurenOS 서버 프로세스만 기록합니다 — 에이전트 루프, 도구 실행, 압축, MCP. 인터페이스와 창 시간은 기록되지 않으므로 여기서 UI 멈춤을 찾지 마세요.",
  "settings.general.row.profiler.title": "CPU 프로필 기록",
  "settings.general.row.profiler.description":
    "기록을 시작하고 느린 동작을 재현한 다음 중지하세요. 기록은 실행 중에 몇 퍼센트의 비용이 들고 꺼져 있을 때는 비용이 없습니다.",
  "settings.general.profiler.recording":
    "기록 중 — {{elapsed}} 경과. 10분 후 자동으로 중지됩니다. TurenOS를 종료하면 기록이 삭제됩니다.",
  "settings.general.profiler.unavailable": "TurenOS 서버가 시작되기를 기다리는 중입니다.",
  "settings.general.profiler.failedTitle": "기록 실패",
  "settings.general.row.profilerResult.title": "마지막 기록",
  "settings.general.row.profilerResult.description":
    "{{duration}} 동안 {{rate}} Hz로 수집한 {{samples}}개 샘플. .cpuprofile 파일을 Chrome DevTools(Performance › Load profile) 또는 speedscope.app에서 여세요.",
  "settings.general.profiler.reveal": "보기",
