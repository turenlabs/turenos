...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans TurenOS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans TurenOS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans TurenOS.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans forge.json",
  ...
  "dialog.server.description": "Changez le serveur TurenOS auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingForge": "Vérification d'TurenOS...",
  "wsl.onboarding.checkingForgeIn": "Vérification d'TurenOS dans {{distro}}...",
  "wsl.onboarding.updatingForge": "Mise à jour d'TurenOS...",
  "wsl.onboarding.updatingForgeIn": "Mise à jour d'TurenOS dans {{distro}}...",
  "wsl.onboarding.updateForgeIn": "Mettez à jour TurenOS dans {{distro}}.",
  "wsl.onboarding.updateForge": "Mettre à jour TurenOS",
  "wsl.onboarding.forgeReadyIn": "TurenOS est prêt dans {{distro}}.",
  "wsl.onboarding.forgeReady": "TurenOS est prêt.",
  "wsl.onboarding.installForgeIn": "Installez TurenOS dans {{distro}}.",
  "wsl.onboarding.installForge": "Installer TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'TurenOS puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "TurenOS n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez TurenOS.",
  ...
  "toast.session.compact.success.title": "Session compactée",
  "toast.session.compact.success.description": "Les messages précédents ont été résumés pour libérer du contexte",
  "toast.session.compact.failed.title": "Échec du compactage de la session",
  ...
  "toast.update.description":
    "Une nouvelle version d'TurenOS ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe TurenOS",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (forge.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'TurenOS ne supporte pas encore l'authentification MCP.",
  ...
  "settings.section.securityIntegrations": "Intégrations de sécurité",
  "settings.tab.general": "Général",
  "settings.tab.shortcuts": "Raccourcis",
  "settings.tab.securityData": "Données",
  "settings.tab.securityTools": "Outils",
  "settings.security.search.placeholder": "Rechercher des intégrations",
  "settings.security.data.empty": "Aucune intégration de données pour le moment",
  "settings.security.tools.empty": "Aucune intégration d'outils pour le moment",
  "settings.security.loadError":
    "Impossible de charger les intégrations de sécurité. Vérifiez que votre serveur est à jour.",
  "settings.security.updateError": "Échec de la mise à jour — votre modification n'a pas été enregistrée.",
  "settings.security.tools.notInstalled": "Non installé",
  "settings.security.secret.action": "Clé API",
  "settings.security.secret.placeholder.set": "Configurée — entrez une nouvelle clé pour la remplacer",
  "settings.security.secret.placeholder.unset": "Entrez la clé API",
  "settings.security.secret.clearHint": "Envoyez une valeur vide pour effacer la clé enregistrée.",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description":
    "Rechercher les vulnérabilités connues dans la base de données open source OSV.dev",
  "settings.security.integration.depsdev.description":
    "Santé des paquets, licences et graphes de dépendances depuis deps.dev",
  "settings.security.integration.kev.description":
    "Vérifier les CVE dans le catalogue Known Exploited Vulnerabilities de la CISA",
  "settings.security.integration.epss.description":
    "Scores de probabilité d'exploitation des CVE fournis par FIRST.org",
  "settings.security.integration.ghsa.description": "Interroger la base de données GitHub Security Advisory",
  "settings.security.integration.hibp.description":
    "Vérification des mots de passe compromis — données sous licence CC-BY de haveibeenpwned.com",
  "settings.security.integration.exploitdb.description":
    "Rechercher des exploits publics par CVE dans l'index Exploit-DB",
  "settings.security.integration.nvd.description": "Détails des CVE depuis la National Vulnerability Database du NIST",
  "settings.security.integration.gitleaks.description":
    "Analyser l'espace de travail à la recherche de secrets présents dans les commits",
  "settings.security.integration.trivy.description":
    "Détecter les vulnérabilités, les mauvaises configurations et les secrets",
  "settings.security.integration.osv-scanner.description":
    "Analyser les lockfiles à la recherche de dépendances vulnérables connues",
  "settings.security.integration.grype.description": "Analyse des vulnérabilités et génération de SBOM",
  "settings.security.integration.checkov.description":
    "Analyser l'infrastructure-as-code à la recherche de mauvaises configurations",
  "settings.security.integration.bandit.description": "Analyse statique des problèmes de sécurité Python",
  "settings.security.integration.native-audit.description":
    "Exécuter l'audit de dépendances propre à chaque écosystème (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "Règles d'analyse statique compatibles Semgrep sur l'espace de travail",
  "settings.security.integration.batou.description":
    "Tests statiques de sécurité applicative pour les vulnérabilités courantes du code",
  "settings.security.integration.batou.note":
    "Automatique — analyse chaque fichier que l'agent écrit ; bloque les résultats critiques",
  "settings.security.integration.batou.installHint":
    "Téléchargé automatiquement lors de la première activation (macOS/Linux)",
  "settings.security.batou.status.downloading": "Téléchargement de Batou…",
  "settings.security.batou.status.installed": "Installé",
  "settings.security.batou.status.failed": "Échec du téléchargement",

  "settings.section.agentIntegrations": "Intégrations d'agents",
  "settings.tab.agentData": "Données",
  "settings.tab.agentTools": "Outils",
  "settings.agent.data.empty": "Aucune intégration de données pour le moment",
  "settings.agent.tools.empty": "Aucune intégration d'outils pour le moment",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Intégration WSL",
  "settings.desktop.wsl.description": "Exécuter le serveur TurenOS dans WSL sur Windows.",
  ...
  "settings.general.section.retention": "Stockage et conservation",
  "settings.general.retention.scope":
    "Ces fenêtres se contentent d'élaguer les charges utiles des transcriptions stockées, ce qui libère de l'espace disque. Elles ne réécrivent jamais le journal d'événements durable et ne suppriment jamais de session. Saisissez 0 pour désactiver une fenêtre.",
  "settings.general.retention.never":
    "Désactivé : rien n'est élagué, quel que soit l'âge des données. Les charges utiles stockées sont conservées intégralement jusqu'à ce que vous saisissiez un nombre de jours.",
  "settings.general.row.retentionToolOutput.title": "Sortie des outils",
  "settings.general.row.retentionToolOutput.description":
    "Au bout de {{days}} jours, les charges utiles des appels d'outils stockées dans chaque session sont réduites à un bref aperçu : les premières et les dernières lignes. Sont conservés : le nom de l'outil, ses entrées et un aperçu du résultat.",
  "settings.general.row.retentionToolOutput.label": "Jours de conservation de la sortie complète des outils",
  "settings.general.row.retentionArchivedSessions.title": "Sessions archivées",
  "settings.general.row.retentionArchivedSessions.description":
    "{{days}} jours après l'archivage d'une session, ses charges utiles d'outils et la sortie des commandes shell sont réduites à des aperçus, et les entrées d'outils trop volumineuses sont effacées. Sont conservés : la session, son titre, toutes les invites de l'utilisateur et toutes les réponses de l'assistant ; la transcription reste lisible.",
  "settings.general.row.retentionArchivedSessions.label":
    "Jours de conservation des charges utiles des sessions archivées",
  "settings.general.row.language.title": "Langue",
  "settings.general.row.language.description": "Changer la langue d'affichage pour TurenOS",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'TurenOS sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si TurenOS suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'TurenOS.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Diagnostics de performance",
  "settings.general.row.performanceDiagnostics.description":
    "Afficher les compteurs de développement pour la navigation, le rendu, le délai de saisie, le décalage de mise en page et la mémoire",
  "settings.general.section.profiler": "Profileur",
  "settings.general.profiler.scope":
    "N'enregistre que le processus serveur TurenOS — la boucle de l'agent, l'exécution des outils, le compactage et MCP. Le temps passé dans l'interface et la fenêtre n'est pas enregistré, ne cherchez donc pas les blocages d'interface ici.",
  "settings.general.row.profiler.title": "Enregistrer un profil CPU",
  "settings.general.row.profiler.description":
    "Démarrez l'enregistrement, reproduisez le comportement lent, puis arrêtez. L'enregistrement coûte quelques pour cent pendant son exécution et rien lorsqu'il est désactivé.",
  "settings.general.profiler.recording":
    "Enregistrement en cours — {{elapsed}} écoulées. S'arrête tout seul au bout de 10 minutes. Quitter TurenOS supprime l'enregistrement.",
  "settings.general.profiler.unavailable": "En attente du démarrage du serveur TurenOS.",
  "settings.general.profiler.failedTitle": "Échec de l'enregistrement",
  "settings.general.row.profilerResult.title": "Dernier enregistrement",
  "settings.general.row.profilerResult.description":
    "{{samples}} échantillons à {{rate}} Hz sur {{duration}}. Ouvrez le fichier .cpuprofile dans Chrome DevTools (Performance › Load profile) ou sur speedscope.app.",
  "settings.general.profiler.reveal": "Afficher",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'TurenOS",
  ...
  "settings.updates.row.track.title": "Canal de mise à jour",
  "settings.updates.row.track.description": "Nombre de versions de retard par rapport à la plus récente",
  "settings.updates.track.option.latest": "Dernière version",
  "settings.updates.track.option.behindOne": "Une version de retard",
  "settings.updates.track.option.behindTwo": "Deux versions de retard",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'TurenOS.",
  ...
  "settings.agents.title": "Paramètres des agents",
  ...
  "nav.rail.label": "Navigation principale",
  "nav.rail.agents": "Agents",
  "nav.rail.agents.running": "{{count}} actifs",
  "nav.rail.agents.showPanel": "Agents — afficher le panneau",
  "nav.rail.agents.hidePanel": "Agents — masquer le panneau",
  "nav.rail.settings": "Paramètres",
  "nav.rail.help": "Aide",
  "nav.rail.server": "Serveur : {{server}}",
  "command.nav.agents": "Aller aux Agents",
  "command.nav.panel.toggle": "Basculer le panneau de navigation",
