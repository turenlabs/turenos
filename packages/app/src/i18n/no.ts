...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i TurenOS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i TurenOS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i TurenOS.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i forge.json",
  ...
  "dialog.server.description": "Bytt hvilken TurenOS-server denne appen kobler til.",
  ...
  "toast.session.compact.success.title": "Økten er komprimert",
  "toast.session.compact.success.description": "Tidligere meldinger ble oppsummert for å frigjøre kontekst",
  "toast.session.compact.failed.title": "Kunne ikke komprimere økten",

  "toast.session.listFailed.title": "Kunne ikke laste sesjoner for {{project}}",

  "toast.update.title": "Oppdatering tilgjengelig",
  "toast.update.description": "En ny versjon av TurenOS ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til TurenOS-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (forge.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at TurenOS ikke støtter MCP-autentisering ennå.',
  ...
  "settings.section.securityIntegrations": "Sikkerhetsintegrasjoner",
  "settings.tab.general": "Generelt",
  "settings.tab.shortcuts": "Snarveier",
  "settings.tab.securityData": "Data",
  "settings.tab.securityTools": "Verktøy",
  "settings.security.search.placeholder": "Søk etter integrasjoner",
  "settings.security.data.empty": "Ingen dataintegrasjoner ennå",
  "settings.security.tools.empty": "Ingen verktøyintegrasjoner ennå",
  "settings.security.loadError": "Kunne ikke laste sikkerhetsintegrasjoner. Sjekk at serveren din er oppdatert.",
  "settings.security.updateError": "Oppdateringen mislyktes — endringen din ble ikke lagret.",
  "settings.security.tools.notInstalled": "Ikke installert",
  "settings.security.secret.action": "API-nøkkel",
  "settings.security.secret.placeholder.set": "Konfigurert — skriv inn en ny nøkkel for å erstatte den",
  "settings.security.secret.placeholder.unset": "Skriv inn API-nøkkel",
  "settings.security.secret.clearHint": "Send inn en tom verdi for å fjerne den lagrede nøkkelen.",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "Slå opp kjente sårbarheter i open source-databasen OSV.dev",
  "settings.security.integration.depsdev.description": "Pakkehelse, lisenser og avhengighetsgrafer fra deps.dev",
  "settings.security.integration.kev.description":
    "Sjekk CVE-er mot CISAs katalog over Known Exploited Vulnerabilities",
  "settings.security.integration.epss.description": "Exploit-sannsynlighetsscorer for CVE-er fra FIRST.org",
  "settings.security.integration.ghsa.description": "Søk i GitHub Security Advisory-databasen",
  "settings.security.integration.hibp.description":
    "Sjekk om passord er lekket — data lisensiert CC-BY fra haveibeenpwned.com",
  "settings.security.integration.exploitdb.description": "Søk i Exploit-DB-indeksen etter offentlige exploits via CVE",
  "settings.security.integration.nvd.description": "CVE-detaljer fra NISTs National Vulnerability Database",
  "settings.security.integration.gitleaks.description": "Skann arbeidsområdet etter hemmeligheter i commits",
  "settings.security.integration.trivy.description": "Skann etter sårbarheter, feilkonfigurasjoner og hemmeligheter",
  "settings.security.integration.osv-scanner.description": "Skann lockfiler etter avhengigheter med kjente sårbarheter",
  "settings.security.integration.grype.description": "Sårbarhetsskanning og SBOM-generering",
  "settings.security.integration.checkov.description": "Skann infrastructure-as-code for feilkonfigurasjoner",
  "settings.security.integration.bandit.description": "Statisk analyse av sikkerhetsproblemer i Python",
  "settings.security.integration.native-audit.description":
    "Kjør hvert økosystems egen avhengighetsrevisjon (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description": "Semgrep-kompatible statiske analyseregler over arbeidsområdet",
  "settings.security.integration.batou.description":
    "Statisk applikasjonssikkerhetstesting for vanlige sårbarheter i koden",
  "settings.security.integration.batou.note": "Automatisk — skanner hver fil agenten skriver; blokkerer kritiske funn",
  "settings.security.integration.batou.installHint": "Lastes ned automatisk ved første aktivering (macOS/Linux)",
  "settings.security.batou.status.downloading": "Laster ned Batou…",
  "settings.security.batou.status.installed": "Installert",
  "settings.security.batou.status.failed": "Nedlasting mislyktes",

  "settings.section.agentIntegrations": "Agentintegrasjoner",
  "settings.tab.agentData": "Data",
  "settings.tab.agentTools": "Verktøy",
  "settings.agent.data.empty": "Ingen dataintegrasjoner ennå",
  "settings.agent.tools.empty": "Ingen verktøyintegrasjoner ennå",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-integrasjon",
  "settings.desktop.wsl.description": "Kjør TurenOS-serveren i WSL på Windows.",
  ...
  "settings.general.section.retention": "Lagring og oppbevaring",

  "settings.general.retention.scope":
    "Disse periodene trimmer bare lagrede transkripsjonsdata, noe som frigjør diskplass. De skriver aldri om den varige hendelsesloggen og sletter aldri en sesjon. Skriv 0 for å slå av en periode.",
  "settings.general.retention.never":
    "Av — ingenting trimmes, uansett alder. Lagrede data beholdes i sin helhet til du oppgir et antall dager.",
  "settings.general.row.retentionToolOutput.title": "Verktøyutdata",
  "settings.general.row.retentionToolOutput.description":
    "Etter {{days}} dager reduseres lagrede verktøykalldata i alle sesjoner til en kort forhåndsvisning — første og siste linje. Beholdes: verktøynavnet, inndataene og en forhåndsvisning av resultatet.",
  "settings.general.row.retentionToolOutput.label": "Antall dager fulle verktøyutdata beholdes",
  "settings.general.row.retentionArchivedSessions.title": "Arkiverte sesjoner",
  "settings.general.row.retentionArchivedSessions.description":
    "{{days}} dager etter at en sesjon er arkivert, reduseres verktøydataene og utdataene fra shell-kommandoer til forhåndsvisninger, og for store verktøyinndata tømmes. Beholdes: sesjonen, tittelen, alle brukerforespørsler og alle assistentsvar — transkripsjonen kan fortsatt leses.",
  "settings.general.row.retentionArchivedSessions.label": "Antall dager data fra arkiverte sesjoner beholdes",

  "settings.general.row.language.title": "Språk",
  "settings.general.row.language.description": "Endre visningsspråket for TurenOS",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan TurenOS ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om TurenOS skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan TurenOS er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når TurenOS starter",
  ...
  "settings.updates.row.track.title": "Oppdateringskanal",
  "settings.updates.row.track.description": "Hvor mange versjoner bak den nyeste du vil holde deg",
  "settings.updates.track.option.latest": "Nyeste",
  "settings.updates.track.option.behindOne": "Én versjon bak",
  "settings.updates.track.option.behindTwo": "To versjoner bak",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av TurenOS.",
  ...
  "settings.agents.title": "Agentinnstillinger",
  ...
  "nav.rail.label": "Primærnavigasjon",
  "nav.rail.agents": "Agenter",
  "nav.rail.agents.running": "{{count}} kjører",
  "nav.rail.agents.showPanel": "Agenter — vis panel",
  "nav.rail.agents.hidePanel": "Agenter — skjul panel",
  "nav.rail.settings": "Innstillinger",
  "nav.rail.help": "Hjelp",
  "nav.rail.server": "Server: {{server}}",
  "command.nav.agents": "Gå til Agenter",
  "command.nav.panel.toggle": "Veksle navigasjonspanel",
  ...
  "wsl.onboarding.checkingForge": "Sjekker TurenOS...",
  "wsl.onboarding.checkingForgeIn": "Sjekker TurenOS i {{distro}}...",
  "wsl.onboarding.updatingForge": "Oppdaterer TurenOS...",
  "wsl.onboarding.updatingForgeIn": "Oppdaterer TurenOS i {{distro}}...",
  "wsl.onboarding.updateForgeIn": "Oppdater TurenOS i {{distro}}.",
  "wsl.onboarding.updateForge": "Oppdater TurenOS",
  "wsl.onboarding.forgeReadyIn": "TurenOS er klar i {{distro}}.",
  "wsl.onboarding.forgeReady": "TurenOS er klar.",
  "wsl.onboarding.installForgeIn": "Installer TurenOS i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før TurenOS kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "TurenOS kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter TurenOS på nytt.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Ytelsesdiagnostikk",
  "settings.general.row.performanceDiagnostics.description":
    "Vis utviklingstellere for navigasjon, rendering, inndataforsinkelse, layoutforskyvning og minne",
  "settings.general.section.profiler": "Profilering",
  "settings.general.profiler.scope":
    "Tar bare opp TurenOS-serverprosessen — agentsløyfen, verktøykjøring, komprimering og MCP. Grensesnitt- og vindustid tas ikke opp, så se ikke etter hakking i grensesnittet her.",
  "settings.general.row.profiler.title": "Ta opp CPU-profil",
  "settings.general.row.profiler.description":
    "Start opptaket, gjenskap den trege oppførselen, og stopp deretter. Opptak koster noen få prosent mens det kjører, og ingenting når det er av.",
  "settings.general.profiler.recording":
    "Tar opp — {{elapsed}} har gått. Stopper av seg selv etter 10 minutter. Å avslutte TurenOS forkaster opptaket.",
  "settings.general.profiler.unavailable": "Venter på at TurenOS-serveren skal starte.",
  "settings.general.profiler.failedTitle": "Opptaket mislyktes",
  "settings.general.row.profilerResult.title": "Siste opptak",
  "settings.general.row.profilerResult.description":
    "{{samples}} prøver ved {{rate}} Hz over {{duration}}. Åpne .cpuprofile-filen i Chrome DevTools (Performance › Load profile) eller på speedscope.app.",
  "settings.general.profiler.reveal": "Vis",
