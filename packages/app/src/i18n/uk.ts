...
export const dict = {
  ...
  "command.tab.new": "Нова вкладка",
  "tab.desktop": "Робочий стіл",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у TurenOS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у TurenOS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у TurenOS.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в forge.json",
  ...
  "dialog.server.description": "Перемкніть сервер TurenOS, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingForge": "Перевірка TurenOS...",
  "wsl.onboarding.checkingForgeIn": "Перевірка TurenOS у {{distro}}...",
  "wsl.onboarding.updatingForge": "Оновлення TurenOS...",
  "wsl.onboarding.updatingForgeIn": "Оновлення TurenOS у {{distro}}...",
  "wsl.onboarding.updateForgeIn": "Оновіть TurenOS у {{distro}}.",
  "wsl.onboarding.updateForge": "Оновити TurenOS",
  "wsl.onboarding.forgeReadyIn": "TurenOS готовий до роботи у {{distro}}.",
  "wsl.onboarding.forgeReady": "TurenOS готовий до роботи.",
  "wsl.onboarding.installForgeIn": "Встановіть TurenOS у {{distro}}.",
  "wsl.onboarding.installForge": "Встановити TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в TurenOS потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "TurenOS не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте TurenOS.",
  ...
  "toast.session.compact.success.title": "Сесію стиснуто",
  "toast.session.compact.success.description": "Попередні повідомлення підсумовано, щоб звільнити контекст",
  "toast.session.compact.failed.title": "Не вдалося стиснути сесію",
  ...
  "toast.update.description": "Нова версія TurenOS ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді TurenOS",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (forge.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, TurenOS ще не підтримує автентифікацію MCP.',
  ...
  "nav.rail.label": "Основна навігація",
  "nav.rail.agents": "Агенти",
  "nav.rail.agents.running": "{{count}} виконується",
  "nav.rail.agents.showPanel": "Агенти — показати панель",
  "nav.rail.agents.hidePanel": "Агенти — приховати панель",
  "nav.rail.settings": "Налаштування",
  "nav.rail.help": "Довідка",
  "nav.rail.server": "Сервер: {{server}}",
  "command.nav.agents": "Перейти до агентів",
  "command.nav.panel.toggle": "Перемкнути панель навігації",
  ...
  "settings.section.securityIntegrations": "Інтеграції безпеки",
  "settings.tab.general": "Загальні",
  "settings.tab.shortcuts": "Скорочення",
  "settings.tab.securityData": "Дані",
  "settings.tab.securityTools": "Інструменти",
  "settings.security.search.placeholder": "Пошук інтеграцій",
  "settings.security.data.empty": "Ще немає інтеграцій даних",
  "settings.security.tools.empty": "Ще немає інтеграцій інструментів",
  "settings.security.loadError": "Не вдалося завантажити інтеграції безпеки. Переконайтеся, що ваш сервер оновлено.",
  "settings.security.updateError": "Не вдалося оновити — вашу зміну не збережено.",
  "settings.security.tools.notInstalled": "Не встановлено",
  "settings.security.secret.action": "Ключ API",
  "settings.security.secret.placeholder.set": "Налаштовано — введіть новий ключ для заміни",
  "settings.security.secret.placeholder.unset": "Введіть ключ API",
  "settings.security.secret.clearHint": "Надішліть порожнє значення, щоб видалити збережений ключ.",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "Пошук відомих вразливостей у базі даних відкритого коду OSV.dev",
  "settings.security.integration.depsdev.description": "Стан пакетів, ліцензії та графи залежностей із deps.dev",
  "settings.security.integration.kev.description":
    "Перевірка CVE за каталогом відомих експлуатованих вразливостей CISA",
  "settings.security.integration.epss.description": "Оцінки ймовірності експлуатації CVE від FIRST.org",
  "settings.security.integration.ghsa.description": "Запити до бази даних GitHub Security Advisory",
  "settings.security.integration.hibp.description":
    "Перевірка паролів на витоки — дані за ліцензією CC-BY з haveibeenpwned.com",
  "settings.security.integration.exploitdb.description": "Пошук публічних експлойтів за CVE в індексі Exploit-DB",
  "settings.security.integration.nvd.description": "Відомості про CVE з Національної бази даних вразливостей NIST",
  "settings.security.integration.gitleaks.description": "Сканування робочої області на наявність закомічених секретів",
  "settings.security.integration.trivy.description": "Сканування на вразливості, неправильні конфігурації та секрети",
  "settings.security.integration.osv-scanner.description":
    "Сканування lock-файлів на залежності з відомими вразливостями",
  "settings.security.integration.grype.description": "Сканування вразливостей і генерація SBOM",
  "settings.security.integration.checkov.description": "Сканування інфраструктури як коду на неправильні конфігурації",
  "settings.security.integration.bandit.description": "Статичний аналіз коду Python на проблеми безпеки",
  "settings.security.integration.native-audit.description":
    "Запуск власного аудиту залежностей кожної екосистеми (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "Semgrep-сумісні правила статичного аналізу для робочої області",
  "settings.security.integration.batou.description":
    "Статичне тестування безпеки застосунків на типові вразливості в коді",
  "settings.security.integration.batou.note":
    "Автоматично — сканує кожен файл, який записує агент, і блокує критичні знахідки",
  "settings.security.integration.batou.installHint": "Завантажується автоматично при першому ввімкненні (macOS/Linux)",
  "settings.security.batou.status.downloading": "Завантаження Batou…",
  "settings.security.batou.status.installed": "Встановлено",
  "settings.security.batou.status.failed": "Помилка завантаження",

  "settings.section.agentIntegrations": "Інтеграції агентів",
  "settings.tab.agentData": "Дані",
  "settings.tab.agentTools": "Інструменти",
  "settings.agent.data.empty": "Ще немає інтеграцій даних",
  "settings.agent.tools.empty": "Ще немає інтеграцій інструментів",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Інтеграція WSL",
  "settings.desktop.wsl.description": "Запускати сервер TurenOS всередині WSL на Windows.",
  ...
  "settings.general.section.retention": "Сховище та термін зберігання",

  "settings.general.retention.scope":
    "Ці інтервали лише скорочують збережений вміст стенограм, що звільняє місце на диску. Вони ніколи не переписують постійний журнал подій і ніколи не видаляють сесію. Введіть 0, щоб вимкнути інтервал.",
  "settings.general.retention.never":
    "Вимкнено — нічого не скорочується незалежно від давності. Збережений вміст зберігається повністю, доки ви не введете кількість днів.",
  "settings.general.row.retentionToolOutput.title": "Вивід інструментів",
  "settings.general.row.retentionToolOutput.description":
    "Через {{days}} днів збережений вміст викликів інструментів у всіх сесіях скорочується до короткого попереднього перегляду — першого та останнього рядків. Зберігаються: назва інструмента, його вхідні дані та попередній перегляд результату.",
  "settings.general.row.retentionToolOutput.label": "Днів зберігати повний вивід інструментів",
  "settings.general.row.retentionArchivedSessions.title": "Заархівовані сесії",
  "settings.general.row.retentionArchivedSessions.description":
    "Через {{days}} днів після архівування сесії вміст викликів її інструментів і вивід команд оболонки скорочуються до попередніх переглядів, а завеликі вхідні дані інструментів очищаються. Зберігаються: сама сесія, її назва, усі запити користувача та всі відповіді асистента — стенограму все одно можна прочитати.",
  "settings.general.row.retentionArchivedSessions.label": "Днів зберігати вміст заархівованих сесій",

  "settings.general.row.language.title": "Мова",
  "settings.general.row.language.description": "Змінити мову інтерфейсу TurenOS",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд TurenOS на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи TurenOS використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему TurenOS.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Діагностика продуктивності",
  "settings.general.row.performanceDiagnostics.description":
    "Показувати лічильники розробки для навігації, рендерингу, затримки введення, зсуву макета та пам'яті",
  "settings.general.section.profiler": "Профайлер",
  "settings.general.profiler.scope":
    "Записує лише процес сервера TurenOS — цикл агента, виконання інструментів, стиснення та MCP. Час інтерфейсу та вікна не записується, тож не шукайте тут підвисань інтерфейсу.",
  "settings.general.row.profiler.title": "Записати профіль CPU",
  "settings.general.row.profiler.description":
    "Почніть запис, відтворіть повільну поведінку, а потім зупиніть його. Запис витрачає кілька відсотків під час роботи й нічого, коли вимкнений.",
  "settings.general.profiler.recording":
    "Триває запис — минуло {{elapsed}}. Зупиняється самостійно через 10 хвилин. Вихід із TurenOS відкидає запис.",
  "settings.general.profiler.unavailable": "Очікування запуску сервера TurenOS.",
  "settings.general.profiler.failedTitle": "Не вдалося виконати запис",
  "settings.general.row.profilerResult.title": "Останній запис",
  "settings.general.row.profilerResult.description":
    "{{samples}} семплів із частотою {{rate}} Гц за {{duration}}. Відкрийте файл .cpuprofile у Chrome DevTools (Performance › Load profile) або на speedscope.app.",
  "settings.general.profiler.reveal": "Показати",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску TurenOS",
  ...
  "settings.updates.row.track.title": "Канал оновлень",
  "settings.updates.row.track.description": "На скільки версій відставати від останньої",
  "settings.updates.track.option.latest": "Остання",
  "settings.updates.track.option.behindOne": "На одну версію позаду",
  "settings.updates.track.option.behindTwo": "На дві версії позаду",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію TurenOS.",
  ...
  "settings.agents.title": "Налаштування агентів",
