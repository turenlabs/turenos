...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in TurenOS zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in TurenOS zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in TurenOS zu nutzen.",
  ...
  "dialog.plugins.empty": "In forge.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den TurenOS-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingForge": "TurenOS wird geprüft...",
  "wsl.onboarding.checkingForgeIn": "TurenOS in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingForge": "TurenOS wird aktualisiert...",
  "wsl.onboarding.updatingForgeIn": "TurenOS in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateForgeIn": "Aktualisieren Sie TurenOS in {{distro}}.",
  "wsl.onboarding.updateForge": "TurenOS aktualisieren",
  "wsl.onboarding.forgeReadyIn": "TurenOS ist in {{distro}} bereit.",
  "wsl.onboarding.forgeReady": "TurenOS ist bereit.",
  "wsl.onboarding.installForgeIn": "Installieren Sie TurenOS in {{distro}}.",
  "wsl.onboarding.installForge": "TurenOS installieren",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor TurenOS einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "TurenOS konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann TurenOS erneut.",
  ...
  "toast.session.compact.success.title": "Sitzung komprimiert",
  "toast.session.compact.success.description": "Frühere Nachrichten wurden zusammengefasst, um Kontext freizugeben",
  "toast.session.compact.failed.title": "Sitzung konnte nicht komprimiert werden",
  "toast.session.listFailed.title": "Sitzungen für {{project}} konnten nicht geladen werden",
  "toast.update.title": "Update verfügbar",
  "toast.update.description": "Eine neue Version von TurenOS ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem TurenOS-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (forge.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: TurenOS unterstützt noch keine MCP-Authentifizierung.',
  ...
  "settings.section.securityIntegrations": "Sicherheitsintegrationen",
  "settings.tab.general": "Allgemein",
  "settings.tab.shortcuts": "Tastenkombinationen",
  "settings.tab.securityData": "Daten",
  "settings.tab.securityTools": "Tools",
  "settings.security.search.placeholder": "Integrationen durchsuchen",
  "settings.security.data.empty": "Noch keine Datenintegrationen",
  "settings.security.tools.empty": "Noch keine Tool-Integrationen",
  "settings.security.loadError":
    "Sicherheitsintegrationen konnten nicht geladen werden. Prüfen Sie, ob Ihr Server auf dem neuesten Stand ist.",
  "settings.security.updateError": "Aktualisierung fehlgeschlagen — Ihre Änderung wurde nicht gespeichert.",
  "settings.security.tools.notInstalled": "Nicht installiert",
  "settings.security.secret.action": "API-Schlüssel",
  "settings.security.secret.placeholder.set": "Konfiguriert — neuen Schlüssel eingeben, um ihn zu ersetzen",
  "settings.security.secret.placeholder.unset": "API-Schlüssel eingeben",
  "settings.security.secret.clearHint": "Übermitteln Sie einen leeren Wert, um den gespeicherten Schlüssel zu löschen.",
  ...
  "settings.security.integration.osv.description":
    "Bekannte Schwachstellen in der Open-Source-Datenbank OSV.dev nachschlagen",
  "settings.security.integration.depsdev.description": "Paketzustand, Lizenzen und Abhängigkeitsgraphen von deps.dev",
  "settings.security.integration.kev.description":
    "CVEs mit dem Known-Exploited-Vulnerabilities-Katalog der CISA abgleichen",
  "settings.security.integration.epss.description": "Exploit-Wahrscheinlichkeitswerte für CVEs von FIRST.org",
  "settings.security.integration.ghsa.description": "Die GitHub-Security-Advisory-Datenbank abfragen",
  "settings.security.integration.hibp.description":
    "Prüfung auf kompromittierte Passwörter — Daten unter CC-BY-Lizenz von haveibeenpwned.com",
  "settings.security.integration.exploitdb.description":
    "Den Exploit-DB-Index nach öffentlichen Exploits per CVE durchsuchen",
  "settings.security.integration.nvd.description": "CVE-Details aus der NIST National Vulnerability Database",
  "settings.security.integration.gitleaks.description": "Den Arbeitsbereich auf committete Geheimnisse scannen",
  "settings.security.integration.trivy.description": "Auf Schwachstellen, Fehlkonfigurationen und Geheimnisse scannen",
  "settings.security.integration.osv-scanner.description":
    "Lockfiles auf Abhängigkeiten mit bekannten Schwachstellen scannen",
  "settings.security.integration.grype.description": "Schwachstellen-Scans und SBOM-Erstellung",
  "settings.security.integration.checkov.description": "Infrastructure-as-Code auf Fehlkonfigurationen scannen",
  "settings.security.integration.bandit.description": "Statische Analyse für Python-Sicherheitsprobleme",
  "settings.security.integration.native-audit.description":
    "Das eigene Abhängigkeits-Audit jedes Ökosystems ausführen (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "Semgrep-kompatible statische Analyseregeln über den Arbeitsbereich",
  "settings.security.integration.batou.description":
    "Statische Anwendungssicherheitstests für häufige Schwachstellen im Code",
  "settings.security.integration.batou.note":
    "Automatisch — scannt jede Datei, die der Agent schreibt; blockiert kritische Funde",
  "settings.security.integration.batou.installHint":
    "Wird beim ersten Aktivieren automatisch heruntergeladen (macOS/Linux)",
  "settings.security.batou.status.downloading": "Batou wird heruntergeladen…",
  "settings.security.batou.status.installed": "Installiert",
  "settings.security.batou.status.failed": "Download fehlgeschlagen",

  "settings.section.agentIntegrations": "Agenten-Integrationen",
  "settings.tab.agentData": "Daten",
  "settings.tab.agentTools": "Tools",
  "settings.agent.data.empty": "Noch keine Datenintegrationen",
  "settings.agent.tools.empty": "Noch keine Tool-Integrationen",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-Integration",
  "settings.desktop.wsl.description": "TurenOS-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.section.retention": "Speicher und Aufbewahrung",
  "settings.general.retention.scope":
    "Diese Zeitfenster kürzen nur gespeicherte Transkriptinhalte und geben so Speicherplatz frei. Sie schreiben das dauerhafte Ereignisprotokoll niemals um und löschen niemals eine Sitzung. Geben Sie 0 ein, um ein Zeitfenster auszuschalten.",
  "settings.general.retention.never":
    "Aus — unabhängig vom Alter wird nichts gekürzt. Gespeicherte Inhalte bleiben vollständig erhalten, bis Sie eine Anzahl von Tagen eingeben.",
  "settings.general.row.retentionToolOutput.title": "Tool-Ausgabe",
  "settings.general.row.retentionToolOutput.description":
    "Nach {{days}} Tagen werden gespeicherte Inhalte von Tool-Aufrufen in allen Sitzungen auf eine kurze Vorschau gekürzt — die erste und die letzte Zeile. Erhalten bleiben: der Name des Tools, seine Eingaben und eine Vorschau des Ergebnisses.",
  "settings.general.row.retentionToolOutput.label": "Tage, für die die vollständige Tool-Ausgabe aufbewahrt wird",
  "settings.general.row.retentionArchivedSessions.title": "Archivierte Sitzungen",
  "settings.general.row.retentionArchivedSessions.description":
    "{{days}} Tage nach der Archivierung einer Sitzung werden ihre Tool-Inhalte und die Ausgabe von Shell-Befehlen auf Vorschauen gekürzt und übergroße Tool-Eingaben gelöscht. Erhalten bleiben: die Sitzung, ihr Titel, jede Benutzereingabe und alle Antworten des Assistenten — das Transkript bleibt lesbar.",
  "settings.general.row.retentionArchivedSessions.label":
    "Tage, für die Inhalte archivierter Sitzungen aufbewahrt werden",
  "settings.general.row.language.title": "Sprache",
  "settings.general.row.language.description": "Die Anzeigesprache für TurenOS ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie TurenOS auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob TurenOS dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von TurenOS anpassen.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Leistungsdiagnose",
  "settings.general.row.performanceDiagnostics.description":
    "Entwicklungszähler für Navigation, Rendering, Eingabeverzögerung, Layoutverschiebung und Speicher anzeigen",
  "settings.general.section.profiler": "Profiler",
  "settings.general.profiler.scope":
    "Zeichnet nur den TurenOS-Serverprozess auf — die Agentenschleife, die Werkzeugausführung, die Komprimierung und MCP. Oberflächen- und Fensterzeit werden nicht aufgezeichnet, suchen Sie hier also nicht nach Hängern der Benutzeroberfläche.",
  "settings.general.row.profiler.title": "CPU-Profil aufzeichnen",
  "settings.general.row.profiler.description":
    "Aufzeichnung starten, das langsame Verhalten reproduzieren und dann stoppen. Die Aufzeichnung kostet während des Laufs ein paar Prozent und nichts, wenn sie aus ist.",
  "settings.general.profiler.recording":
    "Aufzeichnung läuft — {{elapsed}} vergangen. Stoppt nach 10 Minuten von selbst. Beim Beenden von TurenOS wird die Aufzeichnung verworfen.",
  "settings.general.profiler.unavailable": "Warten auf den Start des TurenOS-Servers.",
  "settings.general.profiler.failedTitle": "Aufzeichnung fehlgeschlagen",
  "settings.general.row.profilerResult.title": "Letzte Aufzeichnung",
  "settings.general.row.profilerResult.description":
    "{{samples}} Samples mit {{rate}} Hz über {{duration}}. Öffnen Sie die .cpuprofile-Datei in Chrome DevTools (Performance › Load profile) oder auf speedscope.app.",
  "settings.general.profiler.reveal": "Anzeigen",
  ...
  "settings.updates.row.startup.description": "Beim Start von TurenOS automatisch nach Updates suchen",
  ...
  "settings.updates.row.track.title": "Update-Kanal",
  "settings.updates.row.track.description": "Wie viele Versionen hinter der neuesten geblieben werden soll",
  "settings.updates.track.option.latest": "Neueste",
  "settings.updates.track.option.behindOne": "Eine Version zurück",
  "settings.updates.track.option.behindTwo": "Zwei Versionen zurück",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von TurenOS.",
  ...
  "settings.agents.title": "Agenteneinstellungen",
  ...
  "nav.rail.label": "Hauptnavigation",
  "nav.rail.agents": "Agenten",
  "nav.rail.agents.running": "{{count}} aktiv",
  "nav.rail.agents.showPanel": "Agenten — Panel anzeigen",
  "nav.rail.agents.hidePanel": "Agenten — Panel ausblenden",
  "nav.rail.settings": "Einstellungen",
  "nav.rail.help": "Hilfe",
  "nav.rail.server": "Server: {{server}}",
  "command.nav.agents": "Zu Agenten wechseln",
  "command.nav.panel.toggle": "Navigationspanel umschalten",
