export const dict = {
  ...
  "prompt.action.stopping": "Stopping…",
  "session.interrupt.error": "Could not stop the session. Try Stop again.",
  ...
  "dialog.server.remove.title": "Remove server",
  "dialog.server.remove.confirm": 'Remove "{{name}}"?',
  "dialog.server.remove.warning": "This removes the connection and any state it had in this app.",
  "dialog.server.remove.warningManaged":
    "This disconnects and stops the managed server. For SSH hosts the remote TurenOS process is also stopped.",
  "dialog.server.remove.button": "Remove server",
  "dialog.server.remove.failed": "Failed to remove server",
  "dialog.server.unhealthy.title": "Server unavailable",
  "dialog.server.unhealthy.description": "{{name}} is not responding. Check that the server is running and try again.",
  ...
  "ssh.dialog.host": "SSH target",
  "ssh.dialog.hostPlaceholder": "user@host or a Host alias from ~/.ssh/config",
  "ssh.dialog.port": "Port (optional)",
  "ssh.dialog.identityFile": "Identity file (optional)",
  "ssh.dialog.namePlaceholder": "Production server",
  "ssh.dialog.connect": "Connect",
  "ssh.dialog.connecting": "Connecting...",
  "ssh.prompt.password.title": "SSH password",
  "ssh.prompt.passphrase.title": "Key passphrase",
  "ssh.prompt.hostkey.title": "Trust this host key?",
  "ssh.prompt.trust": "Trust and connect",
  "ssh.prompt.submit": "Continue",
  ...
  "session.message.delivery.sending": "Sending…",
  "session.message.delivery.checking": "Checking delivery…",
  "session.message.delivery.unknown": "Delivery unconfirmed. Your prompt is saved on this device.",
  "session.message.delivery.rejected": "The server did not accept this prompt.",
  "session.message.delivery.check": "Check delivery",
  "session.message.delivery.retry": "Retry send",
  "session.message.delivery.saveFailed": "Could not save the prompt",
  ...
  "session.compaction.summary": "View context summary",
  ...
  "session.permission.redirectHint":
    "You can send a correction while waiting. Allow or deny this request to continue, or use Stop to cancel.",
  "session.question.redirectHint":
    "You can send a correction while waiting. Answer or dismiss this question to continue, or use Stop to cancel.",
