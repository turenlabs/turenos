export const dict = {
  ...
  "session.room.title": "Swarm room",
  "session.room.revision": "rev {{head}}",
  "session.room.workers": "{{count}}/{{budget}} workers",
  "session.room.lanesLabel": "Lanes",
  "session.room.empty": "The room is quiet — coordination entries appear here.",
  "session.room.error": "Could not load the swarm room",
  "session.room.refresh": "Refresh",
  "session.room.retry": "Retry",
  "session.room.replyTo": "re #{{seq}} —",
  "session.room.composer.placeholder": "Message the swarm…",
  "session.room.composer.send": "Send",
  ...
  "home.library.older": "Show older sessions",
  "home.library.olderHide": "Hide older sessions",
  ...
  "session.question.composer.hint": "esc dismisses · type an answer",
  "session.question.composer.hintMulti": "esc dismisses · pick any, then enter",
  "session.question.composer.done": "Done",
  ...
  "settings.updates.row.track.title": "Update channel",
  "settings.updates.row.track.description": "How far behind the newest release to stay",
  "settings.updates.track.option.latest": "Latest",
  "settings.updates.track.option.behindOne": "One release behind",
  "settings.updates.track.option.behindTwo": "Two releases behind",
