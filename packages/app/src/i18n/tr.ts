...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve TurenOS'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak TurenOS'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak TurenOS'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler forge.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi TurenOS sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingForge": "TurenOS kontrol ediliyor...",
  "wsl.onboarding.checkingForgeIn": "{{distro}} içinde TurenOS kontrol ediliyor...",
  "wsl.onboarding.updatingForge": "TurenOS güncelleniyor...",
  "wsl.onboarding.updatingForgeIn": "{{distro}} içinde TurenOS güncelleniyor...",
  "wsl.onboarding.updateForgeIn": "{{distro}} içindeki TurenOS'u güncelleyin.",
  "wsl.onboarding.updateForge": "TurenOS'u güncelle",
  "wsl.onboarding.forgeReadyIn": "{{distro}} içinde TurenOS hazır.",
  "wsl.onboarding.forgeReady": "TurenOS hazır.",
  "wsl.onboarding.installForgeIn": "TurenOS'u {{distro}} içine kurun.",
  "wsl.onboarding.installForge": "TurenOS'u kur",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "TurenOS'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "TurenOS bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından TurenOS'u tekrar açın.",
  ...
  "toast.session.compact.success.title": "Oturum sıkıştırıldı",
  "toast.session.compact.success.description": "Bağlam açmak için önceki mesajlar özetlendi",
  "toast.session.compact.failed.title": "Oturum sıkıştırılamadı",

  "toast.session.listFailed.title": "{{project}} için oturumlar yüklenemedi",

  "toast.update.title": "Güncelleme mevcut",
  "toast.update.description": "TurenOS'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı TurenOS ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (forge.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: TurenOS henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "app.name.desktop": "TurenOS Masaüstü",

  "settings.section.desktop": "Masaüstü",
  "settings.section.server": "Sunucu",
  "settings.section.securityIntegrations": "Güvenlik Entegrasyonları",
  "settings.tab.general": "Genel",
  "settings.tab.shortcuts": "Kısayollar",
  "settings.tab.securityData": "Veri",
  "settings.tab.securityTools": "Araçlar",
  "settings.security.search.placeholder": "Entegrasyon ara",
  "settings.security.data.empty": "Henüz veri entegrasyonu yok",
  "settings.security.tools.empty": "Henüz araç entegrasyonu yok",
  "settings.security.loadError": "Güvenlik entegrasyonları yüklenemedi. Sunucunuzun güncel olduğundan emin olun.",
  "settings.security.updateError": "Güncelleme başarısız — değişikliğiniz kaydedilmedi.",
  "settings.security.tools.notInstalled": "Yüklü değil",
  "settings.security.secret.action": "API anahtarı",
  "settings.security.secret.placeholder.set": "Yapılandırıldı — değiştirmek için yeni bir anahtar girin",
  "settings.security.secret.placeholder.unset": "API anahtarını girin",
  "settings.security.secret.clearHint": "Kayıtlı anahtarı silmek için boş bir değer gönderin.",
  ...
  "settings.security.integration.osv.description":
    "OSV.dev açık kaynak veritabanında bilinen güvenlik açıklarını arayın",
  "settings.security.integration.depsdev.description": "deps.dev'den paket sağlığı, lisanslar ve bağımlılık grafikleri",
  "settings.security.integration.kev.description":
    "CVE'leri CISA'nın bilinen istismar edilen güvenlik açıkları kataloğuna göre kontrol edin",
  "settings.security.integration.epss.description": "FIRST.org'dan CVE'ler için istismar olasılığı puanları",
  "settings.security.integration.ghsa.description": "GitHub Security Advisory veritabanını sorgulayın",
  "settings.security.integration.hibp.description":
    "Parola ihlali kontrolleri — veriler haveibeenpwned.com'dan CC-BY lisanslıdır",
  "settings.security.integration.exploitdb.description":
    "Exploit-DB dizininde CVE'ye göre herkese açık exploitleri arayın",
  "settings.security.integration.nvd.description": "NIST National Vulnerability Database'den CVE ayrıntıları",
  "settings.security.integration.gitleaks.description": "Çalışma alanını commit edilmiş gizli bilgiler için tarayın",
  "settings.security.integration.trivy.description":
    "Güvenlik açıkları, yanlış yapılandırmalar ve gizli bilgiler için tarama yapın",
  "settings.security.integration.osv-scanner.description":
    "Lock dosyalarını bilinen güvenlik açığı bulunan bağımlılıklar için tarayın",
  "settings.security.integration.grype.description": "Güvenlik açığı taraması ve SBOM oluşturma",
  "settings.security.integration.checkov.description": "Kod olarak altyapıyı yanlış yapılandırmalar için tarayın",
  "settings.security.integration.bandit.description": "Python güvenlik sorunları için statik analiz",
  "settings.security.integration.native-audit.description":
    "Her ekosistemin kendi bağımlılık denetimini çalıştırın (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description": "Çalışma alanı üzerinde Semgrep uyumlu statik analiz kuralları",
  "settings.security.integration.batou.description":
    "Koddaki yaygın güvenlik açıkları için statik uygulama güvenlik testi",
  "settings.security.integration.batou.note": "Otomatik — ajanın yazdığı her dosyayı tarar; kritik bulguları engeller",
  "settings.security.integration.batou.installHint": "İlk etkinleştirmede otomatik olarak indirilir (macOS/Linux)",
  "settings.security.batou.status.downloading": "Batou indiriliyor…",
  "settings.security.batou.status.installed": "Yüklü",
  "settings.security.batou.status.failed": "İndirme başarısız oldu",

  "settings.section.agentIntegrations": "Ajan Entegrasyonları",
  "settings.tab.agentData": "Veri",
  "settings.tab.agentTools": "Araçlar",
  "settings.agent.data.empty": "Henüz veri entegrasyonu yok",
  "settings.agent.tools.empty": "Henüz araç entegrasyonu yok",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL entegrasyonu",
  "settings.desktop.wsl.description": "TurenOS sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.section.retention": "Depolama ve saklama",

  "settings.general.retention.scope":
    "Bu süreler yalnızca depolanan konuşma kaydı içeriklerini kısaltır ve böylece disk alanı boşaltır. Kalıcı olay günlüğünü asla yeniden yazmaz ve hiçbir oturumu asla silmez. Bir süreyi kapatmak için 0 girin.",
  "settings.general.retention.never":
    "Kapalı — hiçbir yaşta hiçbir şey kısaltılmaz. Siz bir gün sayısı girene kadar depolanan içerikler eksiksiz olarak saklanır.",
  "settings.general.row.retentionToolOutput.title": "Araç çıktısı",
  "settings.general.row.retentionToolOutput.description":
    "{{days}} gün sonra, her oturumdaki depolanan araç çağrısı içerikleri kısa bir önizlemeye — ilk ve son satırlara — indirgenir. Saklananlar: araç adı, girdileri ve sonucun bir önizlemesi.",
  "settings.general.row.retentionToolOutput.label": "Tam araç çıktısının saklanacağı gün sayısı",
  "settings.general.row.retentionArchivedSessions.title": "Arşivlenmiş oturumlar",
  "settings.general.row.retentionArchivedSessions.description":
    "Bir oturum arşivlendikten {{days}} gün sonra, araç içerikleri ve kabuk komutu çıktısı önizlemelere indirgenir ve aşırı büyük araç girdileri temizlenir. Saklananlar: oturumun kendisi, başlığı, tüm kullanıcı istemleri ve tüm asistan yanıtları — konuşma kaydı yine de okunabilir.",
  "settings.general.row.retentionArchivedSessions.label": "Arşivlenmiş oturum içeriklerinin saklanacağı gün sayısı",

  "settings.general.row.language.title": "Dil",
  "settings.general.row.language.description": "TurenOS'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "TurenOS'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "TurenOS'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "TurenOS'un temasını özelleştirin.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Performans tanılama",
  "settings.general.row.performanceDiagnostics.description":
    "Gezinme, işleme, girdi gecikmesi, düzen kayması ve bellek için geliştirme sayaçlarını göster",
  "settings.general.section.profiler": "Profilleyici",
  "settings.general.profiler.scope":
    "Yalnızca TurenOS sunucu sürecini kaydeder — ajan döngüsü, araç yürütme, sıkıştırma ve MCP. Arayüz ve pencere süresi kaydedilmez, bu yüzden arayüz takılmalarını burada aramayın.",
  "settings.general.row.profiler.title": "CPU profili kaydet",
  "settings.general.row.profiler.description":
    "Kaydı başlatın, yavaş davranışı yeniden oluşturun, ardından durdurun. Kayıt çalışırken birkaç yüzdelik maliyeti vardır, kapalıyken hiçbir maliyeti yoktur.",
  "settings.general.profiler.recording":
    "Kaydediliyor — {{elapsed}} geçti. 10 dakika sonra kendiliğinden durur. TurenOS'dan çıkmak kaydı siler.",
  "settings.general.profiler.unavailable": "TurenOS sunucusunun başlaması bekleniyor.",
  "settings.general.profiler.failedTitle": "Kayıt başarısız oldu",
  "settings.general.row.profilerResult.title": "Son kayıt",
  "settings.general.row.profilerResult.description":
    "{{duration}} boyunca {{rate}} Hz ile {{samples}} örnek. .cpuprofile dosyasını Chrome DevTools (Performance › Load profile) içinde veya speedscope.app adresinde açın.",
  "settings.general.profiler.reveal": "Göster",
  ...
  "settings.updates.row.startup.description": "TurenOS başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.row.track.title": "Güncelleme kanalı",
  "settings.updates.row.track.description": "En yeni sürümün kaç sürüm gerisinde kalınacağı",
  "settings.updates.track.option.latest": "En yeni",
  "settings.updates.track.option.behindOne": "Bir sürüm geride",
  "settings.updates.track.option.behindTwo": "İki sürüm geride",
  ...
  "settings.updates.toast.latest.description": "TurenOS'un en son sürümünü kullanıyorsunuz.",
  ...
  "settings.agents.title": "Ajan Ayarları",
  ...
  "nav.rail.label": "Birincil gezinme",
  "nav.rail.agents": "Ajanlar",
  "nav.rail.agents.running": "{{count}} çalışıyor",
  "nav.rail.agents.showPanel": "Ajanlar — paneli göster",
  "nav.rail.agents.hidePanel": "Ajanlar — paneli gizle",
  "nav.rail.settings": "Ayarlar",
  "nav.rail.help": "Yardım",
  "nav.rail.server": "Sunucu: {{server}}",
  "command.nav.agents": "Ajanlara git",
  "command.nav.panel.toggle": "Gezinme panelini aç/kapat",
