...
export const dict = {
  ...
  "command.tab.new": "แท็บใหม่",
  "tab.desktop": "เดสก์ท็อป",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน TurenOS",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน TurenOS",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน TurenOS",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน forge.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ TurenOS ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingForge": "กำลังตรวจสอบ TurenOS...",
  "wsl.onboarding.checkingForgeIn": "กำลังตรวจสอบ TurenOS ใน {{distro}}...",
  "wsl.onboarding.updatingForge": "กำลังอัปเดต TurenOS...",
  "wsl.onboarding.updatingForgeIn": "กำลังอัปเดต TurenOS ใน {{distro}}...",
  "wsl.onboarding.updateForgeIn": "อัปเดต TurenOS ใน {{distro}}.",
  "wsl.onboarding.updateForge": "อัปเดต TurenOS",
  "wsl.onboarding.forgeReadyIn": "TurenOS พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.forgeReady": "TurenOS พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installForgeIn": "ติดตั้ง TurenOS ใน {{distro}}.",
  "wsl.onboarding.installForge": "ติดตั้ง TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "ยังไม่ได้ติดตั้ง TurenOS",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ TurenOS จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "TurenOS ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้.",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด TurenOS อีกครั้ง.",
  ...
  "toast.session.compact.success.title": "บีบอัดเซสชันแล้ว",
  "toast.session.compact.success.description": "สรุปข้อความก่อนหน้าเพื่อเพิ่มพื้นที่บริบทแล้ว",
  "toast.session.compact.failed.title": "บีบอัดเซสชันไม่สำเร็จ",

  "toast.session.listFailed.title": "ไม่สามารถโหลดเซสชันสำหรับ {{project}}",

  "toast.update.title": "มีการอัปเดต",
  "toast.update.description": "เวอร์ชันใหม่ของ TurenOS ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม TurenOS",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (forge.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า TurenOS ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "settings.section.securityIntegrations": "การรวมความปลอดภัย",
  "settings.tab.general": "ทั่วไป",
  "settings.tab.shortcuts": "ทางลัด",
  "settings.tab.securityData": "ข้อมูล",
  "settings.tab.securityTools": "เครื่องมือ",
  "settings.security.search.placeholder": "ค้นหาการรวม",
  "settings.security.data.empty": "ยังไม่มีการรวมข้อมูล",
  "settings.security.tools.empty": "ยังไม่มีการรวมเครื่องมือ",
  "settings.security.loadError": "ไม่สามารถโหลดการรวมความปลอดภัยได้ โปรดตรวจสอบว่าเซิร์ฟเวอร์ของคุณเป็นเวอร์ชันล่าสุด",
  "settings.security.updateError": "การอัปเดตล้มเหลว — การเปลี่ยนแปลงของคุณไม่ถูกบันทึก",
  "settings.security.tools.notInstalled": "ยังไม่ได้ติดตั้ง",
  "settings.security.secret.action": "คีย์ API",
  "settings.security.secret.placeholder.set": "กำหนดค่าแล้ว — ป้อนคีย์ใหม่เพื่อแทนที่",
  "settings.security.secret.placeholder.unset": "ป้อนคีย์ API",
  "settings.security.secret.clearHint": "ส่งค่าว่างเพื่อล้างคีย์ที่บันทึกไว้",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "ค้นหาช่องโหว่ที่ทราบแล้วในฐานข้อมูลโอเพนซอร์ส OSV.dev",
  "settings.security.integration.depsdev.description": "สุขภาพแพ็กเกจ ไลเซนส์ และกราฟการพึ่งพาจาก deps.dev",
  "settings.security.integration.kev.description": "ตรวจสอบ CVE กับแคตตาล็อกช่องโหว่ที่ถูกใช้โจมตีจริง (KEV) ของ CISA",
  "settings.security.integration.epss.description": "คะแนนความน่าจะเป็นในการถูกโจมตีของ CVE จาก FIRST.org",
  "settings.security.integration.ghsa.description": "สืบค้นฐานข้อมูลคำแนะนำด้านความปลอดภัยของ GitHub",
  "settings.security.integration.hibp.description":
    "ตรวจสอบรหัสผ่านที่รั่วไหล — ข้อมูลภายใต้ไลเซนส์ CC-BY จาก haveibeenpwned.com",
  "settings.security.integration.exploitdb.description": "ค้นหาเอ็กซ์พลอยต์สาธารณะในดัชนี Exploit-DB ตาม CVE",
  "settings.security.integration.nvd.description": "รายละเอียด CVE จาก NIST National Vulnerability Database",
  "settings.security.integration.gitleaks.description": "สแกนพื้นที่ทำงานเพื่อหาข้อมูลลับที่ถูกคอมมิต",
  "settings.security.integration.trivy.description": "สแกนหาช่องโหว่ การกำหนดค่าที่ไม่ถูกต้อง และข้อมูลลับ",
  "settings.security.integration.osv-scanner.description": "สแกนไฟล์ล็อกเพื่อหาการพึ่งพาที่มีช่องโหว่ที่ทราบแล้ว",
  "settings.security.integration.grype.description": "การสแกนช่องโหว่และการสร้าง SBOM",
  "settings.security.integration.checkov.description":
    "สแกนโครงสร้างพื้นฐานแบบโค้ด (IaC) เพื่อหาการกำหนดค่าที่ไม่ถูกต้อง",
  "settings.security.integration.bandit.description": "การวิเคราะห์แบบสถิตสำหรับปัญหาความปลอดภัยของ Python",
  "settings.security.integration.native-audit.description":
    "รันการตรวจสอบการพึ่งพาของแต่ละระบบนิเวศเอง (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "รันกฎการวิเคราะห์แบบสถิตที่เข้ากันได้กับ Semgrep บนพื้นที่ทำงาน",
  "settings.security.integration.batou.description": "การทดสอบความปลอดภัยแอปพลิเคชันแบบสถิตสำหรับช่องโหว่ทั่วไปในโค้ด",
  "settings.security.integration.batou.note": "อัตโนมัติ — สแกนทุกไฟล์ที่เอเจนต์เขียน และบล็อกผลลัพธ์ที่ร้ายแรง",
  "settings.security.integration.batou.installHint": "ดาวน์โหลดโดยอัตโนมัติเมื่อเปิดใช้งานครั้งแรก (macOS/Linux)",
  "settings.security.batou.status.downloading": "กำลังดาวน์โหลด Batou…",
  "settings.security.batou.status.installed": "ติดตั้งแล้ว",
  "settings.security.batou.status.failed": "ดาวน์โหลดล้มเหลว",

  "settings.section.agentIntegrations": "การรวมเอเจนต์",
  "settings.tab.agentData": "ข้อมูล",
  "settings.tab.agentTools": "เครื่องมือ",
  "settings.agent.data.empty": "ยังไม่มีการรวมข้อมูล",
  "settings.agent.tools.empty": "ยังไม่มีการรวมเครื่องมือ",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "การรวม WSL",
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ TurenOS ภายใน WSL บน Windows",
  ...
  "settings.general.section.retention": "พื้นที่จัดเก็บและการเก็บรักษาข้อมูล",

  "settings.general.retention.scope":
    "ช่วงเวลาเหล่านี้จะตัดทอนเฉพาะข้อมูลบทสนทนาที่จัดเก็บไว้ เพื่อคืนพื้นที่ว่างในดิสก์ โดยจะไม่เขียนทับบันทึกเหตุการณ์ถาวรและไม่ลบเซสชันใด ๆ ป้อน 0 เพื่อปิดช่วงเวลานั้น",
  "settings.general.retention.never":
    "ปิดอยู่ — ไม่มีการตัดทอนข้อมูลไม่ว่าข้อมูลจะเก่าเพียงใด ข้อมูลที่จัดเก็บไว้จะถูกเก็บไว้ทั้งหมดจนกว่าคุณจะป้อนจำนวนวัน",
  "settings.general.row.retentionToolOutput.title": "ผลลัพธ์ของเครื่องมือ",
  "settings.general.row.retentionToolOutput.description":
    "หลังจาก {{days}} วัน ข้อมูลการเรียกเครื่องมือที่จัดเก็บไว้ในทุกเซสชันจะถูกลดเหลือเพียงตัวอย่างสั้น ๆ คือบรรทัดแรกและบรรทัดสุดท้าย สิ่งที่เก็บไว้: ชื่อเครื่องมือ ข้อมูลนำเข้าของเครื่องมือ และตัวอย่างของผลลัพธ์",
  "settings.general.row.retentionToolOutput.label": "จำนวนวันที่จะเก็บผลลัพธ์ของเครื่องมือแบบเต็ม",
  "settings.general.row.retentionArchivedSessions.title": "เซสชันที่จัดเก็บถาวร",
  "settings.general.row.retentionArchivedSessions.description":
    "{{days}} วันหลังจากที่เซสชันถูกจัดเก็บถาวร ข้อมูลเครื่องมือและผลลัพธ์ของคำสั่งเชลล์ของเซสชันนั้นจะถูกลดเหลือเพียงตัวอย่าง และข้อมูลนำเข้าของเครื่องมือที่ใหญ่เกินไปจะถูกล้าง สิ่งที่เก็บไว้: ตัวเซสชัน ชื่อเซสชัน คำสั่งของผู้ใช้ทุกรายการ และคำตอบทั้งหมดของผู้ช่วย — บทสนทนายังคงอ่านได้",
  "settings.general.row.retentionArchivedSessions.label": "จำนวนวันที่จะเก็บข้อมูลของเซสชันที่จัดเก็บถาวร",

  "settings.general.row.language.title": "ภาษา",
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ TurenOS",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ TurenOS มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ TurenOS ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ TurenOS มีธีม",
  ...
  "settings.general.row.performanceDiagnostics.title": "การวินิจฉัยประสิทธิภาพ",
  "settings.general.row.performanceDiagnostics.description":
    "แสดงตัวนับสำหรับนักพัฒนาเกี่ยวกับการนำทาง การเรนเดอร์ ความหน่วงของอินพุต การขยับของเลย์เอาต์ และหน่วยความจำ",
  "settings.general.section.profiler": "โปรไฟเลอร์",
  "settings.general.profiler.scope":
    "บันทึกเฉพาะโปรเซสของเซิร์ฟเวอร์ TurenOS เท่านั้น — ลูปของเอเจนต์ การเรียกใช้เครื่องมือ การบีบอัด และ MCP โดยไม่บันทึกเวลาของอินเทอร์เฟซและหน้าต่าง จึงไม่ควรมองหาอาการค้างของ UI ที่นี่",
  "settings.general.row.profiler.title": "บันทึกโปรไฟล์ CPU",
  "settings.general.row.profiler.description":
    "เริ่มบันทึก ทำให้เกิดพฤติกรรมที่ช้าอีกครั้ง แล้วจึงหยุด การบันทึกใช้ทรัพยากรเพิ่มขึ้นไม่กี่เปอร์เซ็นต์ขณะทำงาน และไม่ใช้เลยเมื่อปิดอยู่",
  "settings.general.profiler.recording":
    "กำลังบันทึก — ผ่านไป {{elapsed}} จะหยุดเองหลังจาก 10 นาที การออกจาก TurenOS จะทิ้งการบันทึกนี้",
  "settings.general.profiler.unavailable": "กำลังรอให้เซิร์ฟเวอร์ TurenOS เริ่มทำงาน",
  "settings.general.profiler.failedTitle": "การบันทึกล้มเหลว",
  "settings.general.row.profilerResult.title": "การบันทึกล่าสุด",
  "settings.general.row.profilerResult.description":
    "{{samples}} ตัวอย่างที่ {{rate}} Hz ตลอด {{duration}} เปิดไฟล์ .cpuprofile ใน Chrome DevTools (Performance › Load profile) หรือที่ speedscope.app",
  "settings.general.profiler.reveal": "แสดง",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ TurenOS เปิดใช้งาน",
  ...
  "settings.updates.row.track.title": "ช่องทางอัปเดต",
  "settings.updates.row.track.description": "ต้องการตามหลังเวอร์ชันล่าสุดกี่เวอร์ชัน",
  "settings.updates.track.option.latest": "ล่าสุด",
  "settings.updates.track.option.behindOne": "ตามหลังหนึ่งเวอร์ชัน",
  "settings.updates.track.option.behindTwo": "ตามหลังสองเวอร์ชัน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน TurenOS เวอร์ชันล่าสุด",
  ...
  "settings.agents.title": "การตั้งค่าเอเจนต์",
  ...
  "nav.rail.label": "การนำทางหลัก",
  "nav.rail.agents": "เอเจนต์",
  "nav.rail.agents.running": "กำลังทำงาน {{count}} รายการ",
  "nav.rail.agents.showPanel": "เอเจนต์ — แสดงแผง",
  "nav.rail.agents.hidePanel": "เอเจนต์ — ซ่อนแผง",
  "nav.rail.settings": "การตั้งค่า",
  "nav.rail.help": "ช่วยเหลือ",
  "nav.rail.server": "เซิร์ฟเวอร์: {{server}}",
  "command.nav.agents": "ไปที่เอเจนต์",
  "command.nav.panel.toggle": "สลับแผงการนำทาง",
