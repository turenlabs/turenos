...
export const dict = {
  ...
  "command.tab.new": "علامة تبويب جديدة",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في TurenOS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في TurenOS.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في TurenOS.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في forge.json",
  ...
  "dialog.server.description": "تبديل خادم TurenOS الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingForge": "جارٍ التحقق من TurenOS...",
  "wsl.onboarding.checkingForgeIn": "جارٍ التحقق من TurenOS في {{distro}}...",
  "wsl.onboarding.updatingForge": "جارٍ تحديث TurenOS...",
  "wsl.onboarding.updatingForgeIn": "جارٍ تحديث TurenOS في {{distro}}...",
  "wsl.onboarding.updateForgeIn": "حدّث TurenOS في {{distro}}.",
  "wsl.onboarding.updateForge": "تحديث TurenOS",
  "wsl.onboarding.forgeReadyIn": "TurenOS جاهز في {{distro}}.",
  "wsl.onboarding.forgeReady": "TurenOS جاهز.",
  "wsl.onboarding.installForgeIn": "ثبّت TurenOS في {{distro}}.",
  "wsl.onboarding.installForge": "تثبيت TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن TurenOS من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على TurenOS التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح TurenOS.",
  ...
  "toast.session.compact.success.title": "تم ضغط الجلسة",
  "toast.session.compact.success.description": "تم تلخيص الرسائل السابقة لتحرير مساحة في السياق",
  "toast.session.compact.failed.title": "فشل ضغط الجلسة",
  "toast.session.listFailed.title": "فشل تحميل الجلسات لـ {{project}}",
  "toast.update.title": "تحديث متاح",
  "toast.update.description": "نسخة جديدة من TurenOS ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق TurenOS",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (forge.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن TurenOS لا يدعم مصادقة MCP بعد.',
  ...
  "settings.section.securityIntegrations": "تكاملات الأمان",
  "settings.tab.general": "عام",
  "settings.tab.shortcuts": "اختصارات",
  "settings.tab.securityData": "البيانات",
  "settings.tab.securityTools": "الأدوات",
  "settings.security.search.placeholder": "البحث في التكاملات",
  "settings.security.data.empty": "لا توجد تكاملات بيانات بعد",
  "settings.security.tools.empty": "لا توجد تكاملات أدوات بعد",
  "settings.security.loadError": "تعذر تحميل تكاملات الأمان. تأكد من أن الخادم لديك محدّث.",
  "settings.security.updateError": "فشل التحديث — لم يتم حفظ التغيير.",
  "settings.security.tools.notInstalled": "غير مثبّت",
  "settings.security.secret.action": "مفتاح API",
  "settings.security.secret.placeholder.set": "تم التكوين — أدخل مفتاحًا جديدًا للاستبدال",
  "settings.security.secret.placeholder.unset": "أدخل مفتاح API",
  "settings.security.secret.clearHint": "أرسل قيمة فارغة لمسح المفتاح المخزّن.",
  ...
  "settings.security.integration.osv.description":
    "البحث عن الثغرات الأمنية المعروفة في قاعدة بيانات المصادر المفتوحة OSV.dev",
  "settings.security.integration.depsdev.description": "صحة الحزم والتراخيص ومخططات التبعيات من deps.dev",
  "settings.security.integration.kev.description": "التحقق من CVE مقابل كتالوج الثغرات المستغلة المعروفة من CISA",
  "settings.security.integration.epss.description": "درجات احتمالية الاستغلال لـ CVE من FIRST.org",
  "settings.security.integration.ghsa.description": "الاستعلام في قاعدة بيانات GitHub Security Advisory",
  "settings.security.integration.hibp.description":
    "فحص تسريبات كلمات المرور — بيانات مرخصة CC-BY من haveibeenpwned.com",
  "settings.security.integration.exploitdb.description": "البحث في فهرس Exploit-DB عن برمجيات استغلال علنية حسب CVE",
  "settings.security.integration.nvd.description": "تفاصيل CVE من قاعدة البيانات الوطنية للثغرات التابعة لـ NIST",
  "settings.security.integration.gitleaks.description": "فحص مساحة العمل بحثًا عن الأسرار المضمّنة في commits",
  "settings.security.integration.trivy.description": "فحص الثغرات الأمنية والتكوينات الخاطئة والأسرار",
  "settings.security.integration.osv-scanner.description": "فحص ملفات القفل بحثًا عن تبعيات ذات ثغرات معروفة",
  "settings.security.integration.grype.description": "فحص الثغرات الأمنية وإنشاء SBOM",
  "settings.security.integration.checkov.description": "فحص البنية التحتية ككود بحثًا عن التكوينات الخاطئة",
  "settings.security.integration.bandit.description": "تحليل ثابت لمشاكل الأمان في Python",
  "settings.security.integration.native-audit.description":
    "تشغيل تدقيق التبعيات الخاص بكل منظومة (npm و pip و cargo و Go)",
  "settings.security.integration.opengrep.description": "قواعد تحليل ثابت متوافقة مع Semgrep على مساحة العمل",
  "settings.security.integration.batou.description": "اختبار أمان التطبيقات الثابت للثغرات الشائعة في الشيفرة",
  "settings.security.integration.batou.note": "تلقائي — يفحص كل ملف يكتبه الوكيل، ويحظر النتائج الحرجة",
  "settings.security.integration.batou.installHint": "يتم التنزيل تلقائيًا عند التفعيل الأول (macOS/Linux)",
  "settings.security.batou.status.downloading": "جارٍ تنزيل Batou…",
  "settings.security.batou.status.installed": "مثبّت",
  "settings.security.batou.status.failed": "فشل التنزيل",

  "settings.section.agentIntegrations": "تكاملات الوكلاء",
  "settings.tab.agentData": "البيانات",
  "settings.tab.agentTools": "الأدوات",
  "settings.agent.data.empty": "لا توجد تكاملات بيانات بعد",
  "settings.agent.tools.empty": "لا توجد تكاملات أدوات بعد",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "تكامل WSL",
  "settings.desktop.wsl.description": "تشغيل خادم TurenOS داخل WSL على Windows.",
  ...
  "settings.general.section.retention": "التخزين والاحتفاظ",
  "settings.general.retention.scope":
    "تقلّص هذه الفترات محتويات النصوص المخزَّنة فقط، ما يوفّر مساحة على القرص. وهي لا تعيد كتابة سجل الأحداث الدائم أبدًا، ولا تحذف أي جلسة. أدخل 0 لإيقاف أي فترة.",
  "settings.general.retention.never":
    "متوقّف: لا يتم تقليص أي شيء مهما بلغ عمره. تُحفظ المحتويات المخزَّنة كاملةً إلى أن تُدخل عدد الأيام.",
  "settings.general.row.retentionToolOutput.title": "مخرجات الأدوات",
  "settings.general.row.retentionToolOutput.description":
    "بعد {{days}} يومًا، تُختصر محتويات استدعاءات الأدوات المخزَّنة في كل جلسة إلى معاينة قصيرة تضم السطرين الأول والأخير. ويُحتفظ باسم الأداة ومدخلاتها ومعاينة للنتيجة.",
  "settings.general.row.retentionToolOutput.label": "عدد أيام الاحتفاظ بمخرجات الأدوات كاملةً",
  "settings.general.row.retentionArchivedSessions.title": "الجلسات المؤرشفة",
  "settings.general.row.retentionArchivedSessions.description":
    "بعد {{days}} يومًا من أرشفة الجلسة، تُختصر محتويات أدواتها ومخرجات أوامر shell إلى معاينات، وتُمسح مدخلات الأدوات كبيرة الحجم. ويُحتفظ بالجلسة وعنوانها وبكل مطالبات المستخدم وجميع ردود المساعد، بحيث يظل النص قابلاً للقراءة.",
  "settings.general.row.retentionArchivedSessions.label": "عدد أيام الاحتفاظ بمحتويات الجلسات المؤرشفة",
  "settings.general.row.language.title": "اللغة",
  "settings.general.row.language.description": "تغيير لغة العرض لـ TurenOS",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور TurenOS على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان TurenOS يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة TurenOS.",
  ...
  "settings.general.row.performanceDiagnostics.title": "تشخيصات الأداء",
  "settings.general.row.performanceDiagnostics.description":
    "إظهار عدادات التطوير للتنقل والعرض وتأخير الإدخال وإزاحة التخطيط والذاكرة",
  "settings.general.section.profiler": "محلل الأداء",
  "settings.general.profiler.scope":
    "يسجل عملية خادم TurenOS فقط — حلقة الوكيل، وتنفيذ الأدوات، والضغط، و MCP. لا يتم تسجيل وقت الواجهة والنافذة، لذا لا تبحث هنا عن تجمد واجهة المستخدم.",
  "settings.general.row.profiler.title": "تسجيل ملف تعريف CPU",
  "settings.general.row.profiler.description":
    "ابدأ التسجيل، وأعد إنتاج السلوك البطيء، ثم أوقفه. يكلف التسجيل بضعة بالمئة أثناء تشغيله ولا شيء عند إيقافه.",
  "settings.general.profiler.recording":
    "جارٍ التسجيل — مضى {{elapsed}}. يتوقف من تلقاء نفسه بعد 10 دقائق. إنهاء TurenOS يتجاهل التسجيل.",
  "settings.general.profiler.unavailable": "في انتظار بدء تشغيل خادم TurenOS.",
  "settings.general.profiler.failedTitle": "فشل التسجيل",
  "settings.general.row.profilerResult.title": "آخر تسجيل",
  "settings.general.row.profilerResult.description":
    "{{samples}} عينة بمعدل {{rate}} هرتز على مدى {{duration}}. افتح ملف .cpuprofile في Chrome DevTools (Performance › Load profile) أو على speedscope.app.",
  "settings.general.profiler.reveal": "إظهار",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل TurenOS",
  ...
  "settings.updates.row.track.title": "قناة التحديث",
  "settings.updates.row.track.description": "كم إصدارًا تريد التأخر عن أحدث إصدار",
  "settings.updates.track.option.latest": "الأحدث",
  "settings.updates.track.option.behindOne": "بفارق إصدار واحد",
  "settings.updates.track.option.behindTwo": "بفارق إصدارين",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من TurenOS.",
  ...
  "settings.agents.title": "إعدادات الوكلاء",
  ...
  "nav.rail.label": "التنقل الرئيسي",
  "nav.rail.agents": "الوكلاء",
  "nav.rail.agents.running": "{{count}} قيد التشغيل",
  "nav.rail.agents.showPanel": "الوكلاء — إظهار اللوحة",
  "nav.rail.agents.hidePanel": "الوكلاء — إخفاء اللوحة",
  "nav.rail.settings": "الإعدادات",
  "nav.rail.help": "مساعدة",
  "nav.rail.server": "الخادم: {{server}}",
  "command.nav.agents": "الانتقال إلى الوكلاء",
  "command.nav.panel.toggle": "تبديل لوحة التنقل",
