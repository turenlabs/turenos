...
export const dict = {
  ...
  "command.tab.new": "Nueva pestaña",
  "tab.desktop": "Escritorio",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en TurenOS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en TurenOS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en TurenOS.",
  ...
  "dialog.plugins.empty": "Plugins configurados en forge.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de TurenOS se conecta esta app.",
  ...
  "wsl.onboarding.checkingForge": "Comprobando TurenOS...",
  "wsl.onboarding.checkingForgeIn": "Comprobando TurenOS en {{distro}}...",
  "wsl.onboarding.updatingForge": "Actualizando TurenOS...",
  "wsl.onboarding.updatingForgeIn": "Actualizando TurenOS en {{distro}}...",
  "wsl.onboarding.updateForgeIn": "Actualiza TurenOS en {{distro}}.",
  "wsl.onboarding.updateForge": "Actualizar TurenOS",
  "wsl.onboarding.forgeReadyIn": "TurenOS está listo en {{distro}}.",
  "wsl.onboarding.forgeReady": "TurenOS está listo.",
  "wsl.onboarding.installForgeIn": "Instala TurenOS en {{distro}}.",
  "wsl.onboarding.installForge": "Instalar TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que TurenOS pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "TurenOS no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir TurenOS.",
  ...
  "toast.session.compact.success.title": "Sesión compactada",
  "toast.session.compact.success.description": "Los mensajes anteriores se resumieron para liberar contexto",
  "toast.session.compact.failed.title": "No se pudo compactar la sesión",

  "toast.session.listFailed.title": "Fallo al cargar sesiones para {{project}}",

  "toast.update.title": "Actualización disponible",
  "toast.update.description": "Una nueva versión de TurenOS ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de TurenOS",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (forge.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, TurenOS no soporta autenticación MCP todavía.',
  ...
  "settings.section.securityIntegrations": "Integraciones de seguridad",
  "settings.tab.general": "General",
  "settings.tab.shortcuts": "Atajos",
  "settings.tab.securityData": "Datos",
  "settings.tab.securityTools": "Herramientas",
  "settings.security.search.placeholder": "Buscar integraciones",
  "settings.security.data.empty": "Aún no hay integraciones de datos",
  "settings.security.tools.empty": "Aún no hay integraciones de herramientas",
  "settings.security.loadError":
    "No se pudieron cargar las integraciones de seguridad. Comprueba que tu servidor esté actualizado.",
  "settings.security.updateError": "La actualización falló — tu cambio no se guardó.",
  "settings.security.tools.notInstalled": "No instalado",
  "settings.security.secret.action": "Clave API",
  "settings.security.secret.placeholder.set": "Configurada — introduce una clave nueva para reemplazarla",
  "settings.security.secret.placeholder.unset": "Introduce la clave API",
  "settings.security.secret.clearHint": "Envía un valor vacío para borrar la clave guardada.",
  ...
  "settings.security.integration.osv.description":
    "Consultar vulnerabilidades conocidas en la base de datos de código abierto OSV.dev",
  "settings.security.integration.depsdev.description":
    "Estado de los paquetes, licencias y grafos de dependencias de deps.dev",
  "settings.security.integration.kev.description":
    "Comprobar CVE contra el catálogo Known Exploited Vulnerabilities de CISA",
  "settings.security.integration.epss.description": "Puntuaciones de probabilidad de explotación para CVE de FIRST.org",
  "settings.security.integration.ghsa.description": "Consultar la base de datos GitHub Security Advisory",
  "settings.security.integration.hibp.description":
    "Comprobación de contraseñas filtradas — datos con licencia CC-BY de haveibeenpwned.com",
  "settings.security.integration.exploitdb.description": "Buscar exploits públicos por CVE en el índice de Exploit-DB",
  "settings.security.integration.nvd.description": "Detalles de CVE de la National Vulnerability Database del NIST",
  "settings.security.integration.gitleaks.description":
    "Escanear el espacio de trabajo en busca de secretos incluidos en commits",
  "settings.security.integration.trivy.description":
    "Escanear en busca de vulnerabilidades, configuraciones incorrectas y secretos",
  "settings.security.integration.osv-scanner.description":
    "Escanear los lockfiles en busca de dependencias con vulnerabilidades conocidas",
  "settings.security.integration.grype.description": "Escaneo de vulnerabilidades y generación de SBOM",
  "settings.security.integration.checkov.description":
    "Escanear la infraestructura como código en busca de configuraciones incorrectas",
  "settings.security.integration.bandit.description": "Análisis estático de problemas de seguridad en Python",
  "settings.security.integration.native-audit.description":
    "Ejecutar la auditoría de dependencias propia de cada ecosistema (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "Reglas de análisis estático compatibles con Semgrep sobre el espacio de trabajo",
  "settings.security.integration.batou.description":
    "Pruebas estáticas de seguridad de aplicaciones para vulnerabilidades comunes del código",
  "settings.security.integration.batou.note":
    "Automático — escanea cada archivo que escribe el agente; bloquea hallazgos críticos",
  "settings.security.integration.batou.installHint":
    "Se descarga automáticamente al activar por primera vez (macOS/Linux)",
  "settings.security.batou.status.downloading": "Descargando Batou…",
  "settings.security.batou.status.installed": "Instalado",
  "settings.security.batou.status.failed": "Error de descarga",

  "settings.section.agentIntegrations": "Integraciones de agentes",
  "settings.tab.agentData": "Datos",
  "settings.tab.agentTools": "Herramientas",
  "settings.agent.data.empty": "Aún no hay integraciones de datos",
  "settings.agent.tools.empty": "Aún no hay integraciones de herramientas",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integración con WSL",
  "settings.desktop.wsl.description": "Ejecutar el servidor TurenOS dentro de WSL en Windows.",
  ...
  "settings.general.section.retention": "Almacenamiento y retención",

  "settings.general.retention.scope":
    "Estas ventanas solo recortan las cargas útiles de las transcripciones almacenadas, lo que libera espacio en disco. Nunca reescriben el registro de eventos duradero ni eliminan una sesión. Introduce 0 para desactivar una ventana.",
  "settings.general.retention.never":
    "Desactivado: no se recorta nada, sin importar la antigüedad. Las cargas útiles almacenadas se conservan íntegras hasta que introduzcas un número de días.",
  "settings.general.row.retentionToolOutput.title": "Salida de herramientas",
  "settings.general.row.retentionToolOutput.description":
    "Después de {{days}} días, las cargas útiles de las llamadas a herramientas almacenadas en todas las sesiones se reducen a una vista previa breve: las primeras y las últimas líneas. Se conservan: el nombre de la herramienta, sus entradas y una vista previa del resultado.",
  "settings.general.row.retentionToolOutput.label": "Días para conservar la salida completa de las herramientas",
  "settings.general.row.retentionArchivedSessions.title": "Sesiones archivadas",
  "settings.general.row.retentionArchivedSessions.description":
    "{{days}} días después de archivar una sesión, sus cargas útiles de herramientas y la salida de los comandos de shell se reducen a vistas previas, y las entradas de herramientas demasiado grandes se borran. Se conservan: la sesión, su título, todas las indicaciones del usuario y todas las respuestas del asistente; la transcripción se sigue leyendo.",
  "settings.general.row.retentionArchivedSessions.label":
    "Días para conservar las cargas útiles de las sesiones archivadas",

  "settings.general.row.language.title": "Idioma",
  "settings.general.row.language.description": "Cambiar el idioma de visualización para TurenOS",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve TurenOS en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si TurenOS sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de TurenOS.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Diagnósticos de rendimiento",
  "settings.general.row.performanceDiagnostics.description":
    "Mostrar contadores de desarrollo para navegación, renderizado, retraso de entrada, desplazamiento de diseño y memoria",
  "settings.general.section.profiler": "Perfilador",
  "settings.general.profiler.scope":
    "Registra solo el proceso del servidor de TurenOS: el bucle del agente, la ejecución de herramientas, la compactación y MCP. El tiempo de la interfaz y de la ventana no se registra, así que no busques aquí los bloqueos de la interfaz.",
  "settings.general.row.profiler.title": "Grabar perfil de CPU",
  "settings.general.row.profiler.description":
    "Inicia la grabación, reproduce el comportamiento lento y luego detenla. La grabación cuesta un pequeño porcentaje mientras se ejecuta y nada cuando está desactivada.",
  "settings.general.profiler.recording":
    "Grabando — {{elapsed}} transcurridos. Se detiene sola después de 10 minutos. Salir de TurenOS descarta la grabación.",
  "settings.general.profiler.unavailable": "Esperando a que se inicie el servidor de TurenOS.",
  "settings.general.profiler.failedTitle": "Error en la grabación",
  "settings.general.row.profilerResult.title": "Última grabación",
  "settings.general.row.profilerResult.description":
    "{{samples}} muestras a {{rate}} Hz durante {{duration}}. Abre el archivo .cpuprofile en Chrome DevTools (Performance › Load profile) o en speedscope.app.",
  "settings.general.profiler.reveal": "Mostrar",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia TurenOS",
  ...
  "settings.updates.row.track.title": "Canal de actualización",
  "settings.updates.row.track.description": "Cuántas versiones por detrás de la más reciente mantenerse",
  "settings.updates.track.option.latest": "Más reciente",
  "settings.updates.track.option.behindOne": "Una versión atrás",
  "settings.updates.track.option.behindTwo": "Dos versiones atrás",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de TurenOS.",
  ...
  "settings.agents.title": "Configuración de agentes",
  ...
  "nav.rail.label": "Navegación principal",
  "nav.rail.agents": "Agentes",
  "nav.rail.agents.running": "{{count}} en ejecución",
  "nav.rail.agents.showPanel": "Agentes — mostrar panel",
  "nav.rail.agents.hidePanel": "Agentes — ocultar panel",
  "nav.rail.settings": "Ajustes",
  "nav.rail.help": "Ayuda",
  "nav.rail.server": "Servidor: {{server}}",
  "command.nav.agents": "Ir a Agentes",
  "command.nav.panel.toggle": "Alternar panel de navegación",
