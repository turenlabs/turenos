...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w TurenOS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w TurenOS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w TurenOS.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w forge.json",
  ...
  "dialog.server.description": "Przełącz serwer TurenOS, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingForge": "Sprawdzanie TurenOS...",
  "wsl.onboarding.checkingForgeIn": "Sprawdzanie TurenOS w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingForge": "Aktualizowanie TurenOS...",
  "wsl.onboarding.updatingForgeIn": "Aktualizowanie TurenOS w dystrybucji {{distro}}...",
  "wsl.onboarding.updateForgeIn": "Zaktualizuj TurenOS w dystrybucji {{distro}}.",
  "wsl.onboarding.updateForge": "Zaktualizuj TurenOS",
  "wsl.onboarding.forgeReadyIn": "TurenOS jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.forgeReady": "TurenOS jest gotowy.",
  "wsl.onboarding.installForgeIn": "Zainstaluj TurenOS w dystrybucji {{distro}}.",
  "wsl.onboarding.installForge": "Zainstaluj TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim TurenOS będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "TurenOS nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz TurenOS.",
  ...
  "toast.session.compact.success.title": "Sesja skompaktowana",
  "toast.session.compact.success.description": "Wcześniejsze wiadomości podsumowano, aby zwolnić kontekst",
  "toast.session.compact.failed.title": "Nie udało się skompaktować sesji",
  "toast.session.listFailed.title": "Nie udało się załadować sesji dla {{project}}",
  "toast.update.title": "Dostępna aktualizacja",
  "toast.update.description": "Nowa wersja TurenOS ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu TurenOS",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (forge.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: TurenOS nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "settings.section.securityIntegrations": "Integracje bezpieczeństwa",
  "settings.tab.general": "Ogólne",
  "settings.tab.shortcuts": "Skróty",
  "settings.tab.securityData": "Dane",
  "settings.tab.securityTools": "Narzędzia",
  "settings.security.search.placeholder": "Szukaj integracji",
  "settings.security.data.empty": "Brak integracji danych",
  "settings.security.tools.empty": "Brak integracji narzędzi",
  "settings.security.loadError":
    "Nie udało się załadować integracji bezpieczeństwa. Sprawdź, czy Twój serwer jest aktualny.",
  "settings.security.updateError": "Aktualizacja nie powiodła się — Twoja zmiana nie została zapisana.",
  "settings.security.tools.notInstalled": "Nie zainstalowano",
  "settings.security.secret.action": "Klucz API",
  "settings.security.secret.placeholder.set": "Skonfigurowano — wprowadź nowy klucz, aby zastąpić",
  "settings.security.secret.placeholder.unset": "Wprowadź klucz API",
  "settings.security.secret.clearHint": "Wyślij pustą wartość, aby usunąć zapisany klucz.",
  ...
  "settings.security.integration.osv.description":
    "Wyszukiwanie znanych luk w zabezpieczeniach w bazie danych open source OSV.dev",
  "settings.security.integration.depsdev.description": "Kondycja pakietów, licencje i grafy zależności z deps.dev",
  "settings.security.integration.kev.description":
    "Sprawdzanie CVE względem katalogu znanych wykorzystywanych luk CISA",
  "settings.security.integration.epss.description": "Oceny prawdopodobieństwa wykorzystania CVE z FIRST.org",
  "settings.security.integration.ghsa.description": "Zapytania do bazy danych GitHub Security Advisory",
  "settings.security.integration.hibp.description":
    "Sprawdzanie haseł pod kątem wycieków — dane na licencji CC-BY z haveibeenpwned.com",
  "settings.security.integration.exploitdb.description":
    "Wyszukiwanie publicznych exploitów według CVE w indeksie Exploit-DB",
  "settings.security.integration.nvd.description": "Szczegóły CVE z bazy danych NIST National Vulnerability Database",
  "settings.security.integration.gitleaks.description":
    "Skanowanie przestrzeni roboczej pod kątem sekretów zapisanych w commitach",
  "settings.security.integration.trivy.description":
    "Skanowanie pod kątem luk w zabezpieczeniach, błędnych konfiguracji i sekretów",
  "settings.security.integration.osv-scanner.description":
    "Skanowanie plików lock pod kątem zależności ze znanymi lukami",
  "settings.security.integration.grype.description": "Skanowanie luk w zabezpieczeniach i generowanie SBOM",
  "settings.security.integration.checkov.description":
    "Skanowanie infrastruktury jako kodu pod kątem błędnych konfiguracji",
  "settings.security.integration.bandit.description":
    "Analiza statyczna kodu Python pod kątem problemów bezpieczeństwa",
  "settings.security.integration.native-audit.description":
    "Uruchamianie własnego audytu zależności każdego ekosystemu (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "Reguły analizy statycznej zgodne z Semgrep dla przestrzeni roboczej",
  "settings.security.integration.batou.description":
    "Statyczne testy bezpieczeństwa aplikacji pod kątem typowych luk w kodzie",
  "settings.security.integration.batou.note":
    "Automatycznie — skanuje każdy plik zapisywany przez agenta; blokuje krytyczne wykrycia",
  "settings.security.integration.batou.installHint": "Pobiera się automatycznie przy pierwszym włączeniu (macOS/Linux)",
  "settings.security.batou.status.downloading": "Pobieranie Batou…",
  "settings.security.batou.status.installed": "Zainstalowano",
  "settings.security.batou.status.failed": "Pobieranie nie powiodło się",

  "settings.section.agentIntegrations": "Integracje agentów",
  "settings.tab.agentData": "Dane",
  "settings.tab.agentTools": "Narzędzia",
  "settings.agent.data.empty": "Brak integracji danych",
  "settings.agent.tools.empty": "Brak integracji narzędzi",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integracja z WSL",
  "settings.desktop.wsl.description": "Uruchamiaj serwer TurenOS wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.section.retention": "Pamięć masowa i przechowywanie danych",
  "settings.general.retention.scope":
    "Te okresy przycinają wyłącznie zapisane dane transkrypcji, co zwalnia miejsce na dysku. Nigdy nie zmieniają trwałego dziennika zdarzeń ani nie usuwają sesji. Wpisz 0, aby wyłączyć dany okres.",
  "settings.general.retention.never":
    "Wyłączone — nic nie jest przycinane, niezależnie od wieku danych. Zapisane dane są zachowywane w całości, dopóki nie podasz liczby dni.",
  "settings.general.row.retentionToolOutput.title": "Wyjście narzędzi",
  "settings.general.row.retentionToolOutput.description":
    "Po {{days}} dn. zapisane dane wywołań narzędzi we wszystkich sesjach są redukowane do krótkiego podglądu — pierwszego i ostatniego wiersza. Zachowywane są: nazwa narzędzia, jego dane wejściowe oraz podgląd wyniku.",
  "settings.general.row.retentionToolOutput.label": "Liczba dni przechowywania pełnego wyjścia narzędzi",
  "settings.general.row.retentionArchivedSessions.title": "Zarchiwizowane sesje",
  "settings.general.row.retentionArchivedSessions.description":
    "Po {{days}} dn. od zarchiwizowania sesji jej dane narzędzi i wyniki poleceń powłoki są redukowane do podglądów, a zbyt duże dane wejściowe narzędzi są usuwane. Zachowywane są: sama sesja, jej tytuł, wszystkie polecenia użytkownika i wszystkie odpowiedzi asystenta — transkrypcję nadal da się przeczytać.",
  "settings.general.row.retentionArchivedSessions.label": "Liczba dni przechowywania danych zarchiwizowanych sesji",
  "settings.general.row.language.title": "Język",
  "settings.general.row.language.description": "Zmień język wyświetlania dla TurenOS",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd TurenOS na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy TurenOS ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw TurenOS.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Diagnostyka wydajności",
  "settings.general.row.performanceDiagnostics.description":
    "Pokaż liczniki deweloperskie dla nawigacji, renderowania, opóźnienia wejścia, przesunięcia układu i pamięci",
  "settings.general.section.profiler": "Profiler",
  "settings.general.profiler.scope":
    "Rejestruje wyłącznie proces serwera TurenOS — pętlę agenta, wykonywanie narzędzi, kompaktowanie i MCP. Czas interfejsu i okna nie jest rejestrowany, więc nie szukaj tutaj zacięć interfejsu.",
  "settings.general.row.profiler.title": "Nagraj profil CPU",
  "settings.general.row.profiler.description":
    "Rozpocznij nagrywanie, odtwórz wolne zachowanie, a następnie je zatrzymaj. Nagrywanie kosztuje kilka procent podczas działania i nic, gdy jest wyłączone.",
  "settings.general.profiler.recording":
    "Nagrywanie — upłynęło {{elapsed}}. Zatrzymuje się samo po 10 minutach. Zamknięcie TurenOS odrzuca nagranie.",
  "settings.general.profiler.unavailable": "Oczekiwanie na uruchomienie serwera TurenOS.",
  "settings.general.profiler.failedTitle": "Nagrywanie nie powiodło się",
  "settings.general.row.profilerResult.title": "Ostatnie nagranie",
  "settings.general.row.profilerResult.description":
    "{{samples}} próbek przy {{rate}} Hz w ciągu {{duration}}. Otwórz plik .cpuprofile w Chrome DevTools (Performance › Load profile) lub na speedscope.app.",
  "settings.general.profiler.reveal": "Pokaż",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania TurenOS",
  ...
  "settings.updates.row.track.title": "Kanał aktualizacji",
  "settings.updates.row.track.description": "O ile wersji za najnowszą chcesz pozostać",
  "settings.updates.track.option.latest": "Najnowsza",
  "settings.updates.track.option.behindOne": "Jedna wersja wstecz",
  "settings.updates.track.option.behindTwo": "Dwie wersje wstecz",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji TurenOS.",
  ...
  "settings.agents.title": "Ustawienia agentów",
  ...
  "nav.rail.label": "Nawigacja główna",
  "nav.rail.agents": "Agenci",
  "nav.rail.agents.running": "{{count}} uruchomionych",
  "nav.rail.agents.showPanel": "Agenci — pokaż panel",
  "nav.rail.agents.hidePanel": "Agenci — ukryj panel",
  "nav.rail.settings": "Ustawienia",
  "nav.rail.help": "Pomoc",
  "nav.rail.server": "Serwer: {{server}}",
  "command.nav.agents": "Przejdź do Agentów",
  "command.nav.panel.toggle": "Przełącz panel nawigacji",
