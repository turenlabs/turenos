...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、TurenOSで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してTurenOSで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、TurenOSで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "forge.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するTurenOSサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingForge": "TurenOSを確認中...",
  "wsl.onboarding.checkingForgeIn": "{{distro}}内のTurenOSを確認中...",
  "wsl.onboarding.updatingForge": "TurenOSを更新中...",
  "wsl.onboarding.updatingForgeIn": "{{distro}}内のTurenOSを更新中...",
  "wsl.onboarding.updateForgeIn": "{{distro}}内のTurenOSを更新してください。",
  "wsl.onboarding.updateForge": "TurenOSを更新",
  "wsl.onboarding.forgeReadyIn": "{{distro}}内のTurenOSの準備ができました。",
  "wsl.onboarding.forgeReady": "TurenOSの準備ができました。",
  "wsl.onboarding.installForgeIn": "{{distro}}にTurenOSをインストールしてください。",
  "wsl.onboarding.installForge": "TurenOSをインストール",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOSがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "TurenOSでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、TurenOSをもう一度開いてください。",
  ...
  "toast.session.compact.success.title": "セッションを圧縮しました",
  "toast.session.compact.success.description": "コンテキストを空けるため、以前のメッセージを要約しました",
  "toast.session.compact.failed.title": "セッションの圧縮に失敗しました",
  "toast.session.listFailed.title": "{{project}}のセッション読み込みに失敗しました",
  "toast.update.title": "アップデートが利用可能です",
  "toast.update.description": "TurenOSの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをTurenOSチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (forge.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: TurenOSはまだMCP認証をサポートしていません。',
  ...
  "settings.section.securityIntegrations": "セキュリティ連携",
  "settings.tab.general": "一般",
  "settings.tab.shortcuts": "ショートカット",
  "settings.tab.securityData": "データ",
  "settings.tab.securityTools": "ツール",
  "settings.security.search.placeholder": "連携を検索",
  "settings.security.data.empty": "データ連携はまだありません",
  "settings.security.tools.empty": "ツール連携はまだありません",
  "settings.security.loadError": "セキュリティ連携を読み込めませんでした。サーバーが最新の状態か確認してください。",
  "settings.security.updateError": "更新に失敗しました — 変更は保存されていません。",
  "settings.security.tools.notInstalled": "未インストール",
  "settings.security.secret.action": "APIキー",
  "settings.security.secret.placeholder.set": "設定済み — 置き換えるには新しいキーを入力",
  "settings.security.secret.placeholder.unset": "APIキーを入力",
  "settings.security.secret.clearHint": "空の値を送信すると、保存済みのキーを削除できます。",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "OSV.devのオープンソースデータベースで既知の脆弱性を検索します",
  "settings.security.integration.depsdev.description": "deps.devによるパッケージの健全性、ライセンス、依存関係グラフ",
  "settings.security.integration.kev.description": "CVEをCISAの既知悪用脆弱性（KEV）カタログと照合します",
  "settings.security.integration.epss.description": "FIRST.orgによるCVEの悪用可能性スコア",
  "settings.security.integration.ghsa.description": "GitHubセキュリティアドバイザリのデータベースを照会します",
  "settings.security.integration.hibp.description":
    "パスワード漏えいチェック — データはhaveibeenpwned.comからCC-BYライセンスで提供されています",
  "settings.security.integration.exploitdb.description":
    "CVEを基にExploit-DBインデックスで公開エクスプロイトを検索します",
  "settings.security.integration.nvd.description": "NISTのNational Vulnerability DatabaseによるCVEの詳細情報",
  "settings.security.integration.gitleaks.description":
    "ワークスペースをスキャンしてコミットされたシークレットを検出します",
  "settings.security.integration.trivy.description": "脆弱性、設定ミス、シークレットをスキャンします",
  "settings.security.integration.osv-scanner.description":
    "ロックファイルをスキャンして既知の脆弱な依存関係を検出します",
  "settings.security.integration.grype.description": "脆弱性スキャンとSBOM生成",
  "settings.security.integration.checkov.description": "Infrastructure as Code（IaC）の設定ミスをスキャンします",
  "settings.security.integration.bandit.description": "Pythonのセキュリティ問題を対象とした静的解析",
  "settings.security.integration.native-audit.description":
    "各エコシステム標準の依存関係監査を実行します（npm、pip、cargo、Go）",
  "settings.security.integration.opengrep.description": "ワークスペースに対してSemgrep互換の静的解析ルールを実行します",
  "settings.security.integration.batou.description":
    "コードの一般的な脆弱性を対象とした静的アプリケーションセキュリティテスト",
  "settings.security.integration.batou.note":
    "自動 — エージェントが書き込むすべてのファイルをスキャンし、重大な検出結果をブロックします",
  "settings.security.integration.batou.installHint": "初回有効化時に自動的にダウンロードされます（macOS/Linux）",
  "settings.security.batou.status.downloading": "Batou をダウンロード中…",
  "settings.security.batou.status.installed": "インストール済み",
  "settings.security.batou.status.failed": "ダウンロードに失敗しました",

  "settings.section.agentIntegrations": "エージェント連携",
  "settings.tab.agentData": "データ",
  "settings.tab.agentTools": "ツール",
  "settings.agent.data.empty": "データ連携はまだありません",
  "settings.agent.tools.empty": "ツール連携はまだありません",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL連携",
  "settings.desktop.wsl.description": "WindowsのWSL環境でTurenOSサーバーを実行します。",
  ...
  "settings.general.section.retention": "ストレージと保持期間",
  "settings.general.retention.scope":
    "これらの保持期間は、保存された会話ログのペイロードを削減してディスク容量を解放するだけのものです。永続的なイベントログを書き換えることはなく、セッションを削除することもありません。0 を入力すると、その保持期間は無効になります。",
  "settings.general.retention.never":
    "無効です。どれだけ古くなっても何も削減されません。日数を入力するまで、保存されたペイロードは完全なまま保持されます。",
  "settings.general.row.retentionToolOutput.title": "ツールの出力",
  "settings.general.row.retentionToolOutput.description":
    "{{days}} 日が経過すると、すべてのセッションに保存されているツール呼び出しのペイロードは、先頭と末尾の行だけの短いプレビューに縮小されます。ツール名、その入力、結果のプレビューは保持されます。",
  "settings.general.row.retentionToolOutput.label": "ツールの出力を完全な形で保持する日数",
  "settings.general.row.retentionArchivedSessions.title": "アーカイブ済みセッション",
  "settings.general.row.retentionArchivedSessions.description":
    "セッションがアーカイブされてから {{days}} 日後に、そのセッションのツールのペイロードとシェルコマンドの出力はプレビューに縮小され、サイズの大きすぎるツール入力は消去されます。セッション、そのタイトル、すべてのユーザープロンプト、すべてのアシスタントの応答は保持されるため、会話ログはそのまま読めます。",
  "settings.general.row.retentionArchivedSessions.label": "アーカイブ済みセッションのペイロードを保持する日数",
  "settings.general.row.language.title": "言語",
  "settings.general.row.language.description": "TurenOSの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのTurenOSの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "TurenOSがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "TurenOSのテーマをカスタマイズします。",
  ...
  "settings.general.row.performanceDiagnostics.title": "パフォーマンス診断",
  "settings.general.row.performanceDiagnostics.description":
    "ナビゲーション、レンダリング、入力遅延、レイアウトシフト、メモリの開発用カウンターを表示します",
  "settings.general.section.profiler": "プロファイラー",
  "settings.general.profiler.scope":
    "TurenOSサーバープロセスのみを記録します — エージェントループ、ツール実行、圧縮、MCPです。インターフェースやウィンドウの時間は記録されないため、UIの詰まりをここで探さないでください。",
  "settings.general.row.profiler.title": "CPUプロファイルを記録",
  "settings.general.row.profiler.description":
    "記録を開始し、遅い動作を再現してから停止します。記録中の負荷は数パーセントで、オフのときは負荷はありません。",
  "settings.general.profiler.recording":
    "記録中 — {{elapsed}}経過。10分後に自動的に停止します。TurenOSを終了すると記録は破棄されます。",
  "settings.general.profiler.unavailable": "TurenOSサーバーの起動を待っています。",
  "settings.general.profiler.failedTitle": "記録に失敗しました",
  "settings.general.row.profilerResult.title": "最後の記録",
  "settings.general.row.profilerResult.description":
    "{{duration}}にわたり{{rate}}Hzで{{samples}}サンプル。.cpuprofileをChrome DevTools（Performance › Load profile）またはspeedscope.appで開いてください。",
  "settings.general.profiler.reveal": "表示",
  ...
  "settings.updates.row.startup.description": "TurenOS の起動時に自動でアップデートを確認します",
  "settings.updates.row.check.title": "アップデートを確認",
  "settings.updates.row.check.description": "手動でアップデートを確認し、利用可能ならインストールします",
  "settings.updates.row.track.title": "アップデートチャンネル",
  "settings.updates.row.track.description": "最新リリースからどれだけ遅れたバージョンを使うか",
  "settings.updates.track.option.latest": "最新",
  "settings.updates.track.option.behindOne": "1つ前のリリース",
  "settings.updates.track.option.behindTwo": "2つ前のリリース",
  ...
  "settings.updates.toast.latest.description": "TurenOS は最新バージョンです。",
  ...
  "settings.agents.title": "エージェント設定",
  ...
  "nav.rail.agents": "エージェント",
  "nav.rail.agents.running": "{{count}} 件実行中",
  "nav.rail.agents.showPanel": "エージェント — パネルを表示",
  "nav.rail.agents.hidePanel": "エージェント — パネルを非表示",
  "nav.rail.settings": "設定",
  "nav.rail.help": "ヘルプ",
  "nav.rail.server": "サーバー: {{server}}",
  "command.nav.agents": "エージェントへ移動",
  "command.nav.panel.toggle": "ナビゲーションパネルの切り替え",
