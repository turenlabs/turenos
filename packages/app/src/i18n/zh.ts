...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 TurenOS 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 TurenOS 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 TurenOS 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 forge.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 TurenOS 服务器。",
  ...
  "wsl.onboarding.checkingForge": "正在检查 TurenOS...",
  "wsl.onboarding.checkingForgeIn": "正在检查 {{distro}} 中的 TurenOS...",
  "wsl.onboarding.updatingForge": "正在更新 TurenOS...",
  "wsl.onboarding.updatingForgeIn": "正在更新 {{distro}} 中的 TurenOS...",
  "wsl.onboarding.updateForgeIn": "更新 {{distro}} 中的 TurenOS。",
  "wsl.onboarding.updateForge": "更新 TurenOS",
  "wsl.onboarding.forgeReadyIn": "{{distro}} 中的 TurenOS 已就绪。",
  "wsl.onboarding.forgeReady": "TurenOS 已就绪。",
  "wsl.onboarding.installForgeIn": "在 {{distro}} 中安装 TurenOS。",
  "wsl.onboarding.installForge": "安装 TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "未安装 TurenOS",
  ...
  "wsl.onboarding.wslNotInstalled.description": "TurenOS 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "TurenOS 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 TurenOS。",
  ...
  "toast.session.compact.success.title": "会话已精简",
  "toast.session.compact.success.description": "已总结较早的消息以释放上下文",
  "toast.session.compact.failed.title": "精简会话失败",
  "toast.session.listFailed.title": "无法加载 {{project}} 的会话",
  "toast.update.title": "有可用更新",
  "toast.update.description": "TurenOS 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 TurenOS 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (forge.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: TurenOS 暂不支持 MCP 认证。',
  ...
  "settings.section.securityIntegrations": "安全集成",

  "settings.tab.general": "通用",
  "settings.tab.shortcuts": "快捷键",
  "settings.tab.securityData": "数据",
  "settings.tab.securityTools": "工具",
  "settings.security.search.placeholder": "搜索集成",
  "settings.security.data.empty": "暂无数据集成",
  "settings.security.tools.empty": "暂无工具集成",
  "settings.security.loadError": "无法加载安全集成。请检查服务器是否为最新版本。",
  "settings.security.updateError": "更新失败 — 更改未保存。",
  "settings.security.tools.notInstalled": "未安装",
  "settings.security.secret.action": "API 密钥",
  "settings.security.secret.placeholder.set": "已配置 — 输入新密钥以替换",
  "settings.security.secret.placeholder.unset": "输入 API 密钥",
  "settings.security.secret.clearHint": "提交空值即可清除已保存的密钥。",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "在 OSV.dev 开源数据库中查询已知漏洞",
  "settings.security.integration.depsdev.description": "来自 deps.dev 的软件包健康度、许可证和依赖关系图",
  "settings.security.integration.kev.description": "将 CVE 与 CISA 已知被利用漏洞 (KEV) 目录进行比对",
  "settings.security.integration.epss.description": "来自 FIRST.org 的 CVE 被利用概率评分",
  "settings.security.integration.ghsa.description": "查询 GitHub 安全公告数据库",
  "settings.security.integration.hibp.description": "密码泄露检查 — 数据由 haveibeenpwned.com 以 CC-BY 许可提供",
  "settings.security.integration.exploitdb.description": "按 CVE 在 Exploit-DB 索引中搜索公开的漏洞利用",
  "settings.security.integration.nvd.description": "来自 NIST National Vulnerability Database 的 CVE 详细信息",
  "settings.security.integration.gitleaks.description": "扫描工作区中已提交的机密信息",
  "settings.security.integration.trivy.description": "扫描漏洞、错误配置和机密信息",
  "settings.security.integration.osv-scanner.description": "扫描锁文件以查找已知存在漏洞的依赖项",
  "settings.security.integration.grype.description": "漏洞扫描与 SBOM 生成",
  "settings.security.integration.checkov.description": "扫描基础设施即代码 (IaC) 中的错误配置",
  "settings.security.integration.bandit.description": "针对 Python 安全问题的静态分析",
  "settings.security.integration.native-audit.description": "运行各生态系统自带的依赖审计 (npm、pip、cargo、Go)",
  "settings.security.integration.opengrep.description": "对工作区运行与 Semgrep 兼容的静态分析规则",
  "settings.security.integration.batou.description": "针对代码常见漏洞的静态应用安全测试",
  "settings.security.integration.batou.note": "自动 — 扫描智能体写入的每个文件，并拦截严重问题",
  "settings.security.integration.batou.installHint": "首次启用时自动下载 (macOS/Linux)",
  "settings.security.batou.status.downloading": "正在下载 Batou…",
  "settings.security.batou.status.installed": "已安装",
  "settings.security.batou.status.failed": "下载失败",

  "settings.section.agentIntegrations": "智能体集成",
  "settings.tab.agentData": "数据",
  "settings.tab.agentTools": "工具",
  "settings.agent.data.empty": "暂无数据集成",
  "settings.agent.tools.empty": "暂无工具集成",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 集成",
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 TurenOS 服务器。",
  ...
  "settings.general.section.retention": "存储与保留",

  "settings.general.retention.scope":
    "这些期限仅会精简已存储的会话记录内容，从而释放磁盘空间。它们绝不会重写持久事件日志，也绝不会删除会话。输入 0 即可关闭对应期限。",
  "settings.general.retention.never":
    "已关闭。任何存续时间的内容都不会被精简。在你输入天数之前，已存储的内容都会完整保留。",
  "settings.general.row.retentionToolOutput.title": "工具输出",
  "settings.general.row.retentionToolOutput.description":
    "{{days}} 天后，所有会话中已存储的工具调用内容会被精简为简短预览，即首行和末行。保留的内容：工具名称、其输入参数，以及结果的预览。",
  "settings.general.row.retentionToolOutput.label": "完整保留工具输出的天数",
  "settings.general.row.retentionArchivedSessions.title": "已归档会话",
  "settings.general.row.retentionArchivedSessions.description":
    "会话归档 {{days}} 天后，其工具调用内容和 shell 命令输出会被精简为预览，超大的工具输入会被清除。保留的内容：会话本身、会话标题、所有用户提示词以及全部助手回复，因此会话记录仍可阅读。",
  "settings.general.row.retentionArchivedSessions.label": "保留已归档会话内容的天数",

  "settings.general.row.language.title": "语言",
  "settings.general.row.language.description": "更改 TurenOS 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 TurenOS 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 TurenOS 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 TurenOS 的主题。",
  ...
  "settings.general.row.performanceDiagnostics.title": "性能诊断",
  "settings.general.row.performanceDiagnostics.description": "显示导航、渲染、输入延迟、布局偏移和内存的开发计数器",
  "settings.general.section.profiler": "性能分析器",
  "settings.general.profiler.scope":
    "仅记录 TurenOS 服务器进程——智能体循环、工具执行、精简和 MCP。界面和窗口耗时不会被记录，因此不要在这里查找界面卡顿。",
  "settings.general.row.profiler.title": "录制 CPU 性能分析",
  "settings.general.row.profiler.description":
    "开始录制，复现变慢的行为，然后停止。录制运行时会占用百分之几的开销，关闭后则没有开销。",
  "settings.general.profiler.recording":
    "正在录制——已用时 {{elapsed}}。10 分钟后自动停止。退出 TurenOS 会丢弃本次录制。",
  "settings.general.profiler.unavailable": "正在等待 TurenOS 服务器启动。",
  "settings.general.profiler.failedTitle": "录制失败",
  "settings.general.row.profilerResult.title": "上次录制",
  "settings.general.row.profilerResult.description":
    "在 {{duration}} 内以 {{rate}} Hz 采集了 {{samples}} 个样本。可在 Chrome DevTools（Performance › Load profile）或 speedscope.app 中打开该 .cpuprofile 文件。",
  "settings.general.profiler.reveal": "显示",
  ...
  "settings.updates.row.startup.description": "在 TurenOS 启动时自动检查更新",
  "settings.updates.row.check.title": "检查更新",
  "settings.updates.row.check.description": "手动检查更新并在有更新时安装",
  "settings.updates.row.track.title": "更新频道",
  "settings.updates.row.track.description": "落后最新版本多少个版本",
  "settings.updates.track.option.latest": "最新",
  "settings.updates.track.option.behindOne": "落后一个版本",
  "settings.updates.track.option.behindTwo": "落后两个版本",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 TurenOS。",
  ...
  "nav.rail.label": "主导航",
  "nav.rail.agents": "智能体",
  "nav.rail.agents.running": "{{count}} 个运行中",
  "nav.rail.agents.showPanel": "智能体 — 显示面板",
  "nav.rail.agents.hidePanel": "智能体 — 隐藏面板",
  "nav.rail.settings": "设置",
  "nav.rail.help": "帮助",
  "nav.rail.server": "服务器：{{server}}",
  "command.nav.agents": "前往智能体",
  "command.nav.panel.toggle": "切换导航面板",
