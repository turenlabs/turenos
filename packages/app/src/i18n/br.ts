...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no TurenOS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no TurenOS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no TurenOS.",
  ...
  "dialog.plugins.empty": "Plugins configurados em forge.json",
  ...
  "dialog.server.description": "Trocar para qual servidor TurenOS este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingForge": "Verificando o TurenOS...",
  "wsl.onboarding.checkingForgeIn": "Verificando o TurenOS em {{distro}}...",
  "wsl.onboarding.updatingForge": "Atualizando o TurenOS...",
  "wsl.onboarding.updatingForgeIn": "Atualizando o TurenOS em {{distro}}...",
  "wsl.onboarding.updateForgeIn": "Atualize o TurenOS em {{distro}}.",
  "wsl.onboarding.updateForge": "Atualizar o TurenOS",
  "wsl.onboarding.forgeReadyIn": "O TurenOS está pronto em {{distro}}.",
  "wsl.onboarding.forgeReady": "O TurenOS está pronto.",
  "wsl.onboarding.installForgeIn": "Instale o TurenOS em {{distro}}.",
  "wsl.onboarding.installForge": "Instalar o TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o TurenOS possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O TurenOS não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o TurenOS novamente.",
  ...
  "toast.session.compact.success.title": "Sessão compactada",
  "toast.session.compact.success.description": "As mensagens anteriores foram resumidas para liberar contexto",
  "toast.session.compact.failed.title": "Falha ao compactar a sessão",
  "toast.session.listFailed.title": "Falha ao carregar sessões para {{project}}",
  "toast.update.title": "Atualização disponível",
  "toast.update.description": "Uma nova versão do TurenOS ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do TurenOS",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (forge.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: TurenOS ainda não suporta autenticação MCP.',
  ...
  "settings.section.securityIntegrations": "Integrações de segurança",
  "settings.tab.general": "Geral",
  "settings.tab.shortcuts": "Atalhos",
  "settings.tab.securityData": "Dados",
  "settings.tab.securityTools": "Ferramentas",
  "settings.security.search.placeholder": "Buscar integrações",
  "settings.security.data.empty": "Nenhuma integração de dados ainda",
  "settings.security.tools.empty": "Nenhuma integração de ferramentas ainda",
  "settings.security.loadError":
    "Não foi possível carregar as integrações de segurança. Verifique se o seu servidor está atualizado.",
  "settings.security.updateError": "A atualização falhou — sua alteração não foi salva.",
  "settings.security.tools.notInstalled": "Não instalado",
  "settings.security.secret.action": "Chave de API",
  "settings.security.secret.placeholder.set": "Configurada — digite uma nova chave para substituir",
  "settings.security.secret.placeholder.unset": "Digite a chave de API",
  "settings.security.secret.clearHint": "Envie um valor vazio para apagar a chave armazenada.",
  ...
  "settings.security.integration.osv.description":
    "Consultar vulnerabilidades conhecidas no banco de dados open source OSV.dev",
  "settings.security.integration.depsdev.description":
    "Saúde dos pacotes, licenças e grafos de dependências do deps.dev",
  "settings.security.integration.kev.description": "Verificar CVEs no catálogo Known Exploited Vulnerabilities da CISA",
  "settings.security.integration.epss.description": "Pontuações de probabilidade de exploração para CVEs da FIRST.org",
  "settings.security.integration.ghsa.description": "Consultar o banco de dados GitHub Security Advisory",
  "settings.security.integration.hibp.description":
    "Verificação de senhas vazadas — dados licenciados sob CC-BY de haveibeenpwned.com",
  "settings.security.integration.exploitdb.description": "Pesquisar exploits públicos por CVE no índice do Exploit-DB",
  "settings.security.integration.nvd.description": "Detalhes de CVEs do National Vulnerability Database do NIST",
  "settings.security.integration.gitleaks.description":
    "Escanear o espaço de trabalho em busca de segredos incluídos em commits",
  "settings.security.integration.trivy.description":
    "Escanear em busca de vulnerabilidades, configurações incorretas e segredos",
  "settings.security.integration.osv-scanner.description":
    "Escanear lockfiles em busca de dependências com vulnerabilidades conhecidas",
  "settings.security.integration.grype.description": "Escaneamento de vulnerabilidades e geração de SBOM",
  "settings.security.integration.checkov.description":
    "Escanear infraestrutura como código em busca de configurações incorretas",
  "settings.security.integration.bandit.description": "Análise estática de problemas de segurança em Python",
  "settings.security.integration.native-audit.description":
    "Executar a auditoria de dependências própria de cada ecossistema (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "Regras de análise estática compatíveis com Semgrep no espaço de trabalho",
  "settings.security.integration.batou.description":
    "Teste estático de segurança de aplicações para vulnerabilidades comuns no código",
  "settings.security.integration.batou.note":
    "Automático — escaneia cada arquivo que o agente escreve; bloqueia achados críticos",
  "settings.security.integration.batou.installHint":
    "Baixado automaticamente ao ativar pela primeira vez (macOS/Linux)",
  "settings.security.batou.status.downloading": "Baixando Batou…",
  "settings.security.batou.status.installed": "Instalado",
  "settings.security.batou.status.failed": "Falha no download",

  "settings.section.agentIntegrations": "Integrações de agentes",
  "settings.tab.agentData": "Dados",
  "settings.tab.agentTools": "Ferramentas",
  "settings.agent.data.empty": "Nenhuma integração de dados ainda",
  "settings.agent.tools.empty": "Nenhuma integração de ferramentas ainda",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integração com WSL",
  "settings.desktop.wsl.description": "Executar o servidor TurenOS dentro do WSL no Windows.",
  ...
  "settings.general.section.retention": "Armazenamento e retenção",
  "settings.general.retention.scope":
    "Estas janelas apenas reduzem os conteúdos das transcrições armazenadas, o que libera espaço em disco. Elas nunca reescrevem o registro de eventos durável e nunca excluem uma sessão. Digite 0 para desativar uma janela.",
  "settings.general.retention.never":
    "Desativado — nada é reduzido, independentemente da idade. Os conteúdos armazenados são mantidos na íntegra até você informar um número de dias.",
  "settings.general.row.retentionToolOutput.title": "Saída de ferramentas",
  "settings.general.row.retentionToolOutput.description":
    "Após {{days}} dias, os conteúdos das chamadas de ferramentas armazenados em todas as sessões são reduzidos a uma prévia curta — a primeira e a última linha. São mantidos: o nome da ferramenta, suas entradas e uma prévia do resultado.",
  "settings.general.row.retentionToolOutput.label": "Dias para manter a saída completa das ferramentas",
  "settings.general.row.retentionArchivedSessions.title": "Sessões arquivadas",
  "settings.general.row.retentionArchivedSessions.description":
    "{{days}} dias após uma sessão ser arquivada, os conteúdos de suas ferramentas e a saída dos comandos de shell são reduzidos a prévias, e as entradas de ferramentas grandes demais são apagadas. São mantidos: a sessão, seu título, todos os prompts do usuário e todas as respostas do assistente — a transcrição continua legível.",
  "settings.general.row.retentionArchivedSessions.label": "Dias para manter os conteúdos das sessões arquivadas",
  "settings.general.row.language.title": "Idioma",
  "settings.general.row.language.description": "Alterar o idioma de exibição do TurenOS",
  ...
  "settings.general.row.appearance.description": "Personalize como o TurenOS aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o TurenOS segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o TurenOS é tematizado.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Diagnósticos de desempenho",
  "settings.general.row.performanceDiagnostics.description":
    "Mostrar contadores de desenvolvimento para navegação, renderização, atraso de entrada, deslocamento de layout e memória",
  "settings.general.section.profiler": "Perfilador",
  "settings.general.profiler.scope":
    "Registra apenas o processo do servidor TurenOS — o loop do agente, a execução de ferramentas, a compactação e o MCP. O tempo da interface e da janela não é registrado, então não procure travamentos de interface aqui.",
  "settings.general.row.profiler.title": "Gravar perfil de CPU",
  "settings.general.row.profiler.description":
    "Inicie a gravação, reproduza o comportamento lento e depois pare. A gravação custa alguns por cento enquanto está em execução e nada quando está desligada.",
  "settings.general.profiler.recording":
    "Gravando — {{elapsed}} decorridos. Para sozinha após 10 minutos. Sair do TurenOS descarta a gravação.",
  "settings.general.profiler.unavailable": "Aguardando o servidor TurenOS iniciar.",
  "settings.general.profiler.failedTitle": "Falha na gravação",
  "settings.general.row.profilerResult.title": "Última gravação",
  "settings.general.row.profilerResult.description":
    "{{samples}} amostras a {{rate}} Hz ao longo de {{duration}}. Abra o arquivo .cpuprofile no Chrome DevTools (Performance › Load profile) ou em speedscope.app.",
  "settings.general.profiler.reveal": "Revelar",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o TurenOS iniciar",
  ...
  "settings.updates.row.track.title": "Canal de atualização",
  "settings.updates.row.track.description": "Quantas versões atrás da mais recente manter",
  "settings.updates.track.option.latest": "Mais recente",
  "settings.updates.track.option.behindOne": "Uma versão atrás",
  "settings.updates.track.option.behindTwo": "Duas versões atrás",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do TurenOS.",
  ...
  "settings.agents.title": "Configurações de agentes",
  ...
  "nav.rail.label": "Navegação principal",
  "nav.rail.agents": "Agentes",
  "nav.rail.agents.running": "{{count}} em execução",
  "nav.rail.agents.showPanel": "Agentes — mostrar painel",
  "nav.rail.agents.hidePanel": "Agentes — ocultar painel",
  "nav.rail.settings": "Configurações",
  "nav.rail.help": "Ajuda",
  "nav.rail.server": "Servidor: {{server}}",
  "command.nav.agents": "Ir para Agentes",
  "command.nav.panel.toggle": "Alternar painel de navegação",
