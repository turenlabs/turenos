...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 TurenOS 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 TurenOS 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 TurenOS 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 forge.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 TurenOS 伺服器。",
  ...
  "wsl.onboarding.checkingForge": "正在檢查 TurenOS...",
  "wsl.onboarding.checkingForgeIn": "正在檢查 {{distro}} 中的 TurenOS...",
  ...
  "wsl.onboarding.forgeReadyIn": "{{distro}} 中的 TurenOS 已就緒。",
  "wsl.onboarding.forgeReady": "TurenOS 已就緒。",
  "wsl.onboarding.installForgeIn": "在 {{distro}} 中安裝 TurenOS。",
  "wsl.onboarding.installForge": "安裝 TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "未安裝 TurenOS",
  ...
  "wsl.onboarding.wslUnavailable.description": "TurenOS 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 TurenOS。",
  ...
  "toast.session.compact.success.title": "工作階段已精簡",
  "toast.session.compact.success.description": "已總結較早的訊息以釋放上下文",
  "toast.session.compact.failed.title": "精簡工作階段失敗",

  "toast.session.listFailed.title": "無法載入 {{project}} 的工作階段",

  "toast.update.title": "有可用更新",
  "toast.update.description": "TurenOS 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 TurenOS 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (forge.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: TurenOS 暫不支援 MCP 認證。',
  ...
  "settings.section.securityIntegrations": "安全整合",
  "settings.tab.general": "一般",
  "settings.tab.shortcuts": "快速鍵",
  "settings.tab.securityData": "資料",
  "settings.tab.securityTools": "工具",
  "settings.security.search.placeholder": "搜尋整合",
  "settings.security.data.empty": "暫無資料整合",
  "settings.security.tools.empty": "暫無工具整合",
  "settings.security.loadError": "無法載入安全整合。請確認伺服器已更新至最新版本。",
  "settings.security.updateError": "更新失敗 — 您的變更未儲存。",
  "settings.security.tools.notInstalled": "未安裝",
  "settings.security.secret.action": "API 金鑰",
  "settings.security.secret.placeholder.set": "已設定 — 輸入新金鑰以取代",
  "settings.security.secret.placeholder.unset": "輸入 API 金鑰",
  "settings.security.secret.clearHint": "提交空值即可清除已儲存的金鑰。",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "在 OSV.dev 開源資料庫中查詢已知漏洞",
  "settings.security.integration.depsdev.description": "來自 deps.dev 的套件健全度、授權條款與相依性圖",
  "settings.security.integration.kev.description": "將 CVE 與 CISA 已知遭利用漏洞 (KEV) 目錄進行比對",
  "settings.security.integration.epss.description": "來自 FIRST.org 的 CVE 遭利用機率評分",
  "settings.security.integration.ghsa.description": "查詢 GitHub 安全公告資料庫",
  "settings.security.integration.hibp.description": "密碼外洩檢查 — 資料由 haveibeenpwned.com 以 CC-BY 授權提供",
  "settings.security.integration.exploitdb.description": "依 CVE 在 Exploit-DB 索引中搜尋公開的漏洞利用程式",
  "settings.security.integration.nvd.description": "來自 NIST National Vulnerability Database 的 CVE 詳細資訊",
  "settings.security.integration.gitleaks.description": "掃描工作區中已提交的機密資訊",
  "settings.security.integration.trivy.description": "掃描漏洞、錯誤設定與機密資訊",
  "settings.security.integration.osv-scanner.description": "掃描鎖定檔以找出已知有漏洞的相依套件",
  "settings.security.integration.grype.description": "漏洞掃描與 SBOM 產生",
  "settings.security.integration.checkov.description": "掃描基礎架構即程式碼 (IaC) 中的錯誤設定",
  "settings.security.integration.bandit.description": "針對 Python 安全問題的靜態分析",
  "settings.security.integration.native-audit.description": "執行各生態系自有的相依性稽核 (npm、pip、cargo、Go)",
  "settings.security.integration.opengrep.description": "對工作區執行與 Semgrep 相容的靜態分析規則",
  "settings.security.integration.batou.description": "針對程式碼常見漏洞的靜態應用程式安全測試",
  "settings.security.integration.batou.note": "自動 — 掃描代理程式寫入的每個檔案，並攔截嚴重問題",
  "settings.security.integration.batou.installHint": "首次啟用時自動下載 (macOS/Linux)",
  "settings.security.batou.status.downloading": "正在下載 Batou…",
  "settings.security.batou.status.installed": "已安裝",
  "settings.security.batou.status.failed": "下載失敗",

  "settings.section.agentIntegrations": "代理程式整合",
  "settings.tab.agentData": "資料",
  "settings.tab.agentTools": "工具",
  "settings.agent.data.empty": "暫無資料整合",
  "settings.agent.tools.empty": "暫無工具整合",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 整合",
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 TurenOS 伺服器。",
  ...
  "settings.general.section.retention": "儲存與保留",

  "settings.general.retention.scope":
    "這些期限僅會精簡已儲存的工作階段記錄內容，藉此釋放磁碟空間。它們絕不會重寫持久事件記錄檔，也絕不會刪除工作階段。輸入 0 即可關閉對應期限。",
  "settings.general.retention.never":
    "已關閉。任何存續時間的內容都不會被精簡。在你輸入天數之前，已儲存的內容都會完整保留。",
  "settings.general.row.retentionToolOutput.title": "工具輸出",
  "settings.general.row.retentionToolOutput.description":
    "{{days}} 天後，所有工作階段中已儲存的工具呼叫內容會被精簡為簡短預覽，也就是首行與末行。保留的內容：工具名稱、其輸入參數，以及結果的預覽。",
  "settings.general.row.retentionToolOutput.label": "完整保留工具輸出的天數",
  "settings.general.row.retentionArchivedSessions.title": "已封存的工作階段",
  "settings.general.row.retentionArchivedSessions.description":
    "工作階段封存 {{days}} 天後，其工具呼叫內容與 shell 指令輸出會被精簡為預覽，過大的工具輸入則會被清除。保留的內容：工作階段本身、其標題、所有使用者提示詞以及全部助理回覆，因此記錄仍可閱讀。",
  "settings.general.row.retentionArchivedSessions.label": "保留已封存工作階段內容的天數",

  "settings.general.row.language.title": "語言",
  "settings.general.row.language.description": "變更 TurenOS 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 TurenOS 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 TurenOS 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 TurenOS 的主題。",
  ...
  "settings.general.row.performanceDiagnostics.title": "效能診斷",
  "settings.general.row.performanceDiagnostics.description": "顯示導覽、算繪、輸入延遲、版面位移和記憶體的開發計數器",
  "settings.general.section.profiler": "效能分析器",
  "settings.general.profiler.scope":
    "僅記錄 TurenOS 伺服器程序——代理程式迴圈、工具執行、精簡和 MCP。介面與視窗的耗時不會記錄，因此請勿在此尋找介面卡頓。",
  "settings.general.row.profiler.title": "錄製 CPU 效能分析",
  "settings.general.row.profiler.description":
    "開始錄製，重現變慢的行為，然後停止。錄製執行時會佔用百分之幾的開銷，關閉後則沒有開銷。",
  "settings.general.profiler.recording":
    "錄製中——已經過 {{elapsed}}。10 分鐘後會自動停止。結束 TurenOS 會捨棄這次錄製。",
  "settings.general.profiler.unavailable": "正在等待 TurenOS 伺服器啟動。",
  "settings.general.profiler.failedTitle": "錄製失敗",
  "settings.general.row.profilerResult.title": "上次錄製",
  "settings.general.row.profilerResult.description":
    "在 {{duration}} 內以 {{rate}} Hz 取樣 {{samples}} 個樣本。可在 Chrome DevTools（Performance › Load profile）或 speedscope.app 開啟該 .cpuprofile 檔案。",
  "settings.general.profiler.reveal": "顯示",
  ...
  "settings.updates.row.startup.description": "在 TurenOS 啟動時自動檢查更新",
  "settings.updates.row.check.title": "檢查更新",
  "settings.updates.row.check.description": "手動檢查更新並在有更新時安裝",
  "settings.updates.row.track.title": "更新頻道",
  "settings.updates.row.track.description": "落後最新版本多少個版本",
  "settings.updates.track.option.latest": "最新",
  "settings.updates.track.option.behindOne": "落後一個版本",
  "settings.updates.track.option.behindTwo": "落後兩個版本",
  ...
  "nav.rail.label": "主要導覽",
  "nav.rail.agents": "代理程式",
  "nav.rail.agents.running": "{{count}} 個執行中",
  "nav.rail.agents.showPanel": "代理程式 — 顯示面板",
  "nav.rail.agents.hidePanel": "代理程式 — 隱藏面板",
  "nav.rail.settings": "設定",
  "nav.rail.help": "說明",
  "nav.rail.server": "伺服器: {{server}}",
  "command.nav.agents": "前往代理程式",
  "command.nav.panel.toggle": "切換導覽面板",
