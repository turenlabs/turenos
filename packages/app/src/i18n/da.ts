...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i TurenOS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i TurenOS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i TurenOS.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i forge.json",
  ...
  "dialog.server.description": "Skift hvilken TurenOS-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingForge": "Tjekker TurenOS...",
  "wsl.onboarding.checkingForgeIn": "Tjekker TurenOS i {{distro}}...",
  "wsl.onboarding.updatingForge": "Opdaterer TurenOS...",
  "wsl.onboarding.updatingForgeIn": "Opdaterer TurenOS i {{distro}}...",
  "wsl.onboarding.updateForgeIn": "Opdater TurenOS i {{distro}}.",
  "wsl.onboarding.updateForge": "Opdater TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før TurenOS kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "TurenOS kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter TurenOS igen.",
  ...
  "toast.session.compact.success.title": "Session komprimeret",
  "toast.session.compact.success.description": "Tidligere beskeder blev opsummeret for at frigøre kontekst",
  "toast.session.compact.failed.title": "Kunne ikke komprimere sessionen",

  "toast.session.listFailed.title": "Kunne ikke indlæse sessioner for {{project}}",

  "toast.update.title": "Opdatering tilgængelig",
  "toast.update.description": "En ny version af TurenOS ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til TurenOS-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (forge.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, TurenOS understøtter ikke MCP-godkendelse endnu.',
  ...
  "settings.section.securityIntegrations": "Sikkerhedsintegrationer",
  "settings.tab.general": "Generelt",
  "settings.tab.shortcuts": "Genveje",
  "settings.tab.securityData": "Data",
  "settings.tab.securityTools": "Værktøjer",
  "settings.security.search.placeholder": "Søg integrationer",
  "settings.security.data.empty": "Ingen dataintegrationer endnu",
  "settings.security.tools.empty": "Ingen værktøjsintegrationer endnu",
  "settings.security.loadError": "Kunne ikke indlæse sikkerhedsintegrationer. Tjek, at din server er opdateret.",
  "settings.security.updateError": "Opdateringen mislykkedes — din ændring blev ikke gemt.",
  "settings.security.tools.notInstalled": "Ikke installeret",
  "settings.security.secret.action": "API-nøgle",
  "settings.security.secret.placeholder.set": "Konfigureret — indtast en ny nøgle for at erstatte den",
  "settings.security.secret.placeholder.unset": "Indtast API-nøgle",
  "settings.security.secret.clearHint": "Indsend en tom værdi for at rydde den gemte nøgle.",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "Slå kendte sårbarheder op i open source-databasen OSV.dev",
  "settings.security.integration.depsdev.description": "Pakkesundhed, licenser og afhængighedsgrafer fra deps.dev",
  "settings.security.integration.kev.description":
    "Tjek CVE'er mod CISA's katalog over Known Exploited Vulnerabilities",
  "settings.security.integration.epss.description": "Exploit-sandsynlighedsscorer for CVE'er fra FIRST.org",
  "settings.security.integration.ghsa.description": "Forespørg GitHub Security Advisory-databasen",
  "settings.security.integration.hibp.description":
    "Tjek for lækkede adgangskoder — data licenseret CC-BY fra haveibeenpwned.com",
  "settings.security.integration.exploitdb.description": "Søg i Exploit-DB-indekset efter offentlige exploits via CVE",
  "settings.security.integration.nvd.description": "CVE-detaljer fra NIST's National Vulnerability Database",
  "settings.security.integration.gitleaks.description": "Scan arbejdsområdet for hemmeligheder i commits",
  "settings.security.integration.trivy.description": "Scan for sårbarheder, fejlkonfigurationer og hemmeligheder",
  "settings.security.integration.osv-scanner.description": "Scan lockfiler for afhængigheder med kendte sårbarheder",
  "settings.security.integration.grype.description": "Sårbarhedsscanning og SBOM-generering",
  "settings.security.integration.checkov.description": "Scan infrastructure-as-code for fejlkonfigurationer",
  "settings.security.integration.bandit.description": "Statisk analyse af sikkerhedsproblemer i Python",
  "settings.security.integration.native-audit.description":
    "Kør hvert økosystems egen afhængighedsaudit (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "Semgrep-kompatible statiske analyseregler på tværs af arbejdsområdet",
  "settings.security.integration.batou.description":
    "Statisk applikationssikkerhedstest for almindelige sårbarheder i koden",
  "settings.security.integration.batou.note": "Automatisk — scanner hver fil, agenten skriver; blokerer kritiske fund",
  "settings.security.integration.batou.installHint": "Downloades automatisk ved første aktivering (macOS/Linux)",
  "settings.security.batou.status.downloading": "Downloader Batou…",
  "settings.security.batou.status.installed": "Installeret",
  "settings.security.batou.status.failed": "Download mislykkedes",

  "settings.section.agentIntegrations": "Agentintegrationer",
  "settings.tab.agentData": "Data",
  "settings.tab.agentTools": "Værktøjer",
  "settings.agent.data.empty": "Ingen dataintegrationer endnu",
  "settings.agent.tools.empty": "Ingen værktøjsintegrationer endnu",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Kør TurenOS-serveren inde i WSL på Windows.",
  ...
  "settings.general.section.retention": "Lagring og opbevaring",

  "settings.general.retention.scope":
    "Disse vinduer beskærer kun gemt transskriptionsindhold, hvilket frigør diskplads. De omskriver aldrig den varige hændelseslog og sletter aldrig en session. Indtast 0 for at slå et vindue fra.",
  "settings.general.retention.never":
    "Fra — intet beskæres, uanset alder. Gemt indhold bevares fuldt ud, indtil du indtaster et antal dage.",
  "settings.general.row.retentionToolOutput.title": "Værktøjsoutput",
  "settings.general.row.retentionToolOutput.description":
    "Efter {{days}} dage reduceres gemt indhold fra værktøjskald i alle sessioner til et kort uddrag — den første og den sidste linje. Bevares: værktøjets navn, dets input og et uddrag af resultatet.",
  "settings.general.row.retentionToolOutput.label": "Antal dage det fulde værktøjsoutput bevares",
  "settings.general.row.retentionArchivedSessions.title": "Arkiverede sessioner",
  "settings.general.row.retentionArchivedSessions.description":
    "{{days}} dage efter at en session er arkiveret, reduceres dens værktøjsindhold og output fra shell-kommandoer til uddrag, og alt for store værktøjsinput ryddes. Bevares: sessionen, dens titel, alle brugerprompter og alle assistentsvar — transskriptionen kan stadig læses.",
  "settings.general.row.retentionArchivedSessions.label": "Antal dage indhold fra arkiverede sessioner bevares",

  "settings.general.row.language.title": "Sprog",
  "settings.general.row.language.description": "Ændr visningssproget for TurenOS",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan TurenOS ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om TurenOS følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan TurenOS er temabestemt.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Ydelsesdiagnostik",
  "settings.general.row.performanceDiagnostics.description":
    "Vis udviklingstællere for navigation, rendering, inputforsinkelse, layoutskift og hukommelse",
  "settings.general.section.profiler": "Profilering",
  "settings.general.profiler.scope":
    "Optager kun TurenOS-serverprocessen — agentsløjfen, værktøjskørsel, komprimering og MCP. Grænseflade- og vinduestid optages ikke, så led ikke efter hakken i brugerfladen her.",
  "settings.general.row.profiler.title": "Optag CPU-profil",
  "settings.general.row.profiler.description":
    "Start optagelsen, gentag den langsomme adfærd, og stop så. Optagelse koster nogle få procent, mens den kører, og intet, når den er slået fra.",
  "settings.general.profiler.recording":
    "Optager — {{elapsed}} forløbet. Stopper af sig selv efter 10 minutter. Hvis du afslutter TurenOS, kasseres optagelsen.",
  "settings.general.profiler.unavailable": "Venter på, at TurenOS-serveren starter.",
  "settings.general.profiler.failedTitle": "Optagelsen mislykkedes",
  "settings.general.row.profilerResult.title": "Seneste optagelse",
  "settings.general.row.profilerResult.description":
    "{{samples}} stikprøver ved {{rate}} Hz over {{duration}}. Åbn .cpuprofile-filen i Chrome DevTools (Performance › Load profile) eller på speedscope.app.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når TurenOS starter",
  ...
  "settings.updates.row.track.title": "Opdateringskanal",
  "settings.updates.row.track.description": "Hvor mange versioner bag den nyeste du vil blive",
  "settings.updates.track.option.latest": "Seneste",
  "settings.updates.track.option.behindOne": "Én version bagud",
  "settings.updates.track.option.behindTwo": "To versioner bagud",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af TurenOS.",
  ...
  "settings.agents.title": "Agentindstillinger",
