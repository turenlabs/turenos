...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u TurenOS-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u TurenOS-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u TurenOS-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u forge.json",
  ...
  "dialog.server.description": "Promijeni na koji se TurenOS server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingForge": "Provjera TurenOS...",
  "wsl.onboarding.checkingForgeIn": "Provjera TurenOS u distribuciji {{distro}}...",
  "wsl.onboarding.updatingForge": "Ažuriranje TurenOS...",
  "wsl.onboarding.updatingForgeIn": "Ažuriranje TurenOS u distribuciji {{distro}}...",
  "wsl.onboarding.updateForgeIn": "Ažuriraj TurenOS u distribuciji {{distro}}.",
  "wsl.onboarding.updateForge": "Ažuriraj TurenOS",
  "wsl.onboarding.forgeReadyIn": "TurenOS je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.forgeReady": "TurenOS je spreman.",
  "wsl.onboarding.installForgeIn": "Instaliraj TurenOS u distribuciji {{distro}}.",
  "wsl.onboarding.installForge": "Instaliraj TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi TurenOS mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "TurenOS nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori TurenOS.",
  ...
  "toast.session.compact.success.title": "Sesija sažeta",
  "toast.session.compact.success.description": "Ranije poruke su sažete kako bi se oslobodio kontekst",
  "toast.session.compact.failed.title": "Sažimanje sesije nije uspjelo",

  "toast.session.listFailed.title": "Neuspjelo učitavanje sesija za {{project}}",

  "toast.update.title": "Dostupno ažuriranje",
  "toast.update.description": "Nova verzija TurenOS-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku TurenOS timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (forge.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: TurenOS još ne podržava MCP autentifikaciju.',
  ...
  "session.header.reveal.containingFolder": "Otvori sadržajnu mapu",
  ...
  "settings.section.securityIntegrations": "Sigurnosne integracije",
  "settings.tab.general": "Opšte",
  "settings.tab.shortcuts": "Prečice",
  "settings.tab.securityData": "Podaci",
  "settings.tab.securityTools": "Alati",
  "settings.security.search.placeholder": "Pretraži integracije",
  "settings.security.data.empty": "Još nema integracija podataka",
  "settings.security.tools.empty": "Još nema integracija alata",
  "settings.security.loadError":
    "Nije uspjelo učitavanje sigurnosnih integracija. Provjeri da li je tvoj server ažuriran.",
  "settings.security.updateError": "Ažuriranje nije uspjelo — tvoja izmjena nije sačuvana.",
  "settings.security.tools.notInstalled": "Nije instalirano",
  "settings.security.secret.action": "API ključ",
  "settings.security.secret.placeholder.set": "Konfigurisano — unesi novi ključ za zamjenu",
  "settings.security.secret.placeholder.unset": "Unesi API ključ",
  "settings.security.secret.clearHint": "Pošalji praznu vrijednost da obrišeš sačuvani ključ.",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "Pretraga poznatih ranjivosti u OSV.dev open source bazi podataka",
  "settings.security.integration.depsdev.description": "Zdravlje paketa, licence i grafovi zavisnosti sa deps.dev",
  "settings.security.integration.kev.description":
    "Provjera CVE-ova prema CISA katalogu poznatih eksploatisanih ranjivosti",
  "settings.security.integration.epss.description": "Ocjene vjerovatnoće eksploatacije za CVE-ove sa FIRST.org",
  "settings.security.integration.ghsa.description": "Upiti prema GitHub Security Advisory bazi podataka",
  "settings.security.integration.hibp.description":
    "Provjera curenja lozinki — podaci licencirani CC-BY sa haveibeenpwned.com",
  "settings.security.integration.exploitdb.description": "Pretraga javnih exploita po CVE-u u Exploit-DB indeksu",
  "settings.security.integration.nvd.description": "Detalji CVE-a iz NIST National Vulnerability Database baze",
  "settings.security.integration.gitleaks.description": "Skeniranje radnog prostora u potrazi za komitovanim tajnama",
  "settings.security.integration.trivy.description": "Skeniranje ranjivosti, pogrešnih konfiguracija i tajni",
  "settings.security.integration.osv-scanner.description":
    "Skeniranje lock datoteka za zavisnosti s poznatim ranjivostima",
  "settings.security.integration.grype.description": "Skeniranje ranjivosti i generisanje SBOM-a",
  "settings.security.integration.checkov.description": "Skeniranje infrastrukture kao koda za pogrešne konfiguracije",
  "settings.security.integration.bandit.description": "Statička analiza sigurnosnih problema u Python kodu",
  "settings.security.integration.native-audit.description":
    "Pokretanje vlastitog audita zavisnosti svakog ekosistema (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "Pravila statičke analize kompatibilna sa Semgrep-om za radni prostor",
  "settings.security.integration.batou.description":
    "Statičko sigurnosno testiranje aplikacija za uobičajene ranjivosti u kodu",
  "settings.security.integration.batou.note":
    "Automatski — skenira svaku datoteku koju agent napiše; blokira kritične nalaze",
  "settings.security.integration.batou.installHint": "Preuzima se automatski pri prvom omogućavanju (macOS/Linux)",
  "settings.security.batou.status.downloading": "Preuzimanje Batou…",
  "settings.security.batou.status.installed": "Instalirano",
  "settings.security.batou.status.failed": "Preuzimanje nije uspjelo",

  "settings.section.agentIntegrations": "Integracije agenata",
  "settings.tab.agentData": "Podaci",
  "settings.tab.agentTools": "Alati",
  "settings.agent.data.empty": "Još nema integracija podataka",
  "settings.agent.tools.empty": "Još nema integracija alata",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integracija",
  "settings.desktop.wsl.description": "Pokreni TurenOS server unutar WSL-a na Windowsu.",
  ...
  "settings.general.section.retention": "Pohrana i zadržavanje",

  "settings.general.retention.scope":
    "Ovi periodi samo skraćuju pohranjeni sadržaj transkripta, čime se oslobađa prostor na disku. Nikada ne prepisuju trajni zapis događaja i nikada ne brišu sesiju. Unesi 0 da isključiš period.",
  "settings.general.retention.never":
    "Isključeno — ništa se ne skraćuje bez obzira na starost. Pohranjeni sadržaj se čuva u cijelosti dok ne uneseš broj dana.",
  "settings.general.row.retentionToolOutput.title": "Izlaz alata",
  "settings.general.row.retentionToolOutput.description":
    "Nakon {{days}} dana, pohranjeni sadržaj poziva alata u svakoj sesiji svodi se na kratak pregled — prvi i posljednji red. Zadržavaju se: naziv alata, njegovi ulazi i pregled rezultata.",
  "settings.general.row.retentionToolOutput.label": "Broj dana za čuvanje potpunog izlaza alata",
  "settings.general.row.retentionArchivedSessions.title": "Arhivirane sesije",
  "settings.general.row.retentionArchivedSessions.description":
    "{{days}} dana nakon arhiviranja sesije, sadržaj njenih alata i izlaz shell komandi svode se na preglede, a preveliki ulazi alata se brišu. Zadržavaju se: sesija, njen naslov, svaki korisnikov upit i svi odgovori asistenta — transkript se i dalje može čitati.",
  "settings.general.row.retentionArchivedSessions.label": "Broj dana za čuvanje sadržaja arhiviranih sesija",

  "settings.general.row.language.title": "Jezik",
  "settings.general.row.language.description": "Promijeni jezik prikaza u TurenOS-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako TurenOS izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li TurenOS prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu TurenOS-a.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Dijagnostika performansi",
  "settings.general.row.performanceDiagnostics.description":
    "Prikaži razvojne brojače za navigaciju, renderovanje, kašnjenje unosa, pomak rasporeda i memoriju",
  "settings.general.section.profiler": "Profiler",
  "settings.general.profiler.scope":
    "Snima samo proces TurenOS servera — petlju agenta, izvršavanje alata, sažimanje i MCP. Vrijeme interfejsa i prozora se ne snima, pa ovdje ne tražite zastoje korisničkog interfejsa.",
  "settings.general.row.profiler.title": "Snimi CPU profil",
  "settings.general.row.profiler.description":
    "Pokrenite snimanje, ponovite sporo ponašanje, zatim zaustavite. Snimanje košta nekoliko posto dok radi i ništa kada je isključeno.",
  "settings.general.profiler.recording":
    "Snimanje — proteklo {{elapsed}}. Zaustavlja se samo nakon 10 minuta. Zatvaranje TurenOSa odbacuje snimak.",
  "settings.general.profiler.unavailable": "Čeka se pokretanje TurenOS servera.",
  "settings.general.profiler.failedTitle": "Snimanje nije uspjelo",
  "settings.general.row.profilerResult.title": "Posljednje snimanje",
  "settings.general.row.profilerResult.description":
    "{{samples}} uzoraka pri {{rate}} Hz tokom {{duration}}. Otvorite .cpuprofile u Chrome DevToolsu (Performance › Load profile) ili na speedscope.app.",
  "settings.general.profiler.reveal": "Prikaži",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se TurenOS pokrene",
  ...
  "settings.updates.row.track.title": "Kanal ažuriranja",
  "settings.updates.row.track.description": "Koliko izdanja iza najnovijeg želite ostati",
  "settings.updates.track.option.latest": "Najnovije",
  "settings.updates.track.option.behindOne": "Jedno izdanje iza",
  "settings.updates.track.option.behindTwo": "Dva izdanja iza",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju TurenOS-a.",
  ...
  "settings.agents.title": "Postavke agenata",
  ...
  "nav.rail.label": "Glavna navigacija",
  "nav.rail.agents": "Agenti",
  "nav.rail.agents.running": "{{count}} pokrenuto",
  "nav.rail.agents.showPanel": "Agenti — prikaži panel",
  "nav.rail.agents.hidePanel": "Agenti — sakrij panel",
  "nav.rail.settings": "Postavke",
  "nav.rail.help": "Pomoć",
  "nav.rail.server": "Server: {{server}}",
  "command.nav.agents": "Idi na Agente",
  "command.nav.panel.toggle": "Prikaži/sakrij navigacijski panel",
