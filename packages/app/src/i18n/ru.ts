...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в TurenOS.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в TurenOS.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в TurenOS.",
  ...
  "dialog.plugins.empty": "Плагины настроены в forge.json",
  ...
  "dialog.server.description": "Переключите сервер TurenOS к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingForge": "Проверка TurenOS...",
  "wsl.onboarding.checkingForgeIn": "Проверка TurenOS в {{distro}}...",
  "wsl.onboarding.updatingForge": "Обновление TurenOS...",
  "wsl.onboarding.updatingForgeIn": "Обновление TurenOS в {{distro}}...",
  "wsl.onboarding.updateForgeIn": "Обновите TurenOS в {{distro}}.",
  "wsl.onboarding.updateForge": "Обновить TurenOS",
  "wsl.onboarding.forgeReadyIn": "TurenOS в {{distro}} готов к работе.",
  "wsl.onboarding.forgeReady": "TurenOS готов к работе.",
  "wsl.onboarding.installForgeIn": "Установите TurenOS в {{distro}}.",
  "wsl.onboarding.installForge": "Установить TurenOS",
  ...
  "wsl.onboarding.distroStatus.forgeMissing": "TurenOS не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в TurenOS требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "TurenOS не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте TurenOS.",
  ...
  "toast.session.compact.success.title": "Сессия сжата",
  "toast.session.compact.success.description": "Предыдущие сообщения были обобщены, чтобы освободить контекст",
  "toast.session.compact.failed.title": "Не удалось сжать сессию",

  "toast.session.listFailed.title": "Не удалось загрузить сессии для {{project}}",

  "toast.update.title": "Доступно обновление",
  "toast.update.description": "Новая версия TurenOS ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде TurenOS",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (forge.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что TurenOS пока не поддерживает MCP авторизацию.',
  ...
  "settings.section.securityIntegrations": "Интеграции безопасности",
  "settings.tab.general": "Основные",
  "settings.tab.shortcuts": "Горячие клавиши",
  "settings.tab.securityData": "Данные",
  "settings.tab.securityTools": "Инструменты",
  "settings.security.search.placeholder": "Поиск интеграций",
  "settings.security.data.empty": "Пока нет интеграций данных",
  "settings.security.tools.empty": "Пока нет интеграций инструментов",
  "settings.security.loadError": "Не удалось загрузить интеграции безопасности. Убедитесь, что ваш сервер обновлён.",
  "settings.security.updateError": "Не удалось обновить — ваше изменение не было сохранено.",
  "settings.security.tools.notInstalled": "Не установлено",
  "settings.security.secret.action": "API ключ",
  "settings.security.secret.placeholder.set": "Настроено — введите новый ключ для замены",
  "settings.security.secret.placeholder.unset": "Введите API ключ",
  "settings.security.secret.clearHint": "Отправьте пустое значение, чтобы удалить сохранённый ключ.",
  "settings.security.nvd.notice": "This product uses the NVD API but is not endorsed or certified by the NVD.",
  "settings.security.integration.osv.description": "Поиск известных уязвимостей в базе данных открытого кода OSV.dev",
  "settings.security.integration.depsdev.description": "Состояние пакетов, лицензии и графы зависимостей из deps.dev",
  "settings.security.integration.kev.description":
    "Проверка CVE по каталогу известных эксплуатируемых уязвимостей CISA",
  "settings.security.integration.epss.description": "Оценки вероятности эксплуатации CVE от FIRST.org",
  "settings.security.integration.ghsa.description": "Запросы к базе данных GitHub Security Advisory",
  "settings.security.integration.hibp.description":
    "Проверка паролей на утечки — данные по лицензии CC-BY с haveibeenpwned.com",
  "settings.security.integration.exploitdb.description": "Поиск публичных эксплойтов по CVE в индексе Exploit-DB",
  "settings.security.integration.nvd.description": "Сведения о CVE из Национальной базы данных уязвимостей NIST",
  "settings.security.integration.gitleaks.description":
    "Сканирование рабочего пространства на наличие закоммиченных секретов",
  "settings.security.integration.trivy.description": "Сканирование на уязвимости, неправильные конфигурации и секреты",
  "settings.security.integration.osv-scanner.description":
    "Сканирование lock-файлов на зависимости с известными уязвимостями",
  "settings.security.integration.grype.description": "Сканирование уязвимостей и генерация SBOM",
  "settings.security.integration.checkov.description":
    "Сканирование инфраструктуры как кода на неправильные конфигурации",
  "settings.security.integration.bandit.description": "Статический анализ кода Python на проблемы безопасности",
  "settings.security.integration.native-audit.description":
    "Запуск собственного аудита зависимостей каждой экосистемы (npm, pip, cargo, Go)",
  "settings.security.integration.opengrep.description":
    "Semgrep-совместимые правила статического анализа для рабочего пространства",
  "settings.security.integration.batou.description":
    "Статическое тестирование безопасности приложений на типичные уязвимости в коде",
  "settings.security.integration.batou.note":
    "Автоматически — сканирует каждый файл, который пишет агент, и блокирует критические находки",
  "settings.security.integration.batou.installHint": "Загружается автоматически при первом включении (macOS/Linux)",
  "settings.security.batou.status.downloading": "Загрузка Batou…",
  "settings.security.batou.status.installed": "Установлено",
  "settings.security.batou.status.failed": "Ошибка загрузки",

  "settings.section.agentIntegrations": "Интеграции агентов",
  "settings.tab.agentData": "Данные",
  "settings.tab.agentTools": "Инструменты",
  "settings.agent.data.empty": "Пока нет интеграций данных",
  "settings.agent.tools.empty": "Пока нет интеграций инструментов",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Интеграция с WSL",
  "settings.desktop.wsl.description": "Запускать сервер TurenOS внутри WSL на Windows.",
  ...
  "settings.general.section.retention": "Хранилище и срок хранения",

  "settings.general.retention.scope":
    "Эти периоды только сокращают сохранённые данные транскрипта, освобождая место на диске. Они никогда не переписывают устойчивый журнал событий и никогда не удаляют сессию. Введите 0, чтобы отключить период.",
  "settings.general.retention.never":
    "Выключено — ничего не сокращается независимо от срока. Сохранённые данные хранятся полностью, пока вы не укажете количество дней.",
  "settings.general.row.retentionToolOutput.title": "Вывод инструментов",
  "settings.general.row.retentionToolOutput.description":
    "Через {{days}} дн. сохранённые данные вызовов инструментов во всех сессиях сокращаются до краткого предпросмотра — первой и последней строк. Сохраняются: название инструмента, его входные данные и предпросмотр результата.",
  "settings.general.row.retentionToolOutput.label": "Сколько дней хранить полный вывод инструментов",
  "settings.general.row.retentionArchivedSessions.title": "Архивированные сессии",
  "settings.general.row.retentionArchivedSessions.description":
    "Через {{days}} дн. после архивирования сессии её данные инструментов и вывод команд оболочки сокращаются до предпросмотров, а слишком большие входные данные инструментов очищаются. Сохраняются: сама сессия, её название, все запросы пользователя и все ответы ассистента — транскрипт по-прежнему читается.",
  "settings.general.row.retentionArchivedSessions.label": "Сколько дней хранить данные архивированных сессий",

  "settings.general.row.language.title": "Язык",
  "settings.general.row.language.description": "Изменить язык отображения TurenOS",
  ...
  "settings.general.row.appearance.description": "Настройте как TurenOS выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли TurenOS системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление TurenOS.",
  ...
  "settings.general.row.performanceDiagnostics.title": "Диагностика производительности",
  "settings.general.row.performanceDiagnostics.description":
    "Показывать счетчики разработки для навигации, отрисовки, задержки ввода, сдвига макета и памяти",
  "settings.general.section.profiler": "Профилировщик",
  "settings.general.profiler.scope":
    "Записывает только процесс сервера TurenOS — цикл агента, выполнение инструментов, сжатие и MCP. Время интерфейса и окна не записывается, поэтому не ищите здесь подвисания интерфейса.",
  "settings.general.row.profiler.title": "Записать профиль CPU",
  "settings.general.row.profiler.description":
    "Начните запись, воспроизведите медленное поведение, затем остановите её. Запись расходует несколько процентов во время работы и ничего, когда выключена.",
  "settings.general.profiler.recording":
    "Идет запись — прошло {{elapsed}}. Останавливается сама через 10 минут. Выход из TurenOS отбрасывает запись.",
  "settings.general.profiler.unavailable": "Ожидание запуска сервера TurenOS.",
  "settings.general.profiler.failedTitle": "Не удалось выполнить запись",
  "settings.general.row.profilerResult.title": "Последняя запись",
  "settings.general.row.profilerResult.description":
    "{{samples}} сэмплов с частотой {{rate}} Гц за {{duration}}. Откройте файл .cpuprofile в Chrome DevTools (Performance › Load profile) или на speedscope.app.",
  "settings.general.profiler.reveal": "Показать",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске TurenOS",
  ...
  "settings.updates.row.track.title": "Канал обновлений",
  "settings.updates.row.track.description": "На сколько версий отставать от последней",
  "settings.updates.track.option.latest": "Последняя",
  "settings.updates.track.option.behindOne": "На одну версию позади",
  "settings.updates.track.option.behindTwo": "На две версии позади",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию TurenOS.",
  ...
  "settings.agents.title": "Настройки агентов",
  ...
  "nav.rail.agents": "Агенты",
  "nav.rail.agents.running": "{{count}} выполняется",
  "nav.rail.agents.showPanel": "Агенты — показать панель",
  "nav.rail.agents.hidePanel": "Агенты — скрыть панель",
  "nav.rail.settings": "Настройки",
  "nav.rail.help": "Помощь",
  "nav.rail.server": "Сервер: {{server}}",
  "command.nav.agents": "Перейти к агентам",
  "command.nav.panel.toggle": "Переключить панель навигации",
