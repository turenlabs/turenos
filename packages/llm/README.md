...
Schema-first LLM core for TurenOS and other agent hosts. One typed request,
response, event, and tool language; provider quirks live in adapters, not in
calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@turenlabs/llm"
import { OpenAI } from "@turenlabs/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@turenlabs/llm/providers"
