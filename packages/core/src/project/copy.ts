...
import { Event } from "@turenlabs/schema/project-directories"
import { ProjectCopy } from "@turenlabs/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@forge/ProjectCopy") {}
