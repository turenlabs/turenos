              ...
              return Effect.gen(function* () {
                ...
                for (const external of externalDirectories.values()) {
                  yield* permission.assert({
                    ...
                    metadata: PermissionV2.mutationMetadata(targets.map(({ target }) => target.canonical)),
