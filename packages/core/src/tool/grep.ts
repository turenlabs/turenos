    ...
    yield* tools
      .register({
        [name]: Tool.make({
          ...
          // re-absolutizing prefixed each result line with the workspace root — kilobytes
          // of repeated prefix per call, re-sent every turn. Relative paths resolve fine
          // in every follow-up tool.
