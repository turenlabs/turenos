...
import { OpencodePlugin } from "@turenlabs/core/plugin/provider/opencode"
...
describe("OpencodePlugin", () => {
  ...
  it.effect("never injects a credential of its own", () =>
  ...
  it.effect("leaves a configured apiKey untouched", () =>
    withEnv({ OPENCODE_API_KEY: undefined }, () =>
      Effect.gen(function* () {
        const catalog = yield* Catalog.Service
        yield* catalog.transform((catalog) => {
