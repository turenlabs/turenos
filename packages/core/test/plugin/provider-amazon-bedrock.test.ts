...
const addPlugin = Effect.fn(function* () {
  ...
  const { AmazonBedrockPlugin } = yield* Effect.promise(() => import("@turenlabs/core/plugin/provider/amazon-bedrock"))
...
describe("AmazonBedrockPlugin", () => {
  ...
  it.effect("uses a bearer token option without copying it into process env", () =>
