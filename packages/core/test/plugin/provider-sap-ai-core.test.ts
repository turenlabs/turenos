...
const addPlugin = Effect.fn(function* () {
  ...
  const { SapAICorePlugin } = yield* Effect.promise(() => import("@turenlabs/core/plugin/provider/sap-ai-core"))
...
describe("SapAICorePlugin", () => {
  it.effect("rejects a stored service key instead of copying it into process env", () =>
    withEnv(
