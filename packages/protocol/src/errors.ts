...
export class LoopNotFoundError extends Schema.TaggedErrorClass<LoopNotFoundError>()(
  "LoopNotFoundError",
  { loopID: Schema.String, message: Schema.String },
  { httpApiStatus: 404 },
) {}

export class LoopRunNotFoundError extends Schema.TaggedErrorClass<LoopRunNotFoundError>()(
