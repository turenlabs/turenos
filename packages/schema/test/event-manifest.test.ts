...
describe("public event manifest", () => {
  ...
  test("uses canonical definitions for current public events", () => {
    ...
    expect(EventManifest.Latest.get("session.next.compaction.pruned")).toBe(SessionEvent.Compaction.Pruned)
    expect(EventManifest.Durable.get("session.next.compaction.pruned.1")).toBe(SessionEvent.Compaction.Pruned)
    expect(EventManifest.Latest.get("session.next.goal.updated")).toBe(SessionEvent.Goal.Updated)
    expect(EventManifest.Latest.get("session.next.goal.cleared")).toBe(SessionEvent.Goal.Cleared)
