...
export const Capabilities = Schema.Struct({
  ...
  // models.dev `interleaved`: the field a thinking model expects its own reasoning echoed back on.
  // Providers that declare it reject a request whose assistant history drops the field.
  interleaved: Schema.Struct({
