  ...
  return async function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      if (Module["locateFile"]) {
        return locateFile("libpcap.wasm")
      }
      return new URL("libpcap.wasm", import.meta.url).href
    }
    ...
    function assignWasmExports(wasmExports) {
      ...
      _free = wasmExports["_"]
      _ntohs = wasmExports["$"]
      _htonl = wasmExports["aa"]
      ___getTypeName = wasmExports["ba"]
      _htons = wasmExports["da"]
      __emscripten_timeout = wasmExports["ea"]
