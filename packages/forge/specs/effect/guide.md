...
How we write Effect code in `packages/forge`. This guide describes the preferred shape for new work and migrations. If a
...
export class Service extends Context.Service<Service, Interface>()("@forge/Foo") {}
...
- The public config schema is generated through the schema script.
