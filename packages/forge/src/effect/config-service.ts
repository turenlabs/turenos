 ...
 *   "@forge/ServerAuthConfig",
 *   {
 *     password: Config.string("FORGE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("FORGE_SERVER_USERNAME").pipe(Config.withDefault("forge")),
 *   },
 * ) {}
 *
