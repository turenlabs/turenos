...
export class Service extends Context.Service<Service, Interface>()("@forge/SessionRevert") {}
...
export const node = LayerNode.make({
  service: Service,
  layer: layer,
  deps: [Session.node, Snapshot.node, EventV2Bridge.node, SessionSummary.node, SessionRunState.node],
})
