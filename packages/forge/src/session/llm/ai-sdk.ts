import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@turenlabs/llm"
...
// Move this extraction into @turenlabs/llm when Copilot is handled by the native runtime.
