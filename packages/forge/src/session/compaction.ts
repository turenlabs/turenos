...
import { buildPrompt } from "@turenlabs/core/session/compaction"
import { SessionCompactionEvent } from "@turenlabs/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@forge/SessionCompaction") {}
