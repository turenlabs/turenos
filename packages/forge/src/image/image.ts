...
export class Service extends Context.Service<Service, Interface>()("@forge/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __FORGE_PHOTON_WASM_PATH?: string }).__FORGE_PHOTON_WASM_PATH =
