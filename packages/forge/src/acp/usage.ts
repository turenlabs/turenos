...
import type { AssistantMessage as ForgeAssistantMessage, Message } from "@turenlabs/sdk/v2"
...
export type AssistantTokenCost = Pick<ForgeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ForgeAssistantMessage, "role"> &
  Partial<Pick<ForgeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@forge/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@forge/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@forge/ACPUsage") {}
