...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@forge/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@forge/ACPDirectory") {}
