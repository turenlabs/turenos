...
export const UpdatePayload = Schema.Struct({
  ...
  time: Schema.optional(
    Schema.Struct({
      // Nullable so archiving is a reversible two-way door: a timestamp archives,
      // an explicit null unarchives. Omitting the field leaves archival untouched.
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all TurenOS sessions, sorted by most recently updated.",
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific TurenOS session.",
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new TurenOS session for interacting with AI assistants and managing conversations.",
          }),
        ),
        ...
        HttpApiEndpoint.post("permissionRespond", SessionPaths.permissions, {
          ...
          error: [HttpApiError.BadRequest, ApiNotFoundError, PermissionNotFoundError, InvalidRequestError],
        }).annotateMerge(
          OpenApi.annotations({
