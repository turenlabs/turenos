...
const SessionToolSnapshotTool = Schema.Struct({
  id: Schema.String,
  description: Schema.String,
  source: Schema.Literals(["builtin", "session", "mcp", "mcp-broker"]),
  parameters: Schema.Unknown,
}).annotate({ identifier: "SessionToolSnapshotTool" })
const SessionToolSnapshotCapability = Schema.Struct({
  key: Schema.String,
...
}).annotate({ identifier: "SessionToolSnapshotCapability" })
const SessionToolSnapshotServer = Schema.Struct({
  id: Schema.String,
  status: Schema.Literals(["connected", "connecting", "disabled", "needs-auth", "failed", "unknown"]),
  definitions: NonNegativeInt,
  detail: Schema.optional(Schema.String),
}).annotate({ identifier: "SessionToolSnapshotServer" })
const SessionToolSnapshotExclusion = Schema.Struct({
  id: Schema.optional(Schema.String),
  server: Schema.optional(Schema.String),
  source: Schema.optional(Schema.Literals(["builtin", "session", "mcp", "mcp-broker"])),
  ...
  detail: Schema.optional(Schema.String),
}).annotate({ identifier: "SessionToolSnapshotExclusion" })
const SessionToolSnapshotResponse = Schema.Struct({
  sessionID: SessionID,
  ...
  visible: Schema.Array(SessionToolSnapshotTool),
  mcpServers: Schema.Array(SessionToolSnapshotServer),
  broker: Schema.Struct({
    visible: Schema.Array(Schema.String),
    capabilities: Schema.Array(SessionToolSnapshotCapability),
...
export const ExperimentalApi = HttpApi.make("experimental")
      ...
      .add(
        HttpApiEndpoint.get("capabilities", ExperimentalPaths.capabilities, {
          ...
          OpenApi.annotations({
            ...
            description: "Get experimental features enabled on the TurenOS server.",
          }),
        ),
        ...
        HttpApiEndpoint.post("consoleSwitch", ExperimentalPaths.consoleSwitch, {
          ...
          OpenApi.annotations({
            ...
            description: "Persist a new active Console account/org selection for the current local TurenOS state.",
          }),
        ),
        HttpApiEndpoint.get("tool", ExperimentalPaths.tool, {
          query: ToolListQuery,
          success: described(SessionToolSnapshotResponse, "V2 session tool snapshot"),
          error: HttpApiError.BadRequest,
        }).annotateMerge(
          OpenApi.annotations({
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "TurenOS experimental HttpApi",
      version: "0.0.1",
