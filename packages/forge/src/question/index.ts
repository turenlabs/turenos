...
import { QuestionV1 } from "@turenlabs/schema/question-v1"
...
export class Service extends Context.Service<Service, Interface>()("@forge/Question") {}
...
export const node = LayerNode.make({
  service: Service,
  layer: layer,
  deps: [EventV2Bridge.node, SessionTaskV2.node],
})
