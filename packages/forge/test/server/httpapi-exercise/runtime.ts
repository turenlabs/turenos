export type Runtime = {
  ...
  AppNodeBuilderV1: (typeof import("../../../src/effect/app-node-builder-v1"))["AppNodeBuilderV1"]
  LayerNode: (typeof import("@turenlabs/core/effect/layer-node"))["LayerNode"]
  EventV2: (typeof import("@turenlabs/core/event"))["EventV2"]
  SessionProjector: (typeof import("@turenlabs/core/session/projector"))["SessionProjector"]
  SessionTask: (typeof import("@turenlabs/core/session/task"))["SessionTaskV2"]
...
export function runtime() {
  return (runtimePromise ??= (async () => {
    ...
    const appNodeBuilder = await import("../../../src/effect/app-node-builder-v1")
    const layerNode = await import("@turenlabs/core/effect/layer-node")
    const event = await import("@turenlabs/core/event")
    const sessionProjector = await import("@turenlabs/core/session/projector")
    const sessionTask = await import("@turenlabs/core/session/task")
    ...
    return {
      ...
      AppNodeBuilderV1: appNodeBuilder.AppNodeBuilderV1,
      LayerNode: layerNode.LayerNode,
      EventV2: event.EventV2,
      SessionProjector: sessionProjector.SessionProjector,
      SessionTask: sessionTask.SessionTaskV2,
