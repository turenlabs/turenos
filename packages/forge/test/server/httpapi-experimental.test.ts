...
import { AccountV2 } from "@turenlabs/core/account"
...
function withCreatedWorktree(
  ...
  return Effect.acquireUseRelease(
    Effect.gen(function* () {
      ...
      expect(info).toMatchObject({ name, branch: "turen/api-test" })
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        expect((yield* json<{ visible: unknown[] }>(toolList)).visible).toContainEqual(
