...
/**
 * Packaged Electron windows load renderer HTML via the privileged `forge-internal://`
...
describe("electron vite publicDir", () => {
  test("configured publicDir resolves to a directory with forge-theme-preload.js", async () => {
    ...
    expect(existsSync(join(resolved, "forge-theme-preload.js"))).toBe(true)
  })
})
