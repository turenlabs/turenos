...
export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av TurenOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av TurenOS er lastet ned. Vil du installere den og starte på nytt?",
