...
export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de TurenOS",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de TurenOS a été téléchargée. Voulez-vous l'installer et redémarrer ?",
