...
export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af TurenOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af TurenOS er blevet downloadet. Vil du installere den og genstarte?",
