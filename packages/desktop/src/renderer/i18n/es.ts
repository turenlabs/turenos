...
export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de TurenOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de TurenOS. ¿Quieres instalarla y reiniciar?",
