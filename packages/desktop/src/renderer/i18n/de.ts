...
export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von TurenOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von TurenOS wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
