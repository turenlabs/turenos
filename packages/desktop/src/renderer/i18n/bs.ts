...
export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju TurenOS-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija TurenOS {{version}} je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
