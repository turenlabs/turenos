...
import { compile, emitEffectImported, emitPromise, write } from "@turenlabs/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "ForgeEventEncoded",
              import: 'import type { ForgeEventEncoded } from "@turenlabs/protocol/groups/event"',
            },
          },
        }),
