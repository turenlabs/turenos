...
class Database extends Context.Service<Database, DatabaseShape>()("@forge/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@forge/example/UserStore") {
