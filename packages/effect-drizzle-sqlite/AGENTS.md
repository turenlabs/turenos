...
- Do not add TurenOS-specific tables, paths, migrations, post-commit hooks, or domain storage APIs here.
...
- If touching Effect APIs, verify against the installed Effect declarations and the relevant upstream source.
