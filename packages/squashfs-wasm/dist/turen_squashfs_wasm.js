/* @ts-self-types="./turen_squashfs_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function squashfs_extract(bytes, options_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        wasm.squashfs_extract(retptr, ptr0, len0, ptr1, len1);
 ...
 * @returns {string}
 */
export function squashfs_list(bytes, options_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const ptr1 = passStringToWasm0(options_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.squashfs_list(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./turen_squashfs_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('turen_squashfs_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
