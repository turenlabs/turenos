/* @ts-self-types="./turen_fuzzy_hash_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function fuzzy_compare(algorithm, hash_a, hash_b) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ptr1 = passStringToWasm0(hash_a, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(hash_b, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len2 = WASM_VECTOR_LEN;
        wasm.fuzzy_compare(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
 ...
 * @returns {string}
 */
export function fuzzy_hash(algorithm, bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.fuzzy_hash(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred3_0 = r0;
        deferred3_1 = r1;
 ...
 * @returns {string}
 */
export function hash_all(bytes) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.hash_all(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./turen_fuzzy_hash_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('turen_fuzzy_hash_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
