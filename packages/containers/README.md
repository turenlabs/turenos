...
```
REGISTRY=ghcr.io/turenio TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/turenio TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-desktop-runtime:
    ...
    container:
      image: ghcr.io/turenio/build/bun-node:24.04
```
