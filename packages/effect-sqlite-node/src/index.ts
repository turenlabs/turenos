...
export const TypeId: TypeId = "~@turenlabs/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@turenlabs/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@turenlabs/effect-sqlite-node/NodeSqliteClient")
