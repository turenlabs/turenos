...
export function createAutoScroll(options: AutoScrollOptions) {
  ...
  const handleScroll = () => {
    ...
    if (store.userScrolled) {
      // An initial upward trackpad step can remain inside the follow threshold.
      // Keep the user's pause until they actually return to the bottom.
      if (distance <= 1) setStore("userScrolled", false)
      return
    }
