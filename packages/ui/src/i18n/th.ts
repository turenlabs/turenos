export const dict = {
  "ui.tool.reflectionRead": "อ่านบันทึกเซสชัน",
  "ui.tool.reflectionState": "อัปเดตบันทึกเซสชัน",
  "ui.tool.reflectionComplete": "ตรวจสอบความคืบหน้าของเซสชัน",
  "ui.tool.boardRead": "อ่านบันทึกทีม",
  "ui.tool.boardPost": "แชร์บันทึกทีม",
  "ui.tool.agentSpawn": "เริ่มเอเจนต์ย่อย",
  "ui.tool.agentSend": "ส่งข้อความถึงเอเจนต์ย่อย",
  "ui.tool.agentWait": "รอเอเจนต์ย่อย",
  "ui.tool.agentInterrupt": "หยุดเอเจนต์ย่อย",
  "ui.tool.agentList": "แสดงรายการเอเจนต์ย่อย",
  "ui.toolDetails.input": "ข้อมูลเข้า",
  "ui.toolDetails.output": "ผลลัพธ์",
  "ui.toolDetails.download": "ดาวน์โหลดผลลัพธ์ทั้งหมด",
  "ui.toolDetails.previous": "ก่อนหน้า",
  "ui.toolDetails.next": "ถัดไป",
  "ui.toolDetails.page": "{{page}} จาก {{pages}}",
  "ui.sessionTurn.status.working": "กำลังทำงาน",
  "ui.messagePart.context.activity": "กิจกรรมของเซสชัน",
  "ui.messagePart.context.operation.one": "การดำเนินการกับบริบท {{count}} รายการ",
  "ui.messagePart.context.operation.other": "การดำเนินการกับบริบท {{count}} รายการ",
  ...
  "ui.messagePart.toolCleared": "ล้างผลลัพธ์ออกจากบริบทแล้ว",
  "ui.messagePart.failure.title": "{{tool}} ล้มเหลว",
  "ui.messagePart.board.notes.one": "{{count}} โน้ต",
  "ui.messagePart.board.notes.other": "{{count}} โน้ต",
  "ui.messagePart.board.superseded": "ถูกแทนที่แล้ว",
  "ui.messagePart.board.evidence": "หลักฐาน",
  ...
  "ui.basicTool.argsMore": "+{{count}} รายการ",
  "ui.basicTool.argsUnavailable": "อาร์กิวเมนต์ไม่พร้อมใช้งาน",
