export const dict = {
  "ui.tool.reflectionRead": "قراءة ملاحظات الجلسة",
  "ui.tool.reflectionState": "تحديث ملاحظات الجلسة",
  "ui.tool.reflectionComplete": "مراجعة تقدم الجلسة",
  "ui.tool.boardRead": "قراءة ملاحظات الفريق",
  "ui.tool.boardPost": "مشاركة ملاحظات الفريق",
  "ui.tool.agentSpawn": "بدء وكيل فرعي",
  "ui.tool.agentSend": "مراسلة الوكيل الفرعي",
  "ui.tool.agentWait": "انتظار الوكلاء الفرعيين",
  "ui.tool.agentInterrupt": "إيقاف الوكيل الفرعي",
  "ui.tool.agentList": "قائمة الوكلاء الفرعيين",
  "ui.toolDetails.input": "المدخلات",
  "ui.toolDetails.output": "المخرجات",
  "ui.toolDetails.download": "تنزيل النتيجة الكاملة",
  "ui.toolDetails.previous": "السابق",
  "ui.toolDetails.next": "التالي",
  "ui.toolDetails.page": "{{page}} من {{pages}}",
  "ui.sessionTurn.status.working": "جارٍ العمل",
  "ui.messagePart.context.activity": "نشاط الجلسة",
  "ui.messagePart.context.operation.one": "{{count}} عملية سياق",
  "ui.messagePart.context.operation.other": "{{count}} عمليات سياق",
  ...
  "ui.messagePart.toolCleared": "تمت إزالة النتيجة من السياق",
  "ui.messagePart.failure.title": "{{tool}} فشل",
  "ui.messagePart.board.notes.one": "{{count}} ملاحظة",
  "ui.messagePart.board.notes.other": "{{count}} ملاحظات",
  "ui.messagePart.board.superseded": "تم استبدالها",
  "ui.messagePart.board.evidence": "الأدلة",
  ...
  "ui.basicTool.argsMore": "+{{count}} أخرى",
  "ui.basicTool.argsUnavailable": "الوسائط غير متاحة",
