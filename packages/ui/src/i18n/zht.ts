...
export const dict = {
  ...
  "ui.tool.agentSpawn": "啟動子代理程式",
  "ui.tool.agentSend": "傳送訊息給子代理程式",
  "ui.tool.agentWait": "等待子代理程式",
  "ui.tool.agentInterrupt": "停止子代理程式",
  "ui.tool.agentList": "列出子代理程式",
  ...
  "ui.messagePart.toolCleared": "結果已從上下文中清除",
  "ui.messagePart.failure.title": "{{tool}} 失敗",
  "ui.messagePart.board.notes.one": "{{count}} 則備註",
  "ui.messagePart.board.notes.other": "{{count}} 則備註",
  "ui.messagePart.board.superseded": "已取代",
  "ui.messagePart.board.evidence": "證據",
  ...
  "ui.messagePart.context.shell.one": "{{count}} 個 Shell 命令",
  "ui.messagePart.context.shell.other": "{{count}} 個 Shell 命令",
  ...
  "ui.basicTool.argsMore": "還有 {{count}} 項",
  "ui.basicTool.argsUnavailable": "參數無法顯示",
