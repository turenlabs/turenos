export const dict: Record<string, string> = {
  "ui.tool.reflectionRead": "Прочитати нотатки сеансу",
  "ui.tool.reflectionState": "Оновити нотатки сеансу",
  "ui.tool.reflectionComplete": "Перевірити перебіг сеансу",
  "ui.tool.boardRead": "Прочитати нотатки команди",
  "ui.tool.boardPost": "Поділитися нотатками команди",
  "ui.tool.agentSpawn": "Запустити субагента",
  "ui.tool.agentSend": "Надіслати повідомлення субагенту",
  "ui.tool.agentWait": "Дочекатися субагентів",
  "ui.tool.agentInterrupt": "Зупинити субагента",
  "ui.tool.agentList": "Список субагентів",
  "ui.toolDetails.input": "Вхідні дані",
  "ui.toolDetails.output": "Вихідні дані",
  "ui.toolDetails.download": "Завантажити повний результат",
  "ui.toolDetails.previous": "Назад",
  "ui.toolDetails.next": "Далі",
  "ui.toolDetails.page": "{{page}} з {{pages}}",
  "ui.sessionTurn.status.working": "У роботі",
  "ui.messagePart.context.activity": "Активність сеансу",
  "ui.messagePart.context.operation.one": "{{count}} операція з контекстом",
  "ui.messagePart.context.operation.other": "Операції з контекстом: {{count}}",
  ...
  "ui.messagePart.toolCleared": "Результат вилучено з контексту",
  "ui.messagePart.failure.title": "{{tool}} не вдалося виконати",
  "ui.messagePart.board.notes.one": "{{count}} нотатка",
  "ui.messagePart.board.notes.other": "{{count}} нотаток",
  "ui.messagePart.board.superseded": "Замінено",
  "ui.messagePart.board.evidence": "Докази",
  ...
  "ui.basicTool.argsMore": "+{{count}} ще",
  "ui.basicTool.argsUnavailable": "аргументи недоступні",
