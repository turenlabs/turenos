export const dict = {
  "ui.tool.reflectionRead": "Lire les notes de session",
  "ui.tool.reflectionState": "Mettre à jour les notes de session",
  "ui.tool.reflectionComplete": "Examiner la progression de la session",
  "ui.tool.boardRead": "Lire les notes de l’équipe",
  "ui.tool.boardPost": "Partager les notes de l’équipe",
  "ui.tool.agentSpawn": "Démarrer le sous-agent",
  "ui.tool.agentSend": "Envoyer un message au sous-agent",
  "ui.tool.agentWait": "Attendre les sous-agents",
  "ui.tool.agentInterrupt": "Arrêter le sous-agent",
  "ui.tool.agentList": "Lister les sous-agents",
  "ui.toolDetails.input": "Entrée",
  "ui.toolDetails.output": "Sortie",
  "ui.toolDetails.download": "Télécharger le résultat complet",
  "ui.toolDetails.previous": "Précédent",
  "ui.toolDetails.next": "Suivant",
  "ui.toolDetails.page": "{{page}} sur {{pages}}",
  "ui.sessionTurn.status.working": "En cours",
  "ui.messagePart.context.activity": "Activité de la session",
  "ui.messagePart.context.operation.one": "{{count}} opération de contexte",
  "ui.messagePart.context.operation.other": "{{count}} opérations de contexte",
  ...
  "ui.messagePart.toolCleared": "Résultat effacé du contexte",
  "ui.messagePart.failure.title": "{{tool}} a échoué",
  "ui.messagePart.board.notes.one": "{{count}} note",
  "ui.messagePart.board.notes.other": "{{count}} notes",
  "ui.messagePart.board.superseded": "Remplacée",
  "ui.messagePart.board.evidence": "Preuves",
  ...
  "ui.messagePart.context.shell.one": "{{count}} commande shell",
  "ui.messagePart.context.shell.other": "{{count}} commandes shell",
  ...
  "ui.basicTool.argsMore": "+{{count}} de plus",
  "ui.basicTool.argsUnavailable": "arguments indisponibles",
