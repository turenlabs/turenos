export const dict = {
  "ui.tool.reflectionRead": "セッションのメモを読む",
  "ui.tool.reflectionState": "セッションのメモを更新",
  "ui.tool.reflectionComplete": "セッションの進捗を確認",
  "ui.tool.boardRead": "チームのメモを読む",
  "ui.tool.boardPost": "チームのメモを共有",
  "ui.tool.agentSpawn": "サブエージェントを開始",
  "ui.tool.agentSend": "サブエージェントにメッセージを送信",
  "ui.tool.agentWait": "サブエージェントを待機",
  "ui.tool.agentInterrupt": "サブエージェントを停止",
  "ui.tool.agentList": "サブエージェントを一覧表示",
  "ui.toolDetails.input": "入力",
  "ui.toolDetails.output": "出力",
  "ui.toolDetails.download": "結果全体をダウンロード",
  "ui.toolDetails.previous": "前へ",
  "ui.toolDetails.next": "次へ",
  "ui.toolDetails.page": "{{page}} / {{pages}}",
  "ui.sessionTurn.status.working": "作業中",
  "ui.messagePart.context.activity": "セッションのアクティビティ",
  "ui.messagePart.context.operation.one": "コンテキスト操作 {{count}} 件",
  "ui.messagePart.context.operation.other": "コンテキスト操作 {{count}} 件",
  ...
  "ui.messagePart.toolCleared": "結果をコンテキストから削除しました",
  "ui.messagePart.failure.title": "{{tool}} に失敗しました",
  "ui.messagePart.board.notes.one": "{{count}} 件のメモ",
  "ui.messagePart.board.notes.other": "{{count}} 件のメモ",
  "ui.messagePart.board.superseded": "置き換え済み",
  "ui.messagePart.board.evidence": "証拠",
  ...
  "ui.messagePart.context.shell.one": "{{count}} 件のシェルコマンド",
  "ui.messagePart.context.shell.other": "{{count}} 件のシェルコマンド",
  ...
  "ui.basicTool.argsMore": "他 {{count}} 件",
  "ui.basicTool.argsUnavailable": "引数を表示できません",
