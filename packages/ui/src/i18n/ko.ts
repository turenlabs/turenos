export const dict = {
  "ui.tool.reflectionRead": "세션 메모 읽기",
  "ui.tool.reflectionState": "세션 메모 업데이트",
  "ui.tool.reflectionComplete": "세션 진행 상황 검토",
  "ui.tool.boardRead": "팀 메모 읽기",
  "ui.tool.boardPost": "팀 메모 공유",
  "ui.tool.agentSpawn": "하위 에이전트 시작",
  "ui.tool.agentSend": "하위 에이전트에 메시지 보내기",
  "ui.tool.agentWait": "하위 에이전트 대기",
  "ui.tool.agentInterrupt": "하위 에이전트 중지",
  "ui.tool.agentList": "하위 에이전트 목록",
  "ui.toolDetails.input": "입력",
  "ui.toolDetails.output": "출력",
  "ui.toolDetails.download": "전체 결과 다운로드",
  "ui.toolDetails.previous": "이전",
  "ui.toolDetails.next": "다음",
  "ui.toolDetails.page": "{{page}} / {{pages}}",
  "ui.sessionTurn.status.working": "작업 중",
  "ui.messagePart.context.activity": "세션 활동",
  "ui.messagePart.context.operation.one": "컨텍스트 작업 {{count}}개",
  "ui.messagePart.context.operation.other": "컨텍스트 작업 {{count}}개",
  ...
  "ui.messagePart.toolCleared": "결과가 컨텍스트에서 제거됨",
  "ui.messagePart.failure.title": "{{tool}} 실패",
  "ui.messagePart.board.notes.one": "{{count}}개 메모",
  "ui.messagePart.board.notes.other": "{{count}}개 메모",
  "ui.messagePart.board.superseded": "대체됨",
  "ui.messagePart.board.evidence": "증거",
  ...
  "ui.basicTool.argsMore": "외 {{count}}개",
  "ui.basicTool.argsUnavailable": "인수를 표시할 수 없음",
