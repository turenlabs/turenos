...
export const dict: Record<Keys, string> = {
  ...
  "ui.tool.agentSend": "Send melding til underagent",
  "ui.tool.agentWait": "Vent på underagenter",
  "ui.tool.agentInterrupt": "Stopp underagent",
  "ui.tool.agentList": "List underagenter",
  ...
  "ui.messagePart.toolCleared": "Resultat fjernet fra konteksten",
  "ui.messagePart.failure.title": "{{tool}} mislyktes",
  "ui.messagePart.board.notes.one": "{{count}} notat",
  "ui.messagePart.board.notes.other": "{{count}} notater",
  ...
  "ui.basicTool.argsMore": "+{{count}} til",
  "ui.basicTool.argsUnavailable": "argumenter utilgjengelige",
