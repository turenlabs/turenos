export const dict: Record<string, string> = {
  ...
  "ui.messagePart.toolCleared": "Result cleared from context",
  "ui.tool.reflectionRead": "Read session notes",
  "ui.tool.reflectionState": "Update session notes",
  "ui.tool.reflectionComplete": "Review session progress",
  "ui.tool.boardRead": "Read team notes",
  "ui.tool.boardPost": "Share team notes",
  "ui.tool.agentSpawn": "Start subagent",
  "ui.tool.agentSend": "Message subagent",
  "ui.tool.agentWait": "Await subagents",
  "ui.tool.agentInterrupt": "Stop subagent",
  "ui.tool.agentList": "List subagents",
  "ui.toolDetails.input": "Input",
  "ui.toolDetails.output": "Output",
  "ui.toolDetails.download": "Download full result",
  "ui.toolDetails.previous": "Previous",
  "ui.toolDetails.next": "Next",
  "ui.toolDetails.page": "{{page}} of {{pages}}",
  "ui.sessionTurn.status.working": "Working",
  "ui.messagePart.failure.title": "{{tool}} failed",
  "ui.messagePart.board.notes.one": "{{count}} note",
  "ui.messagePart.board.notes.other": "{{count}} notes",
  "ui.messagePart.board.superseded": "Superseded",
  "ui.messagePart.board.evidence": "Evidence",
  "ui.messagePart.context.activity": "Session activity",
  "ui.messagePart.context.operation.one": "{{count}} context operation",
  "ui.messagePart.context.operation.other": "{{count}} context operations",
  ...
  "ui.messagePart.context.shell.one": "{{count}} shell command",
  "ui.messagePart.context.shell.other": "{{count}} shell commands",
  ...
  "ui.basicTool.argsMore": "+{{count}} more",
  "ui.basicTool.argsUnavailable": "arguments unavailable",
