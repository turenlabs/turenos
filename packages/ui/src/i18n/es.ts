export const dict = {
  "ui.tool.reflectionRead": "Leer notas de la sesión",
  "ui.tool.reflectionState": "Actualizar notas de la sesión",
  "ui.tool.reflectionComplete": "Revisar el progreso de la sesión",
  "ui.tool.boardRead": "Leer notas del equipo",
  "ui.tool.boardPost": "Compartir notas del equipo",
  "ui.tool.agentSpawn": "Iniciar subagente",
  "ui.tool.agentSend": "Enviar mensaje al subagente",
  "ui.tool.agentWait": "Esperar a los subagentes",
  "ui.tool.agentInterrupt": "Detener subagente",
  "ui.tool.agentList": "Listar subagentes",
  "ui.toolDetails.input": "Entrada",
  "ui.toolDetails.output": "Salida",
  "ui.toolDetails.download": "Descargar resultado completo",
  "ui.toolDetails.previous": "Anterior",
  "ui.toolDetails.next": "Siguiente",
  "ui.toolDetails.page": "{{page}} de {{pages}}",
  "ui.sessionTurn.status.working": "Trabajando",
  "ui.messagePart.context.activity": "Actividad de la sesión",
  "ui.messagePart.context.operation.one": "{{count}} operación de contexto",
  "ui.messagePart.context.operation.other": "{{count}} operaciones de contexto",
  ...
  "ui.messagePart.toolCleared": "Resultado eliminado del contexto",
  "ui.messagePart.failure.title": "{{tool}} falló",
  "ui.messagePart.board.notes.one": "{{count}} nota",
  "ui.messagePart.board.notes.other": "{{count}} notas",
  "ui.messagePart.board.superseded": "Reemplazada",
  "ui.messagePart.board.evidence": "Evidencia",
  ...
  "ui.messagePart.context.shell.one": "{{count}} comando de shell",
  "ui.messagePart.context.shell.other": "{{count}} comandos de shell",
  ...
  "ui.basicTool.argsMore": "+{{count}} más",
  "ui.basicTool.argsUnavailable": "argumentos no disponibles",
