export const dict = {
  "ui.tool.reflectionRead": "Прочитать заметки сеанса",
  "ui.tool.reflectionState": "Обновить заметки сеанса",
  "ui.tool.reflectionComplete": "Проверить ход сеанса",
  "ui.tool.boardRead": "Прочитать заметки команды",
  "ui.tool.boardPost": "Поделиться заметками команды",
  "ui.tool.agentSpawn": "Запустить субагента",
  "ui.tool.agentSend": "Отправить сообщение субагенту",
  "ui.tool.agentWait": "Дождаться субагентов",
  "ui.tool.agentInterrupt": "Остановить субагента",
  "ui.tool.agentList": "Список субагентов",
  "ui.toolDetails.input": "Ввод",
  "ui.toolDetails.output": "Вывод",
  "ui.toolDetails.download": "Скачать полный результат",
  "ui.toolDetails.previous": "Назад",
  "ui.toolDetails.next": "Далее",
  "ui.toolDetails.page": "{{page}} из {{pages}}",
  "ui.sessionTurn.status.working": "В работе",
  "ui.messagePart.context.activity": "Активность сеанса",
  "ui.messagePart.context.operation.one": "{{count}} операция с контекстом",
  "ui.messagePart.context.operation.other": "Операции с контекстом: {{count}}",
  ...
  "ui.messagePart.toolCleared": "Результат удалён из контекста",
  "ui.messagePart.failure.title": "{{tool}} завершился с ошибкой",
  "ui.messagePart.board.notes.one": "{{count}} заметка",
  "ui.messagePart.board.notes.other": "{{count}} заметок",
  "ui.messagePart.board.superseded": "Заменено",
  "ui.messagePart.board.evidence": "Доказательства",
  ...
  "ui.basicTool.argsMore": "+{{count}} ещё",
  "ui.basicTool.argsUnavailable": "аргументы недоступны",
