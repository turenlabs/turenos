...
export const dict = {
  "ui.tool.reflectionRead": "读取会话笔记",
  "ui.tool.reflectionState": "更新会话笔记",
  "ui.tool.reflectionComplete": "检查会话进展",
  "ui.tool.boardRead": "读取团队笔记",
  "ui.tool.boardPost": "分享团队笔记",
  "ui.tool.agentSpawn": "启动子代理",
  "ui.tool.agentSend": "向子代理发送消息",
  "ui.tool.agentWait": "等待子代理",
  "ui.tool.agentInterrupt": "停止子代理",
  "ui.tool.agentList": "列出子代理",
  "ui.toolDetails.input": "输入",
  "ui.toolDetails.output": "输出",
  "ui.toolDetails.download": "下载完整结果",
  "ui.toolDetails.previous": "上一页",
  "ui.toolDetails.next": "下一页",
  "ui.toolDetails.page": "第 {{page}} 页，共 {{pages}} 页",
  "ui.sessionTurn.status.working": "处理中",
  "ui.messagePart.context.activity": "会话活动",
  ...
  "ui.messagePart.toolCleared": "结果已从上下文中清除",
  "ui.messagePart.failure.title": "{{tool}} 失败",
  "ui.messagePart.board.notes.one": "{{count}} 条备注",
  "ui.messagePart.board.notes.other": "{{count}} 条备注",
  "ui.messagePart.board.superseded": "已替代",
  "ui.messagePart.board.evidence": "证据",
  ...
  "ui.basicTool.argsMore": "还有 {{count}} 项",
  "ui.basicTool.argsUnavailable": "参数不可用",
