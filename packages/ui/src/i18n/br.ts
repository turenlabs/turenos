export const dict = {
  "ui.tool.reflectionRead": "Ler notas da sessão",
  "ui.tool.reflectionState": "Atualizar notas da sessão",
  "ui.tool.reflectionComplete": "Revisar progresso da sessão",
  "ui.tool.boardRead": "Ler notas da equipe",
  "ui.tool.boardPost": "Compartilhar notas da equipe",
  "ui.tool.agentSpawn": "Iniciar subagente",
  "ui.tool.agentSend": "Enviar mensagem ao subagente",
  "ui.tool.agentWait": "Aguardar subagentes",
  "ui.tool.agentInterrupt": "Parar subagente",
  "ui.tool.agentList": "Listar subagentes",
  "ui.toolDetails.input": "Entrada",
  "ui.toolDetails.output": "Saída",
  "ui.toolDetails.download": "Baixar resultado completo",
  "ui.toolDetails.previous": "Anterior",
  "ui.toolDetails.next": "Próxima",
  "ui.toolDetails.page": "{{page}} de {{pages}}",
  "ui.sessionTurn.status.working": "Trabalhando",
  "ui.messagePart.context.activity": "Atividade da sessão",
  "ui.messagePart.context.operation.one": "{{count}} operação de contexto",
  "ui.messagePart.context.operation.other": "{{count}} operações de contexto",
  ...
  "ui.messagePart.toolCleared": "Resultado removido do contexto",
  "ui.messagePart.failure.title": "{{tool}} falhou",
  "ui.messagePart.board.notes.one": "{{count}} nota",
  "ui.messagePart.board.notes.other": "{{count}} notas",
  "ui.messagePart.board.superseded": "Substituída",
  "ui.messagePart.board.evidence": "Evidências",
  ...
  "ui.messagePart.context.shell.one": "{{count}} comando shell",
  "ui.messagePart.context.shell.other": "{{count}} comandos shell",
  ...
  "ui.basicTool.argsMore": "+{{count}} mais",
  "ui.basicTool.argsUnavailable": "argumentos indisponíveis",
