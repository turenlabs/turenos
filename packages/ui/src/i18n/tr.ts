...
export const dict = {
  ...
  "ui.tool.agentSpawn": "Alt ajanı başlat",
  "ui.tool.agentSend": "Alt ajana mesaj gönder",
  "ui.tool.agentWait": "Alt ajanları bekle",
  "ui.tool.agentInterrupt": "Alt ajanı durdur",
  "ui.tool.agentList": "Alt ajanları listele",
  ...
  "ui.messagePart.toolCleared": "Sonuç bağlamdan kaldırıldı",
  "ui.messagePart.failure.title": "{{tool}} başarısız oldu",
  "ui.messagePart.board.notes.one": "{{count}} not",
  "ui.messagePart.board.notes.other": "{{count}} not",
  "ui.messagePart.board.superseded": "Değiştirildi",
  "ui.messagePart.board.evidence": "Kanıt",
  ...
  "ui.basicTool.argsMore": "+{{count}} daha",
  "ui.basicTool.argsUnavailable": "argümanlar kullanılamıyor",
