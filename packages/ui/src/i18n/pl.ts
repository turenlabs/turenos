export const dict = {
  "ui.tool.reflectionRead": "Odczytaj notatki sesji",
  "ui.tool.reflectionState": "Zaktualizuj notatki sesji",
  "ui.tool.reflectionComplete": "Sprawdź postęp sesji",
  "ui.tool.boardRead": "Odczytaj notatki zespołu",
  "ui.tool.boardPost": "Udostępnij notatki zespołu",
  "ui.tool.agentSpawn": "Uruchom subagenta",
  "ui.tool.agentSend": "Wyślij wiadomość do subagenta",
  "ui.tool.agentWait": "Poczekaj na subagentów",
  "ui.tool.agentInterrupt": "Zatrzymaj subagenta",
  "ui.tool.agentList": "Wyświetl subagentów",
  "ui.toolDetails.input": "Dane wejściowe",
  "ui.toolDetails.output": "Dane wyjściowe",
  "ui.toolDetails.download": "Pobierz pełny wynik",
  "ui.toolDetails.previous": "Poprzednia",
  "ui.toolDetails.next": "Następna",
  "ui.toolDetails.page": "{{page}} z {{pages}}",
  "ui.sessionTurn.status.working": "Praca w toku",
  "ui.messagePart.context.activity": "Aktywność sesji",
  "ui.messagePart.context.operation.one": "{{count}} operacja kontekstu",
  "ui.messagePart.context.operation.other": "Operacje kontekstu: {{count}}",
  ...
  "ui.messagePart.toolCleared": "Wynik usunięty z kontekstu",
  "ui.messagePart.failure.title": "{{tool}} nie powiodło się",
  "ui.messagePart.board.notes.one": "{{count}} notatka",
  "ui.messagePart.board.notes.other": "{{count}} notatek",
  "ui.messagePart.board.superseded": "Zastąpiono",
  "ui.messagePart.board.evidence": "Dowody",
  ...
  "ui.messagePart.context.shell.one": "{{count}} polecenie terminala",
  "ui.messagePart.context.shell.other": "{{count}} polecenia terminala",
  ...
  "ui.basicTool.argsMore": "+{{count}} więcej",
  "ui.basicTool.argsUnavailable": "argumenty niedostępne",
