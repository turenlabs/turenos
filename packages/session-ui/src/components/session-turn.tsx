...
import type { SessionStatus } from "@turenlabs/sdk/v2"
          ...
          <Show when={message()}>
            ...
            >
              ...
              <Show when={showThinking()}>
                <div data-slot="session-turn-thinking" role="status" aria-live="polite" aria-atomic="true">
                  <Thinking state="solving" size={20} aria-hidden="true" />
                  <span data-slot="session-turn-thinking-status">{i18n.t("ui.sessionTurn.status.thinking")}</span>
