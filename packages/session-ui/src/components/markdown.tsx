...
export function Markdown(
  ...
  createEffect(() => {
    ...
    const imageCleanup = local.resolveImage
      ? resolveMarkdownImages(container, local.resolveImage, local.onImageSettled)
      : undefined
    if (imageCleanup) imageCleanups.push(imageCleanup)
  })
